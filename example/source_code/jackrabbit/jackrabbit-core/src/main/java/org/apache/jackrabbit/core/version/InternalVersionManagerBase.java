...
histori
inconsist version state inconsistentversioningst unexpect failur child node parent node parent node getnodeid
...
success
lock releas
return inform version histori node
code null code unavail
param vnode node version histori return
return identifi version histori root version node
throw repositoryexcept error occur
version histori info versionhistoryinfo version histori info node getversionhistoryinfofornod node state nodest node repositori except repositoryexcept
...
histori
inconsist version state inconsistentversioningst unexpect failur child node parent node parent node getnodeid
child node entri childnodeentri rootv histori state getstat child node entri getchildnodeentri jcr rootvers jcr rootvers
rootv
inconsist version state inconsistentversioningst miss child node entri jcr rootvers jcr rootvers version histori node histori node getnodeid
histori node getnodeid
info version histori info versionhistoryinfo histori node getnodeid
rootv getid
lock releas
info
inheritdoc
...
repositori except repositoryexcept
version histori info versionhistoryinfo info version histori info node getversionhistoryinfofornod node
info
