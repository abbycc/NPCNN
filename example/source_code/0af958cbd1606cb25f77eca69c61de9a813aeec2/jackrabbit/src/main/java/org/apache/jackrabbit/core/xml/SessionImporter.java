...
session import sessionimport import
logger log logger logger getlogg session import sessionimport
session impl sessionimpl session
node impl nodeimpl import target node importtargetnod
...
creat code sessionimport code instanc
param importtargetnod
param session
param uuidbehavior constant declar
link importuuidbehavior
session import sessionimport node impl nodeimpl import target node importtargetnod
session impl sessionimpl session
uuid behavior uuidbehavior
import target node importtargetnod import target node importtargetnod
session session
uuid behavior uuidbehavior uuid behavior uuidbehavior
ref tracker reftrack refer chang tracker referencechangetrack
parent stack
parent push import target node importtargetnod
node impl nodeimpl creat node createnod node impl nodeimpl parent
qname node nodenam
...
parent properti hasproperti node nodenam
properti exist properti
import document view import
element attribut
parent element renam onflict properti
http issu apach org jira brows jcr
properti conflict parent properti getproperti node nodenam
conflict isnew
assum properti import
renam conflict properti
todo revers escap scheme creat uniqu
qname newnam qname node nodenam namespac uri getnamespaceuri node nodenam local getlocalnam
parent properti hasproperti newnam
newnam qname newnam namespac uri getnamespaceuri newnam local getlocalnam
conflict definit getdefinit multipl ismultipl
parent set properti setproperti newnam conflict valu getvalu
parent set properti setproperti newnam conflict getvalu
conflict remov
add node
uuid uuid uuid random uuid randomuuid uuid getuuid
node parent add node addnod node nodenam node type nodetypenam uuid
add mixin
mixin name mixinnam
mixin name mixinnam length
node add mixin addmixin mixin name mixinnam
node
node impl nodeimpl resolv uuid conflict resolveuuidconflict node impl nodeimpl parent
node impl nodeimpl conflict
...
creat uuid
node creat node createnod parent node info nodeinfo getnam
...
string msg node uuid node info nodeinfo getid exist
log debug msg
...
make conflict node importtargetnod ancestor thereof
import target node importtargetnod path getpath start startswith conflict path getpath
...
repositori except repositoryexcept
node impl nodeimpl parent node impl nodeimpl parent peek
process node
node impl nodeimpl node
...
node exist
node impl nodeimpl exist parent node getnod node nodenam
node definit nodedefinit def exist definit getdefinit
def sibl allowssamenames
exist sibl
check potenti conflict
def protect isprotect exist node type isnodetyp ntname
skip protect node
parent push parent push null push null stack skip node
log debug skip protect node exist safe jcr path safegetjcrpath
def auto creat isautocr exist node type isnodetyp ntname
node auto creat creat
node exist
item exist except itemexistsexcept exist safe jcr path safegetjcrpath
node
creat node
potenti uuid conflict add node
node creat node createnod parent node nodenam ntname mixin
potenti uuid conflict
node impl nodeimpl conflict
conflict session node getnodebyid
...
tva length
singl multi valu
def ent applic properti def getapplicablepropertydef prop propnam type
multi valu
def ent applic properti def getapplicablepropertydef prop propnam type
def protect isprotect
skip protect properti
log debug skip protect properti prop propnam
convert serial valu object
tva length
...
tva length
text textvalu tva
target type targettyp properti type propertytyp
target type targettyp properti type propertytyp path
path requir special treatment
depend current namespac context
xml document
retriev serial
string ser servalu
ser servalu retriev
...
intern internalvalu ival
intern internalvalu creat ser servalu target type targettyp context nscontext
convert internalvalu
session' namespac map
ival jcr tojcrvalu session namespac resolv getnamespaceresolv
target type targettyp properti type propertytyp binari
length
65kb deseri binari type string
helper valuehelp deseri retriev target type targettyp
65kb deseri binari type reader
reader reader reader
helper valuehelp deseri reader target type targettyp
reader close
except ioexcept ioe
string msg fail deseri binari
log debug msg ioe
repositori except repositoryexcept msg ioe
type
retriev serial
...
log debug msg ioe
repositori except repositoryexcept msg ioe
helper valuehelp deseri ser servalu target type targettyp
multi singl valu properti
length
singl multi valu
set singl
node set properti setproperti prop propnam
format except valueformatexcept vfe
set arrai
node set properti setproperti prop propnam type
...
store refer resolut
ref tracker reftrack process refer processedrefer node properti getproperti prop propnam
parent push node
inheritdoc
...
iter hasnext
properti prop properti iter
paranoid
prop type gettyp properti type propertytyp refer
prop definit getdefinit multipl ismultipl
valu prop valu getvalu
val newval valu length
valu length
val valu
uuid origin uuid string fromstr val string getstr
uuid adjust ref tracker reftrack map uuid getmappeduuid origin
adjust
val newval refer referencevalu session node uuid getnodebyuuid adjust
refer adjust copi
val newval val
prop set setvalu val newval
val prop getvalu
uuid origin uuid string fromstr val string getstr
uuid adjust ref tracker reftrack map uuid getmappeduuid origin
adjust
prop set setvalu session node uuid getnodebyuuid adjust
