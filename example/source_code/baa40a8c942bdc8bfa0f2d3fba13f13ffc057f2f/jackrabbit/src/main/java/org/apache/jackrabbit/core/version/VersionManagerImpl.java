...
builder add addlast qname jcr system jcr system
builder add addlast qname jcr versionstorag jcr versionstorag
...
share state manag version storag
...
item state cach factori itemstatecachefactori cach factori cachefactori repositori except repositoryexcept
mgr pmgr mgr pmgr
reg ntreg reg ntreg
...
qname jcr versionstorag jcr versionstorag qname rep versionstorag rep versionstorag reg ntreg getid
root set node type setnodetypenam qname rep versionstorag rep versionstorag
properti state propertyst mgr pmgr creat createnew properti propertyid root rootid qname jcr primarytyp jcr primarytyp
...
version item state manag versionitemstatemanag mgr pmgr root rootid reg ntreg cach factori cachefactori
...
repositori except repositoryexcept
intern version histori internalversionhistori histori intern version histori internalversionhistori
...
version histori versionhistori session impl sessionimpl session node getnodebyid histori getid
inheritdoc
...
item intern version histori internalversionhistori parent version getvers
...
releas read lock releasereadlock
set store node refer extern node
param refer
return code true code refer set
set node refer setnoderefer node refer noderefer refer
acquir write lock acquirewritelock
filter version storag intern
node refer noderefer ref node refer noderefer refer getid
iter iter refer refer getrefer iter
iter hasnext
properti propertyid properti propertyid iter
item hasitem parent getparentid
ref add refer addrefer
chang log changelog log chang log changelog
log modifi ref
mgr pmgr store log
item state except itemstateexcept
log error error set refer string tostr
...
updateeventlisten
inheritdoc
extern updat externalupd chang log changelog list event repositori except repositoryexcept
...
class
spezial shareditemstatemanag filter noderefer
version state
version item state manag versionitemstatemanag share item state manag shareditemstatemanag
version item state manag versionitemstatemanag persist manag persistencemanag persist mgr persistmgr
node nodeid root node rootnodeid
node type registri nodetyperegistri reg ntreg
item state cach factori itemstatecachefactori cach factori cachefactori
item state except itemstateexcept
persist mgr persistmgr root node rootnodeid reg ntreg cach factori cachefactori
