...
org w3c dom element
sun org apach xalan intern xsltc dom extend sax extendedsax
...
ob mgr obsmgr session workspac getworkspac observ manag getobservationmanag
...
string session repositori getrepositori descriptor getdescriptor org apach jackrabbit spi common additionaleventinfo
boolean pars boolean parseboolean
event provid local flag eventsprovidenolocalflag
session session extens sessionextens
xmlserializ
...
dom util domutil add child element addchildel subscr xml eventswithtyp xml eventswithtyp namespac
boolean string tostr event provid node type inform eventsprovidenodetypeinform
dom util domutil add child element addchildel subscr xml eventswithlocalflag xml eventswithlocalflag namespac
boolean string tostr event provid local flag eventsprovidenolocalflag
subscr
implement specif
...
local flag set localflagset
event hasnext
event event event event nextev
local flag set localflagset
obtain remot session identifi
local flag set localflagset
string session forsessionid string session
attribut getattribut session provid impl sessionproviderimpl attribut session attribut session
calcul local flag
session forsessionid
event addit event info additionaleventinfo
string eventfor session eventforsessionid string addit event info additionaleventinfo event
session attribut getsessionattribut session provid impl sessionproviderimpl attribut session attribut session
local isloc session forsessionid
equal eventfor session eventforsessionid
dom util domutil set attribut setattribut bundl xml event local xml event local
namespac boolean string tostr local isloc
...
comput nodetyp inform
event addit event info additionaleventinfo
dom util domutil add child element addchildel event elem eventelem
xml eventprimarnodetyp xml eventprimarnodetyp namespac
addit event info additionaleventinfo event
primari node type getprimarynodetypenam string tostr
mixin addit event info additionaleventinfo event
mixin type name getmixintypenam
dom util domutil add child element addchildel event elem eventelem
xml eventmixinnodetyp xml eventmixinnodetyp namespac
mixin string tostr
unsupport repositori oper except unsupportedrepositoryoperationexcept
option
...
map event info getinfo
map entri entri entri set entryset
string kei entri kei getkei string tostr
