...
org apach common collect sequenc hash map sequencedhashmap
javax jcr lock lock
...
node impl nodeimpl node node impl nodeimpl session node uuid getnodebyuuid lock token locktoken uuid
...
lockmanag
inheritdoc
lock lock node impl nodeimpl node deep isdeep
...
sequenc hash map sequencedhashmap event map eventmap sequenc hash map sequencedhashmap
event hasnext
