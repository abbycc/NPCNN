...
ref persist mgr persistmgr load
...
properti state propertyst state persist mgr persistmgr creat createnew
properti propertyid parent uuid parentuuid prop propnam
state set statu setstatu item state itemst statu statu
state add listen addlisten
state
...
event creat event state createeventst local
event prepar
