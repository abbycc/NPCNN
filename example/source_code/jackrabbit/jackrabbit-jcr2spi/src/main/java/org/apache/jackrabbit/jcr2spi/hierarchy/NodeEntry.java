...
return index child node entri support sibl
...
path entri load
note contrast getnodeentri getnodeentri method return
invalid entri entri connect remov stale itemst
param path
return entri path
...
travers tree entri return child entri match
path entri load
note contrast getpropertyentri getpropertyentri method
return invalid entri entri connect remov stale
itemst
param path
return properti entri path
throw pathnotfoundexcept
throw repositoryexcept
...
note differ link addnewpropertyentri qpropertydefinit qvalu int
add transient entri
param propnam
return code propertyentri code
