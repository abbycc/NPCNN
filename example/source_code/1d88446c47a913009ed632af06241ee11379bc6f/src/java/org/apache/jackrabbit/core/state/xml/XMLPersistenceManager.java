...
org jdom filter content filter contentfilt
...
read state readstat element prop element propel persist properti state persistentpropertyst state
item state except itemstateexcept
paranoid saniti check
prop element propel getnam equal properti element properti element
string msg invalid serial format unexpect element prop element propel getnam
log error msg
item state except itemstateexcept msg
check
state getnam equal qname valueof prop element propel attribut getattributevalu attribut attribut
string msg invalid serial state mismatch
log error msg
item state except itemstateexcept msg
check parentuuid
string parent uuid parentuuid prop element propel attribut getattributevalu parentuuid attribut parentuuid attribut
...
readi read state
type
string type typenam prop element propel attribut getattributevalu type attribut type attribut
type
...
definit
string definit definitionid prop element propel attribut getattributevalu definitionid attribut definitionid attribut
state set definit setdefinitionid prop def propdefid valueof definit definitionid
valu
iter iter prop element propel child getchild valu element valu element children getchildren element element iter
arrai list arraylist valu arrai list arraylist
iter hasnext
element element valueel element iter
filter filter content filter contentfilt content filter contentfilt text content filter contentfilt cdata
list content element valueel content getcont filter
intern internalvalu val
content empti isempti
read serial
string text element valueel text trim gettexttrim
...
string msg error read serial binari valuei
log error msg ioe
...
val
valu add val
state set valu setvalu intern internalvalu valu arrai toarrai intern internalvalu valu size
...
initi
persistencemanag loadnodest
persist node state persistentnodest load node state loadnodest string uuid
...
persist node state persistentnodest state creat node state instanc createnodestateinst uuid qname valueof ntname
...
element root element rootel builder build root element getrootel
reset state
state remov parent uui removeallparentuuid
state remov properti entri removeallpropertyentri
...
log error msg
item state except itemstateexcept msg
persistencemanag loadpropertyst
persist properti state persistentpropertyst load properti state loadpropertyst string parent uuid parentuuid qname prop propnam
item state except nosuchitemstateexcept item state except itemstateexcept
initi
illeg state except illegalstateexcept initi
except null
string propfilepath buildpropfilepath parentuuid propnam
isfil propfilepath
throw nosuchitemstateexcept parentuuid propnam
inputstream getinputstream propfilepath
saxbuild builder saxbuild
element rootel builder build getrootel
persistentpropertyst state createpropertystateinst propnam parentuuid
readstat rootel state
return state
final
close
catch jdomexcept jde
jde
fall
catch ioexcept ioe
ioe
fall
catch filesystemexcept fse
fse
fall
string msg fail read properti state parentuuid propnam
log error msg
throw itemstateexcept msg
except
...
prop load
persist properti state persistentpropertyst state creat properti state instanc createpropertystateinst prop propnam parent uuid parentuuid
...
item state except itemstateexcept msg
persistencemanag reload
reload persist properti state persistentpropertyst state item state except itemstateexcept
initi
illeg state except illegalstateexcept initi
except
...
log error msg fse
item state except itemstateexcept msg fse
persistencemanag createnodestateinst
persist node state persistentnodest creat node state instanc createnodestateinst string uuid qname node type nodetypenam
xml node state xmlnodest uuid node type nodetypenam
persistencemanag createpropertystateinst
persist properti state persistentpropertyst creat properti state instanc createpropertystateinst qname string parent uuid parentuuid
xml properti state xmlpropertyst parent uuid parentuuid
persistencemanag createnodereferencesinst string
node refer noderefer creat node refer instanc createnodereferencesinst string uuid
node refer noderefer node nodeid uuid
persistencemanag loadnoderefer string uuid
node refer noderefer load node refer loadnoderefer string uuid item state except nosuchitemstateexcept item state except itemstateexcept
initi
illeg state except illegalstateexcept initi
except
...
item state except nosuchitemstateexcept uuid
node refer noderefer ref creat node refer instanc createnodereferencesinst uuid
...
log error msg
item state except itemstateexcept msg
persistencemanag reload noderefer
reload node refer noderefer ref item state except itemstateexcept
initi
illeg state except illegalstateexcept initi
except
