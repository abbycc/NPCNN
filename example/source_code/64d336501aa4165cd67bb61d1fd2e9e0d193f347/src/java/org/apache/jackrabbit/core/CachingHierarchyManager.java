...
logger instanc
logger log logger logger getlogg cach hierarchi manag cachinghierarchymanag
...
cach hierarchi manag cachinghierarchymanag string root node uuid rootnodeuuid
item state manag itemstatemanag provid
namespac resolv namespaceresolv resolv nsresolv
root node uuid rootnodeuuid provid resolv nsresolv
...
state modifi statemodifi node state nodest modifi
evict move renam item cach
state modifi statemodifi node state nodest modifi
cach monitor cachemonitor
lru entri lruentri entri lru entri lruentri cach idcach modifi getid
entri
item cach ignor
...
child getnam child index getindex
cne
item exist remov
child remov
evict child
lru entri lruentri child entri childentri lru entri lruentri child
child entri childentri cne uuid getuuid equal child entri childentri uuid getuuid
child item remov
child remov
evict child
inheritdoc
...
evict discard getid
call code itemst code overlaid
state take ident notif
state overlaid
param overlay code itemst code overlai state
state overlaid stateoverlaid item state itemst overlay
overlay node isnod
overlay overlai state getoverlayedst remov listen removelisten
overlay add listen addlisten
call code itemst code longer overlay
item state notif state overlai
state
param overlay code itemst code overlaid
item state overlaid state invok
link itemst getoverlayedst
state uncov stateuncov item state itemst overlay
overlay node isnod
overlay remov listen removelisten
overlay overlai state getoverlayedst add listen addlisten
inheritdoc
node ad nodead node state nodest state qname index string uuid
path path path creat path getpath state getid index
insert path node nodeid uuid
path found except pathnotfoundexcept
log warn unabl path node state getid
event
malform path except malformedpathexcept
log warn unabl creat path uuid
item found except itemnotfoundexcept
log warn unabl path state getid
repositori except repositoryexcept
log warn unabl path state getid
inheritdoc
gener subsequ add remov notif replac
node replac nodesreplac node state nodest state
list entri state reorder child node entri getreorderedchildnodeentri
entri size
...
node state nodest child node entri childnodeentri
node state nodest state overlai state getoverlayedst child node entri getchildnodeentri uuid getuuid
log warn reorder child node found list
node ad nodead state getnam index getindex uuid getuuid
node remov noderemov state getnam index getindex uuid getuuid
inheritdoc
node remov noderemov node state nodest state qname index string uuid
path path path creat path getpath state getid index
remov path node nodeid uuid
path found except pathnotfoundexcept
log warn unabl path node state getid
event
malform path except malformedpathexcept
...
element evict object
param element path map element
evict path map pathmap element element
cach monitor cachemonitor
