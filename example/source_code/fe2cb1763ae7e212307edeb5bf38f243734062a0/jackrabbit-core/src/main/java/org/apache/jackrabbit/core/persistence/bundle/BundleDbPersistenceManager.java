...
databas
configur
param link setexternalblob string externalblob fals
...
inid filesystem blob store
extern blo externalblob
jdbc conect
connect con
share prepar statement bundl manag
prepar statement preparedstat bundl insert bundleinsert
prepar statement preparedstat bundl updat bundleupd
prepar statement preparedstat bundl select bundleselect
prepar statement preparedstat bundl delet bundledelet
...
object tabl index useful persist
manag databas
...
return extern filesystem blob store
return extern filesystem blob store
string extern blo getexternalblob
string valueof extern blo externalblob
set flag extern filsystem blob store usag
...
return code true code consistenct check enabl
...
return miminum blob size byte
return miminum blob size byte
string min blob size getminblobs
string valueof min blob size minblobs
set minumum blob size size defin threshhold
...
sql text replac sql schema object prefix variabl schema object prefix variabl schema object prefix schemaobjectprefix trim
sql length sql index indexof binval blob store usedbblobstor
...
string msg configur error unabl read schema schema
log debug msg
repositori except repositoryexcept msg
close
except ioexcept
...
code fals code
throw sqlexcept sql erro occur
check tabl exist checktablesexist sql except sqlexcept
...
inheritdoc
basic wrapp jdbc transact super store
...
string msg set autocommit fail
log error msg
...
setup jdbc connect
note explicit creation instanc driver requir
order regist driver drivermanag
repositori shutdown
driver drv driver class fornam driver instanc newinst
log info jdbc driver creat drv
...
bundl insert bundleinsert con prepar statement preparestat insert schema object prefix schemaobjectprefix bundl bundl data node valu
bundl updat bundleupd con prepar statement preparestat updat schema object prefix schemaobjectprefix bundl set bundl data node
bundl select bundleselect con prepar statement preparestat select bundl data schema object prefix schemaobjectprefix bundl node
bundl delet bundledelet con prepar statement preparestat delet schema object prefix schemaobjectprefix bundl node
node refer insert nodereferenceinsert con prepar statement preparestat insert schema object prefix schemaobjectprefix ref ref data node valu
node refer updat nodereferenceupd con prepar statement preparestat updat schema object prefix schemaobjectprefix ref set ref data node
node refer select nodereferenceselect con prepar statement preparestat select ref data schema object prefix schemaobjectprefix ref node
node refer delet nodereferencedelet con prepar statement preparestat delet schema object prefix schemaobjectprefix ref node
bundl insert bundleinsert con prepar statement preparestat insert schema object prefix schemaobjectprefix bundl bundl data node node valu
bundl updat bundleupd con prepar statement preparestat updat schema object prefix schemaobjectprefix bundl set bundl data node node
bundl select bundleselect con prepar statement preparestat select bundl data schema object prefix schemaobjectprefix bundl node node
bundl delet bundledelet con prepar statement preparestat delet schema object prefix schemaobjectprefix bundl node node
node refer insert nodereferenceinsert con prepar statement preparestat insert schema object prefix schemaobjectprefix ref ref data node node valu
node refer updat nodereferenceupd con prepar statement preparestat updat schema object prefix schemaobjectprefix ref set ref data node node
node refer select nodereferenceselect con prepar statement preparestat select ref data schema object prefix schemaobjectprefix ref node node
node refer delet nodereferencedelet con prepar statement preparestat delet schema object prefix schemaobjectprefix ref node node
load namespac
bind bundl bind bundlebind error handl errorhandl blob store blobstor index getnsindex index getnameindex
...
storag model getstoragemodel binari kei binari kei
stmt con prepar statement preparestat select node bundl data bundl
stmt con prepar statement preparestat select node node bundl data bundl
stmt execut
...
child
log error nodest uuid getuuid refer unexist child entri getnam entri getid uuid getuuid
...
log error nodest refer unexist parent parent parentid
except ioexcept
...
close statement closestat bundl insert bundleinsert
close statement closestat bundl updat bundleupd
close statement closestat bundl select bundleselect
close statement closestat bundl delet bundledelet
...
item state except itemstateexcept
prepar statement preparedstat stmt bundl select bundleselect
result set resultset
data input stream datainputstream din
set kei setkei stmt uuid getuuid
stmt execut
stmt result set getresultset
blob blob getblob
track input stream trackinginputstream cin track input stream trackinginputstream binari stream getbinarystream
din data input stream datainputstream cin
node prop bundl nodepropbundl bundl bind read bundl readbundl din
bundl set size setsiz cin posit getposit
bundl
except
...
dout close
bundl isnew
stmt bundl insert bundleinsert
stmt bundl updat bundleupd
stmt set byte setbyt byte arrai tobytearrai
set kei setkei stmt bundl getid uuid getuuid
stmt execut
except
...
prepar statement preparedstat stmt bundl delet bundledelet
set kei setkei stmt bundl getid uuid getuuid
stmt execut
delet
bundl remov properti removeallproperti
except
...
set kei setkei stmt target targetid target gettargetid uuid getuuid
stmt execut
stmt result set getresultset
...
statement synchron
abstractpersistencemanag store noderefer
...
check insert updat
exist ref getid
stmt node refer updat nodereferenceupd
stmt node refer insert nodereferenceinsert
byte arrai output stream bytearrayoutputstream byte arrai output stream bytearrayoutputstream initi buffer size initi buffer size
serial refer
serial serial ref
synchron instanc
...
stmt set byte setbyt byte arrai tobytearrai
set kei setkei stmt ref target gettargetid uuid getuuid
stmt execut
close bytearrayoutputstream
close
except
string msg fail write properti state ref target gettargetid
log error msg
item state except itemstateexcept msg
reset statement resetstat stmt
inheritdoc
...
log error state code sql state getsqlstat
error code geterrorcod
log debug dump
inheritdoc
string string tostr
