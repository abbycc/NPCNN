...
input stream inputstream buffer input stream bufferedinputstream file input stream fileinputstream file
...
insert revis stmt insertrevisionstmt set binari stream setbinarystream file length
...
string msg unabl open journal log file
journal except journalexcept msg
sql except sqlexcept
