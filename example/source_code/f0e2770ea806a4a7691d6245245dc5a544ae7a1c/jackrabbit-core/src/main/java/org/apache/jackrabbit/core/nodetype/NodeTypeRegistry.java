...
node type definit
check conflict content checkforconflictingcont ntd
...
effect node type effectivenodetyp ent ent cach entcach qname ntname
ent
ent
...
map ntd cach ntdcach
node type conflict except nodetypeconflictexcept node type except nosuchnodetypeexcept
effect node type cach effectivenodetypecach weight kei weightedkei kei
effect node type cach effectivenodetypecach weight kei weightedkei name ntname
check aggreg built
...
iter iter ent cach entcach kei iter keyiter
iter hasnext
effect node type cach effectivenodetypecach weight kei weightedkei
effect node type cach effectivenodetypecach weight kei weightedkei iter
...
node type def nodetypedef ntd node type def nodetypedef iter
effect node type effectivenodetyp ent
valid node type def validatenodetypedef ntd tmp ent cach tmpentcach tmp def cach tmpntdefcach reg nsreg lenient
store effect node type instanc
tmp ent cach tmpentcach put ent
except thrown definit assum valid
iter iter def ntdef iter iter hasnext
node type def nodetypedef ntd node type def nodetypedef iter
regist clone node type definit
ntd node type def nodetypedef ntd clone
...
iter tmp ent cach tmpentcach kei iter keyiter hasnext
effect node type cach effectivenodetypecach weight kei weightedkei
effect node type cach effectivenodetypecach weight kei weightedkei
ent cach entcach
ent cach entcach put tmp ent cach tmpentcach
...
arrai list arraylist kei arrai list arraylist ent cach entcach kei set keyset
iter kei iter keysit kei iter kei iter keysit hasnext
effect node type cach effectivenodetypecach weight kei weightedkei
effect node type cach effectivenodetypecach weight kei weightedkei kei iter keysit
effect node type effectivenodetyp ent ent cach entcach
ent includ node type includesnodetyp
ent cach entcach remov
