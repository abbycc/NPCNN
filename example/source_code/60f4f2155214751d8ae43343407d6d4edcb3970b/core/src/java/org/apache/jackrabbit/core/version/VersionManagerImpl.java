...
virtual item state provid virtualitemstateprovid constant
default logger
...
root set definit setdefinitionid reg ntreg effect node type geteffectivenodetyp rep system rep system applic child node def getapplicablechildnodedef
jcr versionstorag jcr versionstorag rep versionstorag rep versionstorag getid
root set node type setnodetypenam rep versionstorag rep versionstorag
properti state propertyst mgr pmgr creat createnew properti propertyid root uuid rootuuid jcr primarytyp jcr primarytyp
set definit setdefinitionid reg ntreg effect node type geteffectivenodetyp rep system rep system applic properti def getapplicablepropertydef
jcr primarytyp jcr primarytyp properti type propertytyp getid
set multi valu setmultivalu
set type settyp properti type propertytyp
set valu setvalu intern internalvalu intern internalvalu creat rep versionstorag rep versionstorag
...
histori root historyroot node state nodestateex state mgr statemgr reg ntreg node state nodest jcr versionstorag jcr versionstorag
...
param base
return
item state manag itemstatemanag item state provid getitemstateprovid item state manag itemstatemanag base
state mgr statemgr
...
repositori except repositoryexcept
intern version histori internalversionhistori histori creat version histori createversionhistori node
histori
...
recurs add recursiveadd event node impl nodeimpl parent getpar
...
root node hasnod
root add node addnod rep versionstorag rep versionstorag
root store
...
intern version histori impl internalversionhistoryimpl hist intern version histori impl internalversionhistoryimpl creat root uuid random uuid randomuuid string tostr histori node historynodenam node
end updat
...
pred length
item state itemst state item state itemst item remov properti propertyid pred getid jcr successor jcr successor
state
state discard
...
list event arrai list arraylist
recurs remov recursiveremov event node impl nodeimpl histori version
...
intern version histori impl internalversionhistoryimpl intern version histori impl internalversionhistoryimpl
version histori impl versionhistoryimpl histori intern version histori getinternalversionhistori
node impl nodeimpl label node labelnod version histori impl versionhistoryimpl histori node getnod jcr versionlabel jcr versionlabel
state mgr statemgr edit
illeg state except illegalstateexcept
version except versionexcept unabl start edit oper
...
param node
throw repositoryexcept
recurs add recursiveadd list event node impl nodeimpl parent node impl nodeimpl node
repositori except repositoryexcept
...
recurs add recursiveadd event node
add subtre itemst 'removed' list event
param event
param parent
param node
throw repositoryexcept
recurs remov recursiveremov list event node impl nodeimpl parent node impl nodeimpl node
repositori except repositoryexcept
...
niter hasnext
node impl nodeimpl node impl nodeimpl niter node nextnod
recurs remov recursiveremov event node
inheritdoc
...
equal histori root historyroot state getstat getid
node nodeid virtual root getvirtualrootid
node nodeid histori root historyroot state getstat getid
virtual properti state virtualpropertyst creat properti state createpropertyst virtual node state virtualnodest parent qname type multi valu multivalu repositori except repositoryexcept
illeg state except illegalstateexcept versionmanag creat virtualpropertyst
virtual node state virtualnodest creat node state createnodest virtual node state virtualnodest parent qname string uuid qname node type nodetypenam repositori except repositoryexcept
illeg state except illegalstateexcept versionmanag creat virtualnodest
set node refer setnoderefer node refer noderefer ref
intern version item internalversionitem item item getitem ref target gettargetid uuid getuuid
...
item state itemst item item state itemst item
item
item state mgr statemgr item state getitemst
item put item
special check successor
item properti state propertyst
properti state propertyst prop properti state propertyst item
prop getnam equal jcr successor jcr successor
intern version internalvers version getvers prop parent uuid getparentuuid
...
prop set valu setvalu succ succv
repositori except repositoryexcept
log warn unabl resolv jcr successor properti
item
...
state mgr statemgr state creat statecr creat
state modifi statemodifi item state itemst modifi
state mgr statemgr state modifi statemodifi modifi
state destroi statedestroi item state itemst destroi
item remov destroi getid
state mgr statemgr state destroi statedestroi destroi
state discard statediscard item state itemst discard
item remov discard getid
state mgr statemgr state discard statediscard discard
