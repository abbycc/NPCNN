...
session creat observ event
session impl sessionimpl event sourc eventsourc
workaround potenti deadlock
object event sourc lock eventsourcelock object
...
event sourc lock eventsourcelock
synchron set event sourc
creat event dispatch
event sourc eventsourc session impl sessionimpl session
histori creat version histori createversionhistori node
histori
...
synchron set event sourc
creat event dispatch
event sourc eventsourc session impl sessionimpl node session getsess
string hist uuid histuuid node properti getproperti qname jcr versionhistori jcr versionhistori string getstr
version checkin intern version histori impl internalversionhistoryimpl
...
abstract version abstractvers event sourc eventsourc node getnodebyid version getid
inheritdoc
method synchron deadlock
item read listen observ thread
...
synchron set event sourc
creat event dispatch
event sourc eventsourc session impl sessionimpl histori session getsess
save predecessor remov version
...
version event sourc eventsourc node uuid getnodebyuuid getid uuid getuuid
...
repositori except repositoryexcept
event sourc eventsourc
repositori except repositoryexcept unknown event sourc
ob mgr obsmgr creat event state collect createeventstatecollect event sourc eventsourc
class
