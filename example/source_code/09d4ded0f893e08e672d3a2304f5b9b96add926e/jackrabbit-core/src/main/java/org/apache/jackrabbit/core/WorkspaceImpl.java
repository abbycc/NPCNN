...
org apach jackrabbit core lock session lock manag sessionlockmanag
...
jackrabbit workspac jackrabbitworkspac javax jcr workspac
event state collect factori eventstatecollectionfactori
...
api lockmanag workspac creat releas
lock determin lock statu
javax jcr lock lock manag lockmanag jcr283 lock manag jcr283lockmanag
api version manag workspac
version manag impl versionmanagerimpl version mgr versionmgr
intern manag evalu effect retent polici
hold
retent registri retentionregistri retent registri retentionregistri
protect constructor
...
workspac clone string string string booelan
clone
newwsp clone srcworkspac fals
node root session root node getrootnod
node iter nodeiter root node getnod hasnext
node child node nextnod
skip node exist newli creat workspac
tmp session tmpsession node exist nodeexist child path getpath
wsp newwsp clone src workspac srcworkspac child path getpath child path getpath
...
javax jcr workspac getlockmanag
javax jcr lock lockmanag
javax jcr lock lock manag lockmanag lock manag getlockmanag unsupport repositori oper except unsupportedrepositoryoperationexcept repositori except repositoryexcept
jcr283 lock manag jcr283lockmanag
jcr283 lock manag jcr283lockmanag session lock manag sessionlockmanag session session lock manag getlockmanag
jcr283 lock manag jcr283lockmanag
javax jcr workspac getversionmanag
version manag versionmanag version manag getversionmanag
version manag impl getversionmanagerimpl
version manag impl versionmanagerimpl version manag impl getversionmanagerimpl
version mgr versionmgr
version mgr versionmgr version manag impl versionmanagerimpl session state mgr statemgr hier mgr hiermgr
version mgr versionmgr
...
throw repositoryexcept error occur
org apach jackrabbit core lock lock manag lockmanag intern lock manag getinternallockmanag repositori except repositoryexcept
check state instanc
saniti check sanitycheck
lock mgr lockmgr
lock mgr lockmgr rep lock manag getlockmanag wsp config wspconfig getnam
lock mgr lockmgr
return intern effect retent hold manag workspac
creat instanc
return effect retent hold manag workspac
throw repositoryexcept error occur
retent registri retentionregistri retent registri getretentionregistri repositori except repositoryexcept
check state instanc
saniti check sanitycheck
retent registri retentionregistri
retent registri retentionregistri rep retent registri getretentionregistri wsp config wspconfig getnam
retent registri retentionregistri
workspac
inheritdoc
string getnam
...
repositori except repositoryexcept msg
succeed
op move src path srcpath dest path destpath
op updat
succeed
succeed
updat oper fail cancel modif
...
rep cluster node getclusternod
...
check state instanc
saniti check sanitycheck
version manag getversionmanag restor version remov exist removeexist
inheritdoc
...
local item state manag localitemstatemanag creat instanc createinst share rep item state cach factori getitemstatecachefactori
