...
binari blob store binari blob store
binari data store binari data store
default logger
...
pname iter
skip redund primarytyp mixintyp uuid properti
pname equal constant nameconst jcr primarytyp jcr primarytyp
pname equal constant nameconst jcr mixintyp jcr mixintyp
pname equal constant nameconst jcr uuid jcr uuid
...
size binari data store binari data store
val intern internalvalu creat data store datastor read utf readutf
size binari blob store binari blob store
...
blob val blobval small issmal
write small binari writesmallbinari blob val blobval state
write int writeint binari data store binari data store
...
write int writeint binari blob store binari blob store
...
delet evt blob
data write small binari writesmallbinari blob val blobval state
replac instanc
back resourc blob store delet temp file
...
write small binari return data
param output stream write
param size size
param blobval binari
param state properti state error messag
param index error messag
return data
throw ioexcept data read
write small binari writesmallbinari data output stream dataoutputstream blob file blobfilevalu blob val blobval node prop bundl nodepropbundl properti entri propertyentri state except ioexcept
size blob val blobval length getlength
