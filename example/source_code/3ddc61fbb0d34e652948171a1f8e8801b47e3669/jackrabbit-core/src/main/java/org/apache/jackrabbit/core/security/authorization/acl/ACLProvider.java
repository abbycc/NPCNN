...
param principalnam list princip name
return iter code accesscontrolentri code
throw repositoryexcept error occur
iter access control entri accesscontrolentri retriev result entri retrieveresultentri node impl nodeimpl node list string princip name principalnam repositori except repositoryexcept
entri node princip name principalnam iter
privat
...
appli princip name
iter access control entri accesscontrolentri entri retriev result entri retrieveresultentri node getnod node princip name principalnam
build list ac defin local node
list access control entri accesscontrolentri local localac
...
local localac collect empti list emptylist
...
clear cach clearcach
clear cach clearcach
class collect ac set princip
node hierarchi
entri
collect string princip name principalnam
list access control entri accesscontrolentri user ac userac arrai list arraylist
list access control entri accesscontrolentri group ac groupac arrai list arraylist
entri node impl nodeimpl node collect string princip name principalnam repositori except repositoryexcept
princip name principalnam princip name principalnam
...
build acl access control node
node impl nodeimpl acl node aclnod node node getnod polici polici
collectentri aclnod principalnamestoentri
collect entri acl collectentriesfromacl acl node aclnod
recurs access control parent hierarchi
root node rootnodeid equal node getid
node impl nodeimpl parent node parentnod node impl nodeimpl node parent getpar
collect entri collectentri parent node parentnod
separ collect entri defin user group
princip
param aclnod acl node
throw repositoryexcept error occur
collect entri acl collectentriesfromacl node impl nodeimpl acl node aclnod repositori except repositoryexcept
session impl sessionimpl impl simpl session impl sessionimpl acl node aclnod session getsess
princip manag principalmanag princip mgr principalmgr impl simpl princip manag getprincipalmanag
access control manag accesscontrolmanag mgr acmgr impl simpl access control manag getaccesscontrolmanag
collect ac present aclnod
list access control entri accesscontrolentri gace arrai list arraylist access control entri accesscontrolentri
list access control entri accesscontrolentri uac arrai list arraylist access control entri accesscontrolentri
...
process acenod 'principalname' contain set
princip name principalnam princip principalnam
princip princ princip mgr principalmgr princip getprincip princip principalnam
princ
log warn princip princip principalnam unknown principalmanag evalu
...
access control entri accesscontrolentri ac acl templat acltempl entri
princ
priv
ac node acenod node type isnodetyp access control constant accesscontrolconst rep grant ac rep grant ac
impl simpl factori getvaluefactori
add proper list separ princip
note access control entri collect revers
order order assert proper evalu
princ group
gace add ac
uac add ac
add list ac list entri
hierarchi
gace empti isempti
group ac groupac add addal gace
uac empti isempti
user ac userac add addal uac
iter access control entri accesscontrolentri iter
iter chain iteratorchain user ac userac iter group ac groupac iter
