...
edit mode editmod
inheritdoc
node state nodest creat createnew node nodeid qname node type nodetypenam
...
state
inheritdoc
properti state propertyst creat createnew qname prop propnam node nodeid parent parentid
illeg state except illegalstateexcept
edit mode editmod
illeg state except illegalstateexcept edit mode
