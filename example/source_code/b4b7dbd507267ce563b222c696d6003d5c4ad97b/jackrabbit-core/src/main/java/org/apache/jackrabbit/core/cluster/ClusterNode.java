...
org apach jackrabbit core journal file revis filerevis
...
string revis revisionnam paramet getparamet properti getproperti revis revis
revis revisionnam
string msg revis
cluster except clusterexcept msg
instanc revis instancerevis file revis filerevis file revis revisionnam
journal journal instanc newinst
journal init cluster node clusternodeid cluster context clustercontext namespac resovl getnamespaceresovl
journal regist
...
param configur code null code random
string cluster node getclusternodeid string
system properti getproperti system properti node system properti node
hex string tohexstr math random short max max short min min
...
workspac workspac
inheritdoc
lock node nodeid node nodeid deep string owner
statu start
...
record journal produc getproduc produc produc append
record write string writestr workspac
write record node nodeid deep owner
record write char writechar
record updat
set revis setrevis record revis getrevis
succeed
...
record cancel updat cancelupd
inheritdoc
unlock node nodeid node nodeid
statu start
...
path path element pathel child rel path childrelpath record read path element readpathel
qname ntname record read readqnam
...
write record record node nodeid node nodeid deep isdeep string owner
journal except journalexcept
write record node nodeid deep isdeep owner
write record record node nodeid node nodeid
journal except journalexcept
write record node nodeid
...
record write writeqnam qname iter
...
write record record node nodeid node nodeid lock islock
deep isdeep string owner
journal except journalexcept
record write char writechar
...
record write string writestr owner
