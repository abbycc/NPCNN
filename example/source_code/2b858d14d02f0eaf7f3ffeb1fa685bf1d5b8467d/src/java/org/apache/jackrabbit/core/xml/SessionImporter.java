...
org apach jackrabbit core refer referencevalu
...
rememb uuid map
node node type isnodetyp constant mix referenc mix referenc
...
node impl nodeimpl conflict
conflict node impl nodeimpl session node uuid getnodebyuuid uuid
...
creat uuid
node creat node createnod parent node nodenam ntname mixin uuid
process properti
...
valu length
val valu
string origin val string getstr
