...
map dav session davsess set object session map sessionmap hash map hashmap dav session davsess set object
map object dav session davsess refer session map referencetosessionmap hash map hashmap object dav session davsess
