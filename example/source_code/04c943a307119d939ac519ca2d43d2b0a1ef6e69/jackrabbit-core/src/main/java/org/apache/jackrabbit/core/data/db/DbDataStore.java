...
param link setcopywhenread int copywhenread true
param link settableprefix int tableprefix
datastor
pre
...
conn close silent closesil
put back putback conn
getdatabaseresourc close resourc success client
stream back resourc close close resourc
param identifi data identifi
return databas resourc back stream
pass data identifi
throw datastoreexcept data store access
identifi invalid
resourc dbresourc databas resourc getdatabaseresourc data identifi dataidentifi identifi data store except datastoreexcept
...
prep result set getresultset
data store except datastoreexcept record found identifi
input stream inputstream result
input stream inputstream stream binari stream getbinarystream
stream
stream null ahead close resourc
result byte arrai input stream bytearrayinputstream
databas helper databasehelp close silent closesil
put back putback conn
result buffer input stream bufferedinputstream stream
copi read copywhenread
file temp move temp file movetotempfil result
result temp file input stream tempfileinputstream temp
resourc dbresourc resourc dbresourc resourc dbresourc conn prep result
resourc dbresourc
except
databas helper databasehelp close silent closesil
put back putback conn
...
result set resultset meta tabl gettabl tabl sql tablesql
exist
close
exist
...
tablesql tabl sql tablesql createtablesql creat tabl sql createtablesql
...
tableprefix prefix set configur empti default
...
sql text replac sql tableprefix tabl prefix tableprefix trim
sql
