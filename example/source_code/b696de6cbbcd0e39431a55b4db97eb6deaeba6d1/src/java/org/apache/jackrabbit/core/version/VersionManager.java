...
param vmgr
version manag versionmanag persist version manag persistentversionmanag mgr vmgr string root rootid
mgr vmgr mgr vmgr
...
param base
return
virtual item state provid virtualitemstateprovid virtual item state provid getvirtualitemstateprovid item state provid itemstateprovid base
virt provid virtprovid
node state nodest root state rootstat node state nodest base item state getitemst node nodeid root rootid
virt provid virtprovid default item state provid defaultitemstateprovid mgr vmgr node type manag getnodetypemanag root state rootstat
histori root historyroot virt provid virtprovid add node addnod virt provid virtprovid root state getrootst version histori root version histori root node type registri nodetyperegistri unstructur unstructur
...
map version histori mapversionhistori histori
...
map version mapvers node vhnode version
...
parent virt provid virtprovid node getnod parent histori node historynodenam
histori node historynodenam qname namespac registri impl namespaceregistryimpl default uri default uri uuid substr
virtual node state virtualnodest node vhnode virt provid virtprovid add node addnod parent histori node historynodenam getid node type registri nodetyperegistri version histori version histori
add version
...
repositori except repositoryexcept
virtual node state virtualnodest node vnode virt provid virtprovid add node addnod node vhnode version getnam version getid node type registri nodetyperegistri version version
initi version
