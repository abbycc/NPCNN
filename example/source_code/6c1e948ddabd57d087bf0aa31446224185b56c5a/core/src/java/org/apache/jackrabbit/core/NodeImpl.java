...
primari type primarytypenam unstructur unstructur
...
getqnam equal mix referenc mix referenc
mix referenc node type
equal jcr uuid jcr uuid
jcr uuid properti
...
genvalu internalvalu internalvalu creat uuid hist getrootvers getuuid
getqnam equal hierarchynod hierarchynod
hierarchynod node type
equal jcr creat jcr creat
jcr creat properti
gen valu genvalu intern internalvalu intern internalvalu creat calendar instanc getinst
getqnam equal resourc resourc
resourc node type
equal jcr lastmodifi jcr lastmodifi
jcr lastmodifi properti
gen valu genvalu intern internalvalu intern internalvalu creat calendar instanc getinst
getqnam equal version version
version node type
equal jcr creat jcr creat
jcr creat properti
gen valu genvalu intern internalvalu intern internalvalu creat calendar instanc getinst
getqnam equal base base
base node type
equal jcr primarytyp jcr primarytyp
jcr primarytyp properti
gen valu genvalu intern internalvalu intern internalvalu creat primari type primarytypenam
equal jcr mixintyp jcr mixintyp
...
state thisstat properti haspropertynam jcr mixintyp jcr mixintyp
prop properti impl propertyimpl item mgr itemmgr item getitem properti propertyid state thisstat uuid getuuid jcr mixintyp jcr mixintyp
find definit jcr mixintyp properti creat properti
properti definit impl propertydefinitionimpl def applic properti definit getapplicablepropertydefinit jcr mixintyp jcr mixintyp properti type propertytyp
prop creat child properti createchildproperti jcr mixintyp jcr mixintyp properti type propertytyp def
mixin name mixinnam empti isempti
purg empti jcr mixintyp properti
remov child properti removechildproperti jcr mixintyp jcr mixintyp
...
remov refer node
node type impl nodetypeimpl mixin mgr ntmgr node type getnodetyp mixin mixinnam
mix referenc mix referenc equal mixin mixinnam
mixin deriv isderivedfrom mix referenc mix referenc
ent remain entremain includ node type includesnodetyp mix referenc mix referenc
...
check state instanc
saniti check sanitycheck
node type isnodetyp mix referenc mix referenc
...
node impl nodeimpl
depth getdepth node type isnodetyp mix referenc mix referenc
...
properti prop intern set properti internalsetproperti jcr ischeckedout jcr ischeckedout intern internalvalu creat
prop save
prop intern set properti internalsetproperti jcr basevers jcr basevers intern internalvalu creat uuid uuid getuuid
prop save
prop intern set properti internalsetproperti jcr predecessor jcr predecessor intern internalvalu empti arrai empti arrai properti type propertytyp refer
prop save
inheritdoc
checkout
...
properti prop intern set properti internalsetproperti jcr ischeckedout jcr ischeckedout intern internalvalu creat
prop save
prop intern set properti internalsetproperti jcr predecessor jcr predecessor
intern internalvalu
...
saniti check sanitycheck
check version checkversion
version histori versionhistori properti getproperti jcr versionhistori jcr versionhistori node getnod
inheritdoc
...
saniti check sanitycheck
check version checkversion
version properti getproperti jcr basevers jcr basevers node getnod
...
check version checkversion
unsupport repositori oper except unsupportedrepositoryoperationexcept repositori except repositoryexcept
node type isnodetyp mix version mix version
...
src node srcnode
version updat
node type isnodetyp mix version mix version fail id failedid
src node srcnode
sourc node version leav
src node srcnode node type isnodetyp mix version mix version
test version
...
val properti getproperti jcr predecessor jcr predecessor valu getvalu
...
intern set properti internalsetproperti jcr predecessor jcr predecessor
save
save
return
throw repositoryexcept
...
properti hasproperti jcr mergefail jcr mergefail
val properti getproperti jcr mergefail jcr mergefail valu getvalu
val length
...
set empti isempti
intern set properti internalsetproperti jcr mergefail jcr mergefail intern internalvalu
...
intern set properti internalsetproperti jcr mergefail jcr mergefail val
...
neg impact perform
node impl nodeimpl node
node properti hasproperti jcr ischeckedout jcr ischeckedout
node depth getdepth
node node impl nodeimpl node parent getpar
node properti getproperti jcr ischeckedout jcr ischeckedout boolean getboolean
...
properti impl propertyimpl properti impl propertyimpl iter properti nextproperti
ignor system type
getqnam equal jcr primarytyp jcr primarytyp
getqnam equal jcr mixintyp jcr mixintyp
getqnam equal jcr uuid jcr uuid
...
child node type isnodetyp mix referenc mix referenc
...
intern set properti internalsetproperti jcr ischeckedout jcr ischeckedout intern internalvalu creat
...
intern set properti internalsetproperti jcr basevers jcr basevers intern internalvalu creat uuid version getid
n' jcr predecessor properti set null
intern set properti internalsetproperti jcr predecessor jcr predecessor intern internalvalu empti arrai empti arrai properti type propertytyp refer
clear mergefail
intern set properti internalsetproperti jcr mergefail jcr mergefail intern internalvalu
...
prop getqnam equal jcr versionhistori jcr versionhistori
prop getqnam equal jcr predecessor jcr predecessor
...
check state instanc
saniti check sanitycheck
node type isnodetyp mix lockabl mix lockabl
