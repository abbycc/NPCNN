...
org apach jackrabbit core nodetyp node def impl nodedefimpl
...
org apach jackrabbit core nodetyp properti def impl propertydefimpl
...
state thisstat properti entri haspropertyentri getnam
...
state thisstat child node entri getchildnodeentri getnam
...
transient istransi
iter iter state mgr statemgr descend transient item state getdescendanttransientitemst
iter hasnext
...
statu clear
node state nodest state thisstat node state nodest state
state thisstat properti entri haspropertyentri
...
prop state propstat state mgr statemgr creat transient properti state createtransientpropertyst parent uuid parentuuid item state itemst statu statu
...
node state nodest state mgr statemgr creat transient node state createtransientnodest uuid node type nodetyp getqnam parent uuid parentuuid item state itemst statu statu
...
illeg except illegalnameexcept in
repositori except repositoryexcept invalid properti prop propnam in
unknown prefix except unknownprefixexcept up
repositori except repositoryexcept invalid properti prop propnam up
...
item isnod
properti
throw itemexistsexcept itemmgr safegetjcrpath nodepath
node
check sibl set exist node
def allowsamenamesib
nodeimpl item getdefinit allowsamenamesib
throw itemexistsexcept itemmgr safegetjcrpath nodepath
catch pathnotfoundexcept pnfe
collis
node state nodest state thisstat node state nodest state
state thisstat properti entri haspropertyentri node nodenam
properti
...
node impl nodeimpl item mgr itemmgr item getitem newid definit getdefinit sib allowsamenamesib
item exist except itemexistsexcept item mgr itemmgr safe jcr path safegetjcrpath node path nodepath
...
state thisstat properti entri haspropertyentri jcr mixintyp jcr mixintyp
...
properti def impl propertydefimpl def applic properti def getapplicablepropertydef jcr mixintyp jcr mixintyp properti type propertytyp
...
node 'new'
persist state persistentst state mgr statemgr creat createnew transient state transientst uuid getuuid
transient state transientst node type getnodetypenam transient state transientst parent uuid getparentuuid
...
check lock statu
check lock checklock
node type impl nodetypeimpl node type nodetypenam
...
check lock statu
check lock checklock
type properti type propertytyp undefin type gettyp
bit set bitset statu bit set bitset
properti impl propertyimpl prop creat properti getorcreateproperti type statu
prop set setvalu
repositori except repositoryexcept
...
make node check
intern check internalischeckedout
string msg safe jcr path safegetjcrpath set properti check node
log debug msg
version except versionexcept msg
check lock statu
check lock checklock
...
effort convers
bit set bitset statu bit set bitset
properti impl propertyimpl prop creat properti getorcreateproperti properti type propertytyp undefin statu
prop set setvalu
repositori except repositoryexcept
statu creat
set fail rid newli creat properti
...
saniti check sanitycheck
path nodepath
nodepath path creat getprimarypath relpath session getnamespaceresolv true
catch malformedpathexcept
string msg fail resolv path relpath rel safegetjcrpath
log debug msg
throw repositoryexcept msg
item item itemmgr getitem nodepath
item isnod
return node item
properti child node
throw pathnotfoundexcept relpath
catch accessdeniedexcept ad
throw pathnotfoundexcept relpath
...
saniti check sanitycheck
path proppath
proppath path creat getprimarypath relpath session getnamespaceresolv true
catch malformedpathexcept
string msg fail resolv path relpath rel safegetjcrpath
log debug msg
throw repositoryexcept msg
...
prop save
prop intern set properti internalsetproperti jcr predecessor jcr predecessor intern internalvalu
prop save
inheritdoc
checkout
...
unsupport repositori oper except unsupportedrepositoryoperationexcept
workspac except nosuchworkspaceexcept access deni except accessdeniedexcept version except versionexcept
lock except lockexcept invalid item state except invaliditemstateexcept repositori except repositoryexcept
intern merg internalmerg src workspac srcworkspac effort besteffort
...
check lock checklock
check 'own' version
version impl versionimpl version version histori getcontainingversionhistori issam version histori getversionhistori
...
node impl nodeimpl merg test domergetest session impl sessionimpl src session srcsession updat effort besteffort
...
src node srcnode
version updat
node type isnodetyp mix version mix version updat
src node srcnode
...
check pend
session pend haspendingchang
string msg unabl updat updat merg node session pend
log debug msg
invalid item state except invaliditemstateexcept msg
workspac ignor
...
intern merg internalmerg src session srcsession updat effort besteffort remov exist removeexist replac exist replaceexist
repositori except repositoryexcept
session refresh
repositori except repositoryexcept
ignor
...
throw lockexcept
throw repositoryexcept
intern merg internalmerg session impl sessionimpl src session srcsession updat effort besteffort remov exist removeexist replac exist replaceexist
lock except lockexcept repositori except repositoryexcept
node impl nodeimpl src node srcnode merg test domergetest src session srcsession updat effort besteffort
src node srcnode
leav iter children
...
dst node dstnode intern merg internalmerg src session srcsession updat effort besteffort remov exist removeexist replac exist replaceexist
...
intern set properti internalsetproperti jcr predecessor jcr predecessor intern internalvalu properti type propertytyp refer
clear mergefail
intern set properti internalsetproperti jcr mergefail jcr mergefail intern internalvalu
...
found node tree
item exist except itemexistsexcept unabl restor node item exist restor tree exist safe jcr path safegetjcrpath
item found except itemnotfoundexcept
...
delet opv copi children
found node tree
item exist except itemexistsexcept unabl restor node item exist restor tree safe jcr path safegetjcrpath
