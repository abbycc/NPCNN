...
org apach jackrabbit core persist bundl cach persist manag cachingpersistencemanag
...
item state except nosuchitemstateexcept item state except itemstateexcept
ism lock ismlock read lock readlock read lock readlock acquir read lock acquirereadlock target gettargetid
check persist manag
...
ism lock ismlock read lock readlock read lock readlock
read lock readlock acquir read lock acquirereadlock target gettargetid
item state except itemstateexcept
check persist manag
...
chang log
iter item state itemst iter local modifi state modifiedst iter hasnext
...
item state except itemstateexcept
node def nodedef def reg ntreg node def getnodedef definit getdefinitionid
...
iter item state itemst iter local delet state deletedst iter hasnext
item state itemst state iter
state connect item state getitemst state getid
state stale isstal
string msg state getid modifi extern
...
iter item state itemst iter local ad state addedst iter hasnext
item state itemst state iter
state connect creat instanc createinst state
share ad state overlai state getoverlayedst
filter virtual node refer process
comment
iter node refer noderefer iter local modifi ref modifiedref iter hasnext
node refer noderefer ref iter
virtual
node nodeid ref getid target gettargetid
virtual provid virtualprovid length
virtual provid virtualprovid item state hasitemst
...
event channel eventchannel updat cancel updatecancel
local disconnect
iter item state itemst iter share modifi state modifiedst iter hasnext
item state itemst state iter
state copi load item state loaditemst state getid
item state except itemstateexcept
state discard
iter item state itemst iter share delet state deletedst iter hasnext
item state itemst state iter
state copi load item state loaditemst state getid
item state except itemstateexcept
state discard
iter item state itemst iter share ad state addedst iter hasnext
item state itemst state iter
state discard
write lock writelock
write lock writelock releas
...
iter item state itemst local ad state addedst hasnext
item state itemst state
state node isnod
remov ref target ad extern jcr
item state hasitemst state getid
...
iter item state itemst local modifi state modifiedst hasnext
item state itemst state
state node isnod
remov refer target
remov refer removerefer item state getitemst state getid
...
iter item state itemst local delet state deletedst hasnext
...
valu valu length
add refer addrefer properti properti getpropertyid valu uuid getuuid
add refer addrefer properti propertyid uuid uuid
item state except itemstateexcept
...
creat refer instanc
node refer noderefer ref local ref refsid
ref
...
valu valu length
remov refer removerefer
properti properti getpropertyid valu uuid getuuid
remov refer removerefer properti propertyid uuid uuid
item state except itemstateexcept
node refer nodereferencesid ref refsid node refer nodereferencesid uuid
virtual provid virtualprovid
virtual provid virtualprovid node refer hasnoderefer ref refsid
...
persist manag
node refer noderefer ref local ref refsid
ref node refer hasnoderefer ref refsid
ref node refer getnoderefer ref refsid
ref
remov refer
...
delet ad
uuid node referenc
ref refer hasrefer local node node getnodeid
...
chang
iter item state itemst modifi state modifiedst extern modifi state modifiedst
...
log warn msg
state discard
iter item state itemst delet state deletedst extern delet state deletedst
...
jcr system node' definit
node def nodedefid jcr system def jcrsystemdefid
node def nodedefid reg ntreg root node def getrootnodedef getid
effect node type effectivenodetyp ent reg ntreg effect node type geteffectivenodetyp constant nameconst rep root rep root
prop def propdef ent applic properti def getapplicablepropertydef constant nameconst jcr primarytyp jcr primarytyp
properti type propertytyp
jcr system def jcrsystemdefid ent applic child node def getapplicablechildnodedef constant nameconst jcr system jcr system constant nameconst rep system rep system reg ntreg getid
node type except nosuchnodetypeexcept nsnte
...
jcr system state jcrsystemst set definit setdefinitionid jcr system def jcrsystemdefid
...
jcr system state jcrsystemst add properti addpropertynam prop def propdef getnam
properti state propertyst primari type prop primarytypeprop creat instanc createinst prop def propdef getnam jcr system state jcrsystemst node getnodeid
...
primari type prop primarytypeprop set type settyp prop def propdef requir type getrequiredtyp
primari type prop primarytypeprop set multi valu setmultivalu prop def propdef multipl ismultipl
primari type prop primarytypeprop set definit setdefinitionid prop def propdef getid
