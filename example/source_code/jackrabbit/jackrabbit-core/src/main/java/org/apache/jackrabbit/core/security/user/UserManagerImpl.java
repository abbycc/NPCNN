...
link param compat jr16 param present
...
jackrabbit repositori found
default option disabl
string param compat jr16 param compat jr16 compatiblejr16
...
authoriz action execut creation remov
authoriz order contain arrai
note link isautosav autosav turn configur
action execut persist creation remov
authoriz action authorizableact authoriz action authorizableact authoriz action authorizableact
...
param config config param compat jr16 param compat jr16
...
default link userconst member record group
membership
return maximum number group member split structur
group membership split size getgroupmembershipsplits
group membership split size groupmembershipsplits
set authoriz action invok authoriz
creation remov
param authorizableact arrai authoriz action
set authoriz action setauthorizableact authoriz action authorizableact authoriz action authorizableact
authoriz action authorizableact
authoriz action authorizableact authoriz action authorizableact
usermanag
...
admin adminid equal session system issystem
...
implement user manag api retriev
path authoriz
usermanag getauthorizablebypath string
...
check valid princip checkvalidprincip princip node node type isnodetyp rep group rep group
...
text descend isdescend user path userspath path
authorz creat user createus
user node configur tree return null
log error user node path configur user tree user path userspath valid user
node type isnodetyp rep group rep group
text descend isdescend group path groupspath path
authorz creat group creategroup
group node configur tree return null
log error group node path configur group tree group path groupspath valid group
node type return null
log warn unexpect user group node type primari node type getprimarynodetyp getnam
match node return null
authorz
throw code unsupportedrepositoryoperationexcept code
node resid workspac edit code session code
string path getpath node authoriz node authorizablenod unsupport repositori oper except unsupportedrepositoryoperationexcept repositori except repositoryexcept
unsupport repositori oper except unsupportedrepositoryoperationexcept
return session user manag
return session
...
param princip princip valid
param isgroup flag indic princip repres group
check valid princip checkvalidprincip princip princip group isgroup
princip princip getnam equal princip getnam
illeg argument except illegalargumentexcept princip null valid
group isgroup princip everyoneprincip equal princip getnam
illeg argument except illegalargumentexcept 'everyone' reserv group princip
...
configur code authorizableact code perform addit
task creation user
node persist
param user user
param password
throw repositoryexcept except occur
creat oncreat user user string repositori except repositoryexcept
authoriz action authorizableact action authoriz action authorizableact
action creat oncreat user session
configur code authorizableact code perform addit
task creation group
node persist
param group group
throw repositoryexcept except occur
creat oncreat group group repositori except repositoryexcept
authoriz action authorizableact action authoriz action authorizableact
action creat oncreat group session
configur code authorizableact code perform clean
task relat authoriz remov
node remov
param authoriz authoriz remov
throw repositoryexcept except occur
remov onremov authoriz authoriz repositori except repositoryexcept
authoriz action authorizableact action authoriz action authorizableact
action remov onremov authoriz session
configur code authorizableact code perform addit
task password chang user
properti chang
param user target user
param password password
throw repositoryexcept except occur
password chang onpasswordchang user user string password repositori except repositoryexcept
authoriz action authorizableact action authoriz action authorizableact
action password chang onpasswordchang user password session
sessionlisten
