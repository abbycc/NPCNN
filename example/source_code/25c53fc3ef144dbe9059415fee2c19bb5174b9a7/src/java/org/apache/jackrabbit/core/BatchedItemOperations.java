...
parent target node
target set parent uuid setparentuuid dest parent destpar uuid getuuid
...
properti propertyid properti propertyid parent uuid getuuid prop propnam
item exist except itemexistsexcept safe jcr path safegetjcrpath
creat properti
...
repositori except repositoryexcept
string parent uuid parentuuid target parent uuid getparentuuid
...
remov child node entri parent
parent remov child node entri removechildnodeentri target uuid getuuid
store parent
state mgr statemgr store parent
remov target
...
properti propertyid node state nodest uuid getuuid qname jcr ischeckedout jcr ischeckedout
...
properti propertyid prop propid
properti propertyid target state targetst uuid getuuid prop propnam
properti state propertyst prop state propstat
...
repositori except repositoryexcept msg is
unlink target state
target state targetst set parent uuid setparentuuid
...
iter hasnext
qname prop propnam qname iter
properti propertyid prop propid properti propertyid src state srcstate uuid getuuid prop propnam
...
copi properti state copypropertyst src child state srcchildstat uuid prop propnam
version flag copi
version node copi
