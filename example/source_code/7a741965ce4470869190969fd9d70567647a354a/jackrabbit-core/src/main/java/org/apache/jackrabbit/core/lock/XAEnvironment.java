...
info lock info lockinfo node lock token locktoken
...
info lock token locktoken info session scope sessionscop info deep info lock owner lockown
node node
unlock isunlock
...
lock mgr lockmgr intern lock internallock node deep session scope sessionscop
undo oper
