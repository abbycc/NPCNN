...
check state instanc
saniti check sanitycheck
aquir session workspac throw nosuchworkspaceexcept
todo fixm session credenti current
session impl sessionimpl src session srcsession rep system session getsystemsess workspac workspacenam
...
todo fixm session credenti current
session impl sessionimpl src session srcsession rep system session getsystemsess src workspac srcworkspac
...
invalid item state except invaliditemstateexcept msg
check 'own' version
todo chang version getcontainingversionhistori introduc
version parent getpar issam version histori getversionhistori
...
restor frozen state restorefrozenst version frozen node getfrozennod vsel remov exist removeexist
...
param removeexist
throw repositoryexcept
restor frozen state restorefrozenst intern frozen node internalfrozennod freez version selector versionselector vsel remov exist removeexist
repositori except repositoryexcept
check uuid
node type isnodetyp mix referenc mix referenc
...
delet frozen version histori opv version
...
restor frozen state restorefrozenst vsel remov exist removeexist
