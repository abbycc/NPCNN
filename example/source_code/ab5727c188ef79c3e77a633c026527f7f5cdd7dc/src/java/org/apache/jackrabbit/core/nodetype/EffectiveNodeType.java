...
logger log logger logger getlogg effect node type effectivenodetyp
node type registri
...
hash map hashmap name item def nameditemdef
list unnam item definit residu definit
arrai list arraylist unnam item def unnameditemdef
privat constructor
effect node type effectivenodetyp node type registri nodetyperegistri reg ntreg
reg ntreg reg ntreg
...
name item def nameditemdef hash map hashmap
unnam item def unnameditemdef arrai list arraylist
factori method creat effect node type
represent exist regist node type
param ntreg
param nodetypenam
return
throw nodetypeconflictexcept
throw nosuchnodetypeexcept
effect node type effectivenodetyp creat node type registri nodetyperegistri reg ntreg qname node type nodetypenam
node type conflict except nodetypeconflictexcept node type except nosuchnodetypeexcept
creat reg ntreg reg ntreg node type def getnodetypedef node type nodetypenam
factori method creat effect node type
represent node type definit referenc
node type exist regist definit
requir regist
param ntreg
param ntd
return
throw nodetypeconflictexcept
throw nosuchnodetypeexcept
effect node type effectivenodetyp creat node type registri nodetyperegistri reg ntreg node type def nodetypedef ntd
node type conflict except nodetypeconflictexcept node type except nosuchnodetypeexcept
creat empti effect node type instanc
effect node type effectivenodetyp ent effect node type effectivenodetyp reg ntreg
qname ntname ntd getnam
prepar instanc
...
cnda length
cnda defin residu definesresidu
residu node definit
ent unnam item def unnameditemdef add cnda
name node definit
qname cnda getnam
list def list ent name item def nameditemdef
def
def arrai list arraylist
ent name item def nameditemdef put def
def size
exist definit
make auto creat
def size
child item def childitemdef def child item def childitemdef def
cnda auto creat isautocr def auto creat isautocr
conflict
string msg 'auto create' item definit node type ntname
log debug msg
node type conflict except nodetypeconflictexcept msg
def add cnda
prop def propdef pda ntd properti def getpropertydef
pda length
pda defin residu definesresidu
residu properti definit
ent unnam item def unnameditemdef add pda
...
def size
child item def childitemdef def child item def childitemdef def
pda auto creat isautocr def auto creat isautocr
conflict
string msg 'auto create' item definit node type ntname
log debug msg
node type conflict except nodetypeconflictexcept msg
...
ent intern merg internalmerg reg ntreg effect node type geteffectivenodetyp supertyp
ent
factori method creat 'empty' effect node type instanc
return
effect node type effectivenodetyp creat node type registri nodetyperegistri reg ntreg
effect node type effectivenodetyp reg ntreg
qname merg node type getmergednodetyp
qname merg node type mergednodetyp arrai toarrai qname merg node type mergednodetyp size
qname inherit node type getinheritednodetyp
qname inherit node type inheritednodetyp arrai toarrai qname inherit node type inheritednodetyp size
qname node type getallnodetyp
qname node type allnodetyp arrai toarrai qname node type allnodetyp size
child item def childitemdef item def getallitemdef
arrai list arraylist def arrai list arraylist name item def nameditemdef size unnam item def unnameditemdef size
iter iter name item def nameditemdef valu iter
iter hasnext
def add addal list iter
def add addal unnam item def unnameditemdef
child item def childitemdef def arrai toarrai child item def childitemdef def size
child item def childitemdef name item def getnameditemdef
arrai list arraylist def arrai list arraylist name item def nameditemdef size
iter iter name item def nameditemdef valu iter
iter hasnext
def add addal list iter
child item def childitemdef def arrai toarrai child item def childitemdef def size
child item def childitemdef unnam item def getunnameditemdef
child item def childitemdef unnam item def unnameditemdef arrai toarrai child item def childitemdef unnam item def unnameditemdef size
name item def hasnameditemdef qname
name item def nameditemdef kei containskei
child item def childitemdef name item def getnameditemdef qname
list def list name item def nameditemdef
def
child item def childitemdef def arrai toarrai child item def childitemdef def size
child node def childnodedef node def getallnodedef
arrai list arraylist def arrai list arraylist name item def nameditemdef size unnam item def unnameditemdef size
iter iter unnam item def unnameditemdef iter
iter hasnext
child item def childitemdef def child item def childitemdef iter
def defin node definesnod
def add def
iter name item def nameditemdef valu iter
iter hasnext
list list list iter
iter iter1 list iter
iter1 hasnext
child item def childitemdef def child item def childitemdef iter1
def defin node definesnod
def add def
child node def childnodedef def arrai toarrai child node def childnodedef def size
child node def childnodedef name node def getnamednodedef
arrai list arraylist def arrai list arraylist name item def nameditemdef size
iter iter name item def nameditemdef valu iter
iter hasnext
list list list iter
...
def add def
child node def childnodedef def arrai toarrai child node def childnodedef def size
child node def childnodedef unnam node def getunnamednodedef
arrai list arraylist def arrai list arraylist unnam item def unnameditemdef size
iter iter unnam item def unnameditemdef iter
iter hasnext
child item def childitemdef def child item def childitemdef iter
def defin node definesnod
def add def
child node def childnodedef def arrai toarrai child node def childnodedef def size
child node def childnodedef auto creat node def getautocreatenodedef
auto creat item
...
def add def
child node def childnodedef def arrai toarrai child node def childnodedef def size
prop def propdef prop def getallpropdef
arrai list arraylist def arrai list arraylist name item def nameditemdef size unnam item def unnameditemdef size
iter iter unnam item def unnameditemdef iter
iter hasnext
child item def childitemdef def child item def childitemdef iter
...
def defin node definesnod
def add def
prop def propdef def arrai toarrai prop def propdef def size
prop def propdef name prop def getnamedpropdef
arrai list arraylist def arrai list arraylist name item def nameditemdef size
iter iter name item def nameditemdef valu iter
iter hasnext
list list list iter
...
def add def
prop def propdef def arrai toarrai prop def propdef def size
prop def propdef unnam prop def getunnamedpropdef
arrai list arraylist def arrai list arraylist unnam item def unnameditemdef size
iter iter unnam item def unnameditemdef iter
iter hasnext
child item def childitemdef def child item def childitemdef iter
...
def add def
prop def propdef def arrai toarrai prop def propdef def size
prop def propdef auto creat prop def getautocreatepropdef
auto creat item
search name item definit
arrai list arraylist def arrai list arraylist name item def nameditemdef size
iter iter name item def nameditemdef valu iter
...
def add def
prop def propdef def arrai toarrai prop def propdef def size
prop def propdef mandatori prop def getmandatorypropdef
mandatori item
search name item definit
arrai list arraylist def arrai list arraylist name item def nameditemdef size
iter iter name item def nameditemdef valu iter
...
def add def
prop def propdef def arrai toarrai prop def propdef def size
child node def childnodedef mandatori node def getmandatorynodedef
mandatori item
search name item definit
arrai list arraylist def arrai list arraylist name item def nameditemdef size
iter iter name item def nameditemdef valu iter
...
code fals code
includ node type includesnodetyp qname node type nodetypenam
...
check set properti constraint checksetpropertyvalueconstraint prop def propdef intern internalvalu valu
...
param
throw constraintviolationexcept
check add node constraint checkaddnodeconstraint qname
constraint violat except constraintviolationexcept
...
throw constraintviolationexcept
throw nosuchnodetypeexcept
check add node constraint checkaddnodeconstraint qname qname node type nodetypenam
constraint violat except constraintviolationexcept node type except nosuchnodetypeexcept
child node def childnodedef applic child node def getapplicablechildnodedef node type nodetypenam
protect isprotect
...
found
child node def childnodedef applic child node def getapplicablechildnodedef qname qname node type nodetypenam
node type except nosuchnodetypeexcept constraint violat except constraintviolationexcept
name node definit
child item def childitemdef def name item def getnameditemdef
def
def length
child item def childitemdef def def
def defin node definesnod
child node def childnodedef child node def childnodedef def
node definit exist
node type nodetypenam
check node type constraint
check requir primari type checkrequiredprimarytyp node type nodetypenam requir primari type getrequiredprimarytyp
constraint violat except constraintviolationexcept cve
ignor
found node definit
default primari type getdefaultprimarytyp
default node type defin
found node definit default node type
item defin
residu node definit
child node def childnodedef nda unnam node def getunnamednodedef
nda length
child node def childnodedef nda
node type nodetypenam
check node type constraint
check requir primari type checkrequiredprimarytyp node type nodetypenam requir primari type getrequiredprimarytyp
constraint violat except constraintviolationexcept
...
found
prop def propdef applic properti def getapplicablepropertydef qname type
...
child item def childitemdef def def
def defin node definesnod
prop def propdef prop def propdef def
req type reqtyp requir type getrequiredtyp
properti definit exist
match type
...
item defin
residu properti definit
prop def propdef pda unnam prop def getunnamedpropdef
pda length
...
param
throw constraintviolationexcept
check remov item constraint checkremoveitemconstraint qname constraint violat except constraintviolationexcept
multipl definit
applic check
child item def childitemdef def name item def getnameditemdef
def
...
param nodetypenam
param requiredprimarytyp
throw constraintviolationexcept
throw nosuchnodetypeexcept
check requir primari type checkrequiredprimarytyp qname node type nodetypenam qname requir primari type requiredprimarytyp
constraint violat except constraintviolationexcept node type except nosuchnodetypeexcept
requir primari type requiredprimarytyp
constraint
effect node type effectivenodetyp ent
ent reg ntreg effect node type geteffectivenodetyp node type nodetypenam
repositori except repositoryexcept
string msg fail check node type constraint
log debug msg
constraint violat except constraintviolationexcept msg
requir primari type requiredprimarytyp length
ent includ node type includesnodetyp requir primari type requiredprimarytyp
constraint violat except constraintviolationexcept node type constraint satisfi requir primari type requiredprimarytyp
...
node type conflict except nodetypeconflictexcept
qname nta node type getallnodetyp
...
qname def getnam
list exist def existingdef list name item def nameditemdef
exist def existingdef
exist def existingdef size
exist definit
exist def existingdef size
child item def childitemdef exist def existingdef child item def childitemdef exist def existingdef
make auto creat
...
properti definit
prop def propdef prop def propdef def
prop def propdef epd prop def propdef exist def existingdef
...
log debug msg
node type conflict except nodetypeconflictexcept msg
exist def existingdef arrai list arraylist
...
iter iter unnam item def unnameditemdef iter
iter hasnext
child item def childitemdef exist child item def childitemdef iter
compar exist definit
def defin node definesnod exist defin node definesnod
def defin node definesnod
properti definit
prop def propdef prop def propdef def
prop def propdef epd prop def propdef exist
compar type multivalu flag
requir type getrequiredtyp epd requir type getrequiredtyp
multipl ismultipl epd multipl ismultipl
conflict
...
log debug msg
node type conflict except nodetypeconflictexcept msg
todo check ambigu definit conflict
...
inherit node type inheritednodetyp add nta
object clone
effect node type effectivenodetyp clone effect node type effectivenodetyp reg ntreg
...
iter iter name item def nameditemdef kei set keyset iter
iter hasnext
object kei iter
list list list name item def nameditemdef kei
clone name item def nameditemdef put kei arrai list arraylist list
