...
proxi content handler pass sax event
proxi handler
conveni class inherit link defaulthandl class
link contenthandl interfac make
class adapt method
link javax xml parser saxpars pars string defaulthandl
expect defaulthandl instanc contenthandl
proxi content handler proxycontenthandl default handler defaulthandl
proxi content handler protect final field
subclass access proxi handler replac
content handler contenthandl handler
creat proxi content handler
param handler content handler proxi
proxi content handler proxycontenthandl content handler contenthandl handler
handler handler
contenthandl
deleg link handler
param pass
...
deleg link handler
param namespaceuri pass
param localnam pass
param qname pass
throw saxexcept error occur
end element endel
string namespac uri namespaceuri string local localnam string qname
sax except saxexcept
...
param data pass
throw saxexcept error occur
process instruct processinginstruct string target string data
sax except saxexcept
...
handler skip entiti skippedent
deleg link handler
throw saxexcept error occur
...
param uri pass
throw saxexcept error occur
start prefix map startprefixmap string prefix string uri
sax except saxexcept
handler start prefix map startprefixmap prefix uri
object
string string tostr
handler string tostr
