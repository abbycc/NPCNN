...
enabl disabl write lock hack call
link xaversionmanag
param nolockhack
set lock hack setnolockhack lock hack nolockhack
ism lock ismlock default ism lock defaultismlock
default ism lock defaultismlock ism lock ismlock set lock hack setnolockhack lock hack nolockhack
...
local
inheritdoc
event state collect eventstatecollect event getev
event
...
reg ntreg effect node type geteffectivenodetyp type includ node type includesnodetyp constant nameconst mix referenc mix referenc
