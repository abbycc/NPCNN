...
org apach jackrabbit core helper valuehelp
...
session node type manag getnodetypemanag node type getnodetyp state node type getnodetypenam
...
session node type manag getnodetypemanag node type getnodetyp unstructur unstructur
node type nodetyp
...
code link node getrefer code
method filter refer exist
workspac code skipinexist code set code true code
param skipinexist set code true code inexist item skip
properti iter propertyiter refer getrefer skip inexist skipinexist
repositori except repositoryexcept
...
lazi item iter lazyitemiter item mgr itemmgr list idlist skip inexist skipinexist
item state except itemstateexcept
string msg unabl retriev node refer
log debug msg
repositori except repositoryexcept msg
...
node type nodetyp deriv isderivedfrom mixin mixinnam
...
mixin name mixinnam empti isempti
node type registri nodetyperegistri reg ntreg session node type manag getnodetypemanag node type registri getnodetyperegistri
effect node type effectivenodetyp ent reg ntreg effect node type geteffectivenodetyp qname mixin name mixinnam arrai toarrai qname mixin name mixinnam size
...
property' definit
import method public order make access
intern code locat subpackag call
applic directli
param
param
return
...
check state instanc
saniti check sanitycheck
string node type nodetyp primari item getprimaryitemnam
item found except itemnotfoundexcept
...
check state instanc
saniti check sanitycheck
todo optim build entir path find node' index
index primari path getprimarypath element getnameel index getindex
index
index
