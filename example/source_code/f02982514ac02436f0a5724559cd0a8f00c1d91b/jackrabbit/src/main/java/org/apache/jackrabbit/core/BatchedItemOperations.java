...
src access mgr srcaccessmgr grant isgrant src state srcstate node getnodeid access manag accessmanag read
...
uuid origin uuid val intern internalvalu
...
access mgr accessmgr grant isgrant parent state parentst node getnodeid access manag accessmanag read
...
access mgr accessmgr grant isgrant parent state parentst node getnodeid access manag accessmanag write
...
constraint violat except constraintviolationexcept safe jcr path safegetjcrpath parent state parentst node getnodeid
...
node refer nodereferencesid ref refsid node refer nodereferencesid target state targetst node getnodeid
...
access mgr accessmgr grant isgrant node node getnodeid access manag accessmanag read
...
access mgr accessmgr grant isgrant node node getnodeid access manag accessmanag write
access deni except accessdeniedexcept safe jcr path safegetjcrpath node node getnodeid
allow modifi node
lock statu
...
prop def propdef ent applic properti def getapplicablepropertydef qname jcr mixintyp jcr mixintyp
...
node state nodest properti haspropertynam qname jcr ischeckedout jcr ischeckedout
...
properti propertyid node state nodest node getnodeid qname jcr ischeckedout jcr ischeckedout
...
qname def getnam
qname mix referenc mix referenc equal declar declaringnt
mix referenc node type
qname jcr uuid jcr uuid equal
jcr uuid properti
gen valu genvalu intern internalvalu intern internalvalu creat
parent node getnodeid uuid getuuid string tostr
qname base base equal declar declaringnt
base node type
qname jcr primarytyp jcr primarytyp equal
jcr primarytyp properti
gen valu genvalu intern internalvalu intern internalvalu creat parent node type getnodetypenam
qname jcr mixintyp jcr mixintyp equal
...
qname hierarchynod hierarchynod equal declar declaringnt
hierarchynod node type
qname jcr creat jcr creat equal
jcr creat properti
gen valu genvalu intern internalvalu intern internalvalu creat calendar instanc getinst
qname resourc resourc equal declar declaringnt
resourc node type
qname jcr lastmodifi jcr lastmodifi equal
jcr lastmodifi properti
gen valu genvalu intern internalvalu intern internalvalu creat calendar instanc getinst
qname version version equal declar declaringnt
version node type
qname jcr creat jcr creat equal
jcr creat properti
gen valu genvalu intern internalvalu intern internalvalu creat calendar instanc getinst
...
referenc ent includ node type includesnodetyp qname mix referenc mix referenc
version ent includ node type includesnodetyp qname mix version mix version
flag
copi
creat uuid
node nodeid uuid random uuid randomuuid
referenc
rememb uuid map
ref tracker reftrack map uuid mappeduuid src state srcstate node getnodeid uuid getuuid uuid getuuid
clone
referenc
...
ancestor thereof
path hier mgr hiermgr path getpath dest parent destparentid
...
copi properti
iter src state srcstate properti name getpropertynam iter
iter hasnext
qname prop propnam qname iter
...
def declar node type getdeclaringnodetyp equal qname mix lockabl mix lockabl
...
version flag copi
version node copi
copi properti declar mix version
adjust
prop propnam equal qname jcr versionhistori jcr versionhistori
jcr versionhistori
version histori versionhistori creat version histori getorcreateversionhistori state newstat
child state newchildst set valu setvalu intern internalvalu intern internalvalu creat uuid uuid getuuid
prop propnam equal qname jcr basevers jcr basevers
jcr basevers
version histori versionhistori creat version histori getorcreateversionhistori state newstat
child state newchildst set valu setvalu intern internalvalu intern internalvalu creat uuid root version getrootvers uuid getuuid
prop propnam equal qname jcr predecessor jcr predecessor
jcr predecessor
version histori versionhistori creat version histori getorcreateversionhistori state newstat
child state newchildst set valu setvalu intern internalvalu intern internalvalu creat uuid root version getrootvers uuid getuuid
prop propnam equal qname jcr ischeckedout jcr ischeckedout
jcr ischeckedout
...
mix lockabl
todo fixm deleg 'node type instanc handler'
def declar node type getdeclaringnodetyp equal qname mix referenc mix referenc
prop propnam equal qname jcr uuid jcr uuid
set correct jcr uuid properti
state newstat set valu setvalu intern internalvalu intern internalvalu creat parent parentid uuid getuuid string tostr
...
state newstat
return version histori node state
version histori creat exist
param node node state
return version histori target node state
throw repositoryexcept error occur
version histori versionhistori creat version histori getorcreateversionhistori node state nodest node
repositori except repositoryexcept
version manag versionmanag mgr vmgr session version manag getversionmanag
version histori versionhistori mgr vmgr version histori getversionhistori session node
creat version histori
mgr vmgr creat version histori createversionhistori session node
