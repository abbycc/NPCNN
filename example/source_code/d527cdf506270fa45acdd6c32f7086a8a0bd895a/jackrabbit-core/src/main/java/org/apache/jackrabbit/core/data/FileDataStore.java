...
directori mkdir
inheritdoc
data record datarecord record store getrecordifstor data identifi dataidentifi identifi
file file file getfil identifi
file exist
min modifi date minmodifiedd file write canwrit
...
string file filenam file getnam
file modifi lastmodifi min
data identifi dataidentifi data identifi dataidentifi file filenam
inus kei containskei
log info enabl isinfoen
log info delet file file absolut path getabsolutepath
modifi timestamp file modifi lastmodifi string tostr
length file length
file delet
count
