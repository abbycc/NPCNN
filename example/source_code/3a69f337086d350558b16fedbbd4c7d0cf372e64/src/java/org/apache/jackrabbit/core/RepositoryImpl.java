...
mgr vmgr version manag impl versionmanagerimpl mgr pvmgr reg ntreg deleg dispatch delegatingdispatch
...
add nodetyp
sy session syssess node type manag getnodetypemanag node type getnodetyp rep nodetyp rep nodetyp
sy root sysroot intern add child node internaladdchildnod jcr nodetyp jcr nodetyp nodetyp node uuid nodetyp node uuid
...
workspac
throw repositoryexcept error occur
session impl sessionimpl creat session createsess subject subject string workspac workspacenam
workspac except nosuchworkspaceexcept access deni except accessdeniedexcept
repositori except repositoryexcept
workspac info workspaceinfo wsp info wspinfo workspac info getworkspaceinfo workspac workspacenam
...
auth ctx authctx auth context authcontext local lmc credenti
...
item state mgr itemstatemgr add virtual item state provid addvirtualitemstateprovid mgr vmgr virtual item state provid getvirtualitemstateprovid item state mgr itemstatemgr
