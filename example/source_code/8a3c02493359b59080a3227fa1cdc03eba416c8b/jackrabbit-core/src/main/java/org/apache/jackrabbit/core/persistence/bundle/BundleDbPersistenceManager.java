...
child
log error nodest uuid getuuid refer inexist child entri getnam entri getid uuid getuuid
...
node refer insert sql nodereferenceinsertsql insert schema object prefix schemaobjectprefix ref ref data node node valu
node refer updat sql nodereferenceupdatesql updat schema object prefix schemaobjectprefix ref set ref data node node
...
bundl select id sql bundleselectallidsfromsql select node node schema object prefix schemaobjectprefix bundl node null order node node
