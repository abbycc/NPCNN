...
iter queri term queryterm iter
hasnext
term term text
...
term vector offset info termvectoroffsetinfo offset term vector offset info termvectoroffsetinfo list arrai toarrai term vector offset info termvectoroffsetinfo list size
sort offset
term length
...
fragment info fragmentinfo fragment info fragmentinfo fragment list bestfragmentslist
trim
...
len reader read buf
excerpt append buf len
len buf length
excerpt length min
charact whitespac iswhitespac excerpt char charat
excerpt delet excerpt length
excerpt append
...
iter offset info list offsetinfoslist iter
hasnext
term vector offset info termvectoroffsetinfo tvoi term vector offset info termvectoroffsetinfo
