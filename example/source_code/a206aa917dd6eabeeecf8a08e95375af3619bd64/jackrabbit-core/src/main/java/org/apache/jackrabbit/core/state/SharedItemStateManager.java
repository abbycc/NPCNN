...
flag enabl hierarchi valid
href http issu apach org jira brows jcr jcr
valid hierarchi valid hierarchi
boolean boolean getboolean org apach jackrabbit core state validatehierarchi
...
updat event channel default dummi channel simpli
ignor event check null time
cluster environ
link seteventchannel updateeventchannel method call
initi connect sism instanc cluster
updat event channel updateeventchannel event channel eventchannel dummi updat event channel dummyupdateeventchannel
...
virtual item state provid virtualitemstateprovid virtual provid virtualprovid virtual provid virtualprovid
...
fall virtual state provid afford
except control flow perform hit
perform critic content virtual
catch avoid extra hasnonvirtualitemst call
...
inheritdoc
string string tostr
shareditemstatemanag string tostr
referencecach cach
misc public method
...
attribut store size updat
string attribut updat size attribut updat size updates
local chang log
...
item state except itemstateexcept messag getmessag
...
effect node type effectivenodetyp effect node type geteffectivenodetyp ntname node type except nosuchnodetypeexcept
reg ntreg effect node type geteffectivenodetyp ntname
...
iter item state itemst delet local delet state deletedst iter
delet hasnext
item state itemst state delet
state connect item state getitemst state getid
state stale isstal
string msg state getid modifi extern
log debug msg
...
item state except nosuchitemstateexcept
item state delet extern
delet remov
item state itemst state local ad state addedst
state node isnod state statu getstatu item state itemst statu statu
node creat
meantim caus mid air collis
concurr version oper jcr
...
valid hierarchi valid hierarchi
log info valid chang set hierarchi
valid hierarchi validatehierarchi local
item state except itemstateexcept
repositori except repositoryexcept
item state except itemstateexcept invalid hierarchi
...
set attribut setattribut attribut updat size attribut updat size share updat size getupdates
succeed
...
cancel
ism lock ismlock read lock readlock read lock readlock
make item state present referenc cach
lock downgrad read lock
thread read
sism potenti read ad item state
put cach
share persist jcr
item state itemst state share ad state addedst
except
share changelog item remov
ad item updat cach
lead warn messag
itemstatereferencecach jcr
share delet state getid
...
listen finish oper
happen final block cluster lock
releas post store except
thrown code jcr
string path event session getsess user getuserid
event session getsess workspac getworkspac getnam
event common path getcommonpath
event channel eventchannel updat commit updatecommit path
set attribut setattribut attribut updat size attribut updat size
write lock writelock
...
string msg
node node getnodeid remov
referenc
log debug msg ref refer getrefer
...
valid hierarchi consist changelog
param changelog
local changelog valid
throw itemstateexcept
hierarchi inconsist
throw repositoryexcept
consist valid
valid hierarchi validatehierarchi chang log changelog chang log changelog item state except itemstateexcept repositori except repositoryexcept
check delet node state
valid delet validatedelet chang log changelog
check ad node state
valid ad validatead chang log changelog
check modifi node state
valid modifi validatemodifi chang log changelog
check parent children delet node state changelog
param changelog
local changelog valid
throw itemstateexcept
hierarchi inconsist
valid delet validatedelet chang log changelog chang log changelog item state except itemstateexcept
check delet nodest
item state itemst remov state removedst chang log changelog delet state deletedst
remov state removedst node state nodest
state
node state nodest remov node state removednodest node state nodest remov state removedst
node nodeid remov node state removednodest node getnodeid
check overlai state
node state nodest overlai state overlayedst node state nodest remov state removedst overlai state getoverlayedst
overlai state overlayedst
string messag unabl load persist state remov node
overlai state overlayedst node state nodest share item state manag shareditemstatemanag item state getitemst
overlai state overlayedst
log error messag
item state except itemstateexcept messag
check version node restor
ad remov addedandremov chang log changelog remov node state removednodest getid
ad remov addedandremov
check parent delet
modifi reflect remov child
node nodeid parent oldparentid overlai state overlayedst parent getparentid
chang log changelog delet parent oldparentid
chang log changelog modifi ismodifi parent oldparentid
string messag node
remov parent node part changelog parent oldparentid
log error messag
item state except itemstateexcept messag
origin list child id
child node entri childnodeentri entri overlai state overlayedst child node entri getchildnodeentri
check child delet
modifi reflect move
node nodeid child childid entri getid
chang log changelog delet child childid
chang log changelog modifi ismodifi child childid
string messag node
remov child node part changelog
child childid
log error messag
item state except itemstateexcept messag
check parent children ad node state changelog
param changelog
local changelog valid
throw itemstateexcept
hierarchi inconsist
valid ad validatead chang log changelog chang log changelog item state except itemstateexcept
check ad node
item state itemst state chang log changelog ad state addedst
state node state nodest
ad node
node state nodest ad node state addednodest node state nodest state
node nodeid ad node state addednodest node getnodeid
check parent
node nodeid parent parentid ad node state addednodest parent getparentid
chang log changelog parent parentid changelog parentid ad modifi
modifi state check
check parent checkpar chang log changelog ad node state addednodest parent parentid
string messag node
ad parent node part changelog parent parentid
log error messag
item state except itemstateexcept messag
check children
child node entri childnodeentri entri ad node state addednodest child node entri getchildnodeentri
child
node nodeid child childid entri getid
chang log changelog child childid
node state nodest child state childstat node state nodest chang log changelog child childid
check parent checkpar chang log changelog child state childstat
child state check
string messag node
ad child node part changelog child childid
log error messag
item state except itemstateexcept messag
check parent children modifi node state changelog
param changelog
local changelog valid
throw itemstateexcept
hierarchi inconsist
valid modifi validatemodifi chang log changelog chang log changelog item state except itemstateexcept repositori except repositoryexcept
check modifi node
item state itemst state chang log changelog modifi state modifiedst
state node state nodest
check node
node state nodest modifi node state modifiednodest node state nodest state
node nodeid modifi node state modifiednodest node getnodeid
check overlai state present determin diff
node state nodest overlai state overlayedst node state nodest modifi node state modifiednodest overlai state getoverlayedst
overlai state overlayedst
string messag unabl load persist state modifi node
log error messag
item state except itemstateexcept messag
check parent
node nodeid parent parentid modifi node state modifiednodest parent getparentid
node nodeid parent oldparentid overlai state overlayedst parent getparentid
parent delet
parent parentid chang log changelog delet parent parentid
string messag parent node delet
log error messag
item state except itemstateexcept messag
parent parentid chang log changelog parent parentid
check parent checkpar chang log changelog modifi node state modifiednodest parent parentid
parent parentid parent oldparentid
parent parentid parent parentid equal parent oldparentid
node root move check
parent modifi
chang log changelog parent parentid
check parent checkpar chang log changelog modifi node state modifiednodest parent parentid
shareabl isshar modifi node state modifiednodest
string messag parent node present changelog
log error messag
item state except itemstateexcept messag
parent modifi delet
chang log changelog modifi ismodifi parent oldparentid chang log changelog delet parent oldparentid
string messag node
move origin parent part changelog
parent oldparentid
log error messag
item state except itemstateexcept messag
check assign children
child node entri childnodeentri entri modifi node state modifiednodest child node entri getchildnodeentri
node nodeid child childid entri getid
check node delet childid
chang log changelog delet child childid chang log changelog child childid changelog delet childid changelog childid version
string messag node delet childid child childid
log error messag
item state except itemstateexcept messag
chang log changelog child childid
node state nodest child state childstat node state nodest chang log changelog child childid
check parent checkpar chang log changelog child state childstat
check children ad
child node entri childnodeentri entri modifi node state modifiednodest ad child node entri getaddedchildnodeentri
node nodeid child childid entri getid
chang log changelog child childid
string messag childid child childid ad parent
present changelog
log error messag
item state except itemstateexcept messag
check children move remov
child node entri childnodeentri entri modifi node state modifiednodest remov child node entri getremovedchildnodeentri
node nodeid child childid entri getid
chang log changelog modifi ismodifi child childid chang log changelog delet child childid
string messag child node entri child childid
remov present changelog
log error messag
item state except itemstateexcept messag
check consist parent child relationship
param changelog
changelog check
param childstat
node parent child relationship valid
param expectedpar
expect parent child node
throw itemstateexcept
inconsist detect
check parent checkpar chang log changelog chang log changelog node state nodest child state childstat node nodeid expect parent expectedpar item state except itemstateexcept
check changelog entri parent
node nodeid parent parentid child state childstat parent getparentid
parent parentid equal expect parent expectedpar
set node nodeid share set sharedset child state childstat share set getsharedset
share set sharedset expect parent expectedpar
string messag child node child state childstat getid parent parent parentid expect expect parent expectedpar
log error messag
item state except itemstateexcept messag
chang log changelog parent parentid
string messag parent part changelog
log error messag
item state except itemstateexcept messag
parent changelog
node state nodest parent node state nodest chang log changelog parent parentid
check child node entri parent
node nodeid child childid child state childstat node getnodeid
child node entri childnodeentri child node entri childnodeentri parent child node entri getchildnodeentri child childid
child node entri childnodeentri
string messag child present parent
log error messag
item state except itemstateexcept messag
determin node shareabl mixin type code mix shareabl code
directli assign indirectli inherit
param state
node state check
...
effect node type effectivenodetyp type reg ntreg effect node type geteffectivenodetyp primari mixin
type includ node type includesnodetyp constant nameconst mix shareabl mix shareabl
node type conflict except nodetypeconflictexcept ntce
string msg intern error fail build effect node type node state node getnodeid
log debug msg
...
persist mgr persistmgr store chang log changelog
chang log changelog persist
identifi item state load
underli persist manag exclus
link getnonvirtualitemst itemid method prevent thread
concurr load item
set item itemid load currentlyload hash set hashset item itemid
return item state virtual
item state provid
item state itemst virtual item state getnonvirtualitemst item itemid
item state except nosuchitemstateexcept item state except itemstateexcept
check item state cach
item state itemst state cach retriev
state
state
wait thread load item state
load currentlyload
wait
...
load currentlyload add
load item state persist storag
note happen synchron block
...
cach cach state
state
notifi concurr thread item
note happen final block
load currentlyload remov
notifi notifyal
