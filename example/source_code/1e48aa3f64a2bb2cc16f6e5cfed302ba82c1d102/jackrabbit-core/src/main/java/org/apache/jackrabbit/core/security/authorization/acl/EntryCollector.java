...
observ mgr observationmgr add event listen addeventlisten event system session systemsess root node getrootnod path getpath name ntname
...
list access control entri accesscontrolentri entri acl templat acltempl acl node aclnod entri getentri
entri empti isempti filter
filter filter entri filterentri entri user ac userac group ac groupac
node nodeid node node getnodeid
list access control entri accesscontrolentri entri entri getentri
entri empti isempti filter
filter filter entri filterentri entri user ac userac group ac groupac
parent getparentid
...
return
throw repositoryexcept
list access control entri accesscontrolentri entri getentri node impl nodeimpl node repositori except repositoryexcept
list access control entri accesscontrolentri entri
...
entri acl templat acltempl acl node aclnod entri getentri
access control
entri collect empti list emptylist
entri
param nodeid
return
throw repositoryexcept
list access control entri accesscontrolentri entri getentri node nodeid node nodeid repositori except repositoryexcept
...
return
throw repositoryexcept
node nodeid parent getparentid node nodeid node nodeid repositori except repositoryexcept
node nodeid parent parentid
root rootid equal node nodeid
parent parentid parentid null root node reach
parent parentid node getnodebyid node nodeid parent getparentid
parent parentid
param nodeid
return
