...
list term vector offset info termvectoroffsetinfo term offset info termoffsetinfo arrai list arraylist term vector offset info termvectoroffsetinfo
iter term queri term queryterm iter
hasnext
term
len qtlen length
len qtlen
string text qttext string len qtlen
len qtlen
text qttext text
tvecindex tvec index indexesof text qttext text qttext length
map integ term vector offset info termvectoroffsetinfo local term offset info localtermoffsetinfo hash map hashmap integ term vector offset info termvectoroffsetinfo
tvecindex tvecindex
term vector offset info termvectoroffsetinfo termoffset tvec offset getoffset tvecindex
termoffset termoffset length
local term offset info localtermoffsetinfo put tvecindex termoffset
order kei tvecindex
term found tvecindex
deal multipl term exist check
tvecindex length tvecindex
build interv termvectoroffsetinfo
hit
list term vector offset info termvectoroffsetinfo interv term offset info intervaltermoffsetinfo arrai list arraylist term vector offset info termvectoroffsetinfo
pick key' hist interv start
term vector offset info termvectoroffsetinfo kei term offset firstkeytermoffset local term offset info localtermoffsetinfo
tvecindex
arrai sort kei term offset firstkeytermoffset
term vector offset info sorter termvectoroffsetinfosort
interv term offset info intervaltermoffsetinfo add addal arrai
list aslist kei term offset firstkeytermoffset
check kei part interv
drop list
tvecindex length
integ kei tvecindex
term vector offset info termvectoroffsetinfo termoffset local term offset info localtermoffsetinfo
kei
termoffset
arrai sort termoffset term vector offset info sorter termvectoroffsetinfosort
iter term vector offset info termvectoroffsetinfo interv iter intervaliter interv term offset info intervaltermoffsetinfo
iter
index
interv iter intervaliter hasnext
term vector offset info termvectoroffsetinfo interv intervaloi interv iter intervaliter
index termoffset length
interv iter intervaliter remov
match search matchsearch
match found matchfound
match search matchsearch
term vector offset info termvectoroffsetinfo local localoi termoffset index
check interv match
cjk languag token phrasequeri glu lucen
diff local localoi start offset getstartoffset
interv intervaloi end offset getendoffset
todo remov 'diff
upgrad lucen
diff diff
interv intervaloi set end offset setendoffset local localoi end offset getendoffset
match search matchsearch
match found matchfound
index
index termoffset length
...
index
interv iter intervaliter remov
term offset info termoffsetinfo add addal interv term offset info intervaltermoffsetinfo
term vector offset info termvectoroffsetinfo offset term offset info termoffsetinfo arrai toarrai term vector offset info termvectoroffsetinfo term offset info termoffsetinfo size
sort offset
...
skip char skippedchar surround
append escap string cbuf surround
skip char skippedchar
...
sentenc start sentencestart
append
append escap string cbuf skip char skippedchar cbuf length
skip char skippedchar
iter term
...
po start nextstart po
append escap string cbuf char read charsread
...
skip char skippedchar surround
skip char skippedchar
append escap string cbuf eof skip
surround skip char skippedchar
eof
...
param fragmentstart fragment start
...
tmp append
excerpt append escap tmp string tostr
excerpt append fragment end fragmentend append excerpt end excerptend
excerpt string tostr
escap input text suitabl output format
default xml escap overridden
format
param input raw text
return text suitabl escap
string escap string input
text encod illeg xml charact encodeillegalxmlcharact input
