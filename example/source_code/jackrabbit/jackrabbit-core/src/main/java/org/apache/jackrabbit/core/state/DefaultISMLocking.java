...
releas write lock releasewritelock
read lock readlock
flag determin lock strategi give
prefer writer writer prefer
default set reader block
writer wait lock
writer prefer writerprefer
...
return writer prefer statu lock strategi
return writer prefer
writer prefer iswriterprefer
writer prefer writerprefer
set writer prefer statu lock strategi
param prefer writer prefer
set writer prefer setwriterprefer prefer
writer prefer writerprefer prefer
...
object current currentid current thread getcurrentthreadid
writer writerid
writer count writercount thread issamethreadid writer writerid current currentid
writer prefer writerprefer writer wait writerswait
wait
reader count readercount
read lock readlock
...
writer wait writerswait
writer writerid
thread issamethreadid writer writerid current currentid reader count readercount
wait
writer wait writerswait
writer count writercount
