...
declar node type getdeclaringnodetyp equal qname mix version mix version
...
includ node type includesnodetyp qname mix version mix version
node state nodest properti haspropertynam qname jcr versionhistori jcr versionhistori
...
node intern set properti internalsetproperti qname jcr versionhistori jcr versionhistori intern internalvalu creat uuid uuid getuuid
node intern set properti internalsetproperti qname jcr basevers jcr basevers intern internalvalu creat uuid root version getrootvers uuid getuuid
node intern set properti internalsetproperti qname jcr ischeckedout jcr ischeckedout intern internalvalu creat
node intern set properti internalsetproperti qname jcr predecessor jcr predecessor
...
node nodeid parent oldparentid
node state nodest overlai state getoverlayedst parent getparentid
