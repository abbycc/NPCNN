...
inheritdoc
gener subsequ add remov notif replac method
assum reorder detect compar state' child
node entri overlai state' child node entri handl
transient reorder evict cach entri situat
detect
...
cach monitor cachemonitor
cach idcach
cach path element parent transient
children reorder multipl time jcr
child' posit cach intermedi stage
total reorder effect leav child initi
posit child' bad posit detect
node nodeid parent parentid state parent getparentid
parent parentid provid item state getitemst parent parentid transient istransi
item state except itemstateexcept
string msg unabl retriev parent state
log warn msg
