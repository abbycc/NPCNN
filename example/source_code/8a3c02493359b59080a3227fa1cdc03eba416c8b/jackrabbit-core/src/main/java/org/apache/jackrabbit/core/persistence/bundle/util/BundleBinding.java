...
data size
read fulli readfulli data
log info binari data length byte
except ioexcept
...
po len
po read byte po len po
log info string string byte utf
except ioexcept
...
log error error reload blob truncat state getid
idx size size
valu intern internalvalu creat
blob val blobval discard
store blob properti
