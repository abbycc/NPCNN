...
factori factori
creat code localitemstatemanag instanc regist link itemstatelisten
...
return code localitemstatemanag instanc
local item state manag localitemstatemanag creat instanc createinst share item state manag shareditemstatemanag share state mgr sharedstatemgr
event state collect factori eventstatecollectionfactori factori item state cach factori itemstatecachefactori cach factori cachefactori
local item state manag localitemstatemanag mgr local item state manag localitemstatemanag share state mgr sharedstatemgr factori cach factori cachefactori
...
state set contain setcontain
state
return chang log current local
item state manag
return chang log current
...
item state except nosuchitemstateexcept item state except itemstateexcept
check chang log
node refer noderefer ref chang log changelog refer getreferencesto
ref
ref
...
edit mode editmod
repositori except repositoryexcept edit mode
random nonrandomid
node factori getnodeidfactori node newnodeid
random nonrandomid
node state nodest state node state nodest
node type nodetypenam parent parentid item state itemst statu statu
chang log changelog ad state
state set contain setcontain
random nonrandomid chang log changelog delet
share state mgr sharedstatemgr item state hasitemst
invalid item state except invaliditemstateexcept
node exist
state
return local node state transient
fresh node state local state creat ad
chang log
param transientst transient state
return local node state
throw repositoryexcept local state creat
node state nodest creat local state getorcreatelocalst node state nodest transient state transientst
repositori except repositoryexcept
node state nodest local state localst node state nodest transient state transientst overlai state getoverlayedst
local state localst
transient node state creat local state
local state localst node state nodest
transient state transientst node getnodeid
...
chang log changelog ad local state localst
local state localst set contain setcontain
transient state transientst connect local state localst
...
edit mode editmod
illeg state except illegalstateexcept edit mode
properti state propertyst state properti state propertyst
properti propertyid parent parentid prop propnam item state itemst statu statu
chang log changelog ad state
state set contain setcontain
state
inheritdoc
...
illeg state except illegalstateexcept edit mode
jcr execut updat
chang log changelog updat hasupd
...
referenti integr except referentialintegrityexcept stale item state except staleitemstateexcept item state except itemstateexcept
share state mgr sharedstatemgr updat chang log changelog factori
chang log changelog persist
inheritdoc
dispos
share state mgr sharedstatemgr remov listen removelisten
localitemstatemanag instanc longer need
cach item state safe discard
item state itemst state cach retriev retrieveal
state length
item state itemst state state
state
dispatch notifi state discard notifystatediscard state
item state dispos
...
itemstatelisten
inheritdoc
notif handler call local state state manag
creat state creat share state manag
listen
state creat statecr item state itemst creat
item state itemst local
creat contain getcontain
share state creat
local chang log changelog creat getid
local
local node isnod local overlai state getoverlayedst creat
mid air collis concurr node state creation
jcr
local statu getstatu item state itemst statu statu
local set statu setstatu item state itemst statu undefin statu undefin local setstatu itemst statu undefin state
local overlai state getoverlayedst creat
underli state perman creat
local pull
local set statu setstatu item state itemst statu exist statu exist
cach cach local
item state except nosuchitemstateexcept
ignor
local state creat
local creat
ensur newli creat state cach
happen restor oper state
delet creat jcr
cach cach iscach creat getid
cach cach local
...
share state modifi
local cach retriev modifi getid
...
local modifi
local
dispatch notifi state modifi notifystatemodifi local
modifi node isnod
state cach
vanish weak ref cach due
listen cachinghierarchymanag
notifi
dispatch notifi node modifi notifynodemodifi node state nodest modifi
inheritdoc
notif handler call local state state manag
creat state creat share state manag
listen
...
share state destroi
local cach retriev destroi getid
local local connect isconnect
local set statu setstatu item state itemst statu exist remov statu exist remov
local state destroi
local destroi
cach evict destroi getid
local
dispatch notifi state destroi notifystatedestroi local
inheritdoc
notif handler call local state state manag
creat state creat share state manag
listen
...
share state discard
local cach retriev discard getid
local local connect isconnect
local set statu setstatu item state itemst statu undefin statu undefin
local state discard
local discard
cach evict discard getid
local
dispatch notifi state discard notifystatediscard local
inheritdoc
optim share state manag listen deliv node state state
concern local state
...
share state mgr sharedstatemgr node factori getnodeidfactori
