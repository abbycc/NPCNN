...
bundl check
param fix
true repair thing repair
param modif
code fix true code collect repair
linkplain nodepropbundl bundl
check bundl consist checkbundleconsist node nodeid node prop bundl nodepropbundl bundl fix collect modif
...
skip check system node root system root version storag nodetyp
...
equal
log error childnod invalid parent uuid
...
exist bundl existsbundl parent parentid
log error nodest refer inexist parent uuid parent parentid
item state except itemstateexcept
log error error read node parent parentid parent
inheritdoc
...
uuid
node bundl databas singl sql statement
faster load bundl travers tree
...
pars check bundl
check bundl log problem
bind check bundl checkbundl din
reset stream readbundl
din data input stream datainputstream blob binari stream getbinarystream
node prop bundl nodepropbundl bundl bind read bundl readbundl din
check bundl consist checkbundleconsist bundl fix modif
log error invalid bundl previou bundlebind error log entri
except
log error error bundl
count
count
log info check count bundl
except
log error error load bundl
util ioutil close quietli closequietli din
...
list uuid list uuidlist arrai list arraylist uuid length
convert uuid string arrai list uuid object
uuid length
uuid list uuidlist add uuid uuid
illeg argument except illegalargumentexcept
log error invalid uuid consist check skip uuid
iter uuid includ newli ad insid loop
uuid list uuidlist size
uuid uuid uuid uuid list uuidlist
load node databas
node nodeid node nodeid uuid
node prop bundl nodepropbundl bundl load bundl loadbundl
bundl
log error bundl found uuid uuid
check bundl consist checkbundleconsist bundl fix modif
recurs
iter iter bundl child node entri getchildnodeentri iter
iter hasnext
node prop bundl nodepropbundl child node entri childnodeentri entri node prop bundl nodepropbundl child node entri childnodeentri iter
uuid list uuidlist add entri getid uuid getuuid
count
count
log info check count uuid list uuidlist size bundl
item state except itemstateexcept
problem log loadbundl call logdetailederror true
total uuid list uuidlist size
...
item state except itemstateexcept
load bundl loadbundl
load bundl underli system option perform
check bundl
param node bundl
param checkbeforeload check bundl load log
detail inform slower
return load bundl code null code bundl
exist
throw itemstateexcept error load occur
node prop bundl nodepropbundl load bundl loadbundl node nodeid check load checkbeforeload
item state except itemstateexcept
result set resultset
...
check load checkbeforeload
bind check bundl checkbundl din
reset stream readbundl
din data input stream datainputstream byte arrai input stream bytearrayinputstream byte
wrap proper itemstateexcept
except invalid bundl previou bundlebind error log entri
node prop bundl nodepropbundl bundl bind read bundl readbundl din
