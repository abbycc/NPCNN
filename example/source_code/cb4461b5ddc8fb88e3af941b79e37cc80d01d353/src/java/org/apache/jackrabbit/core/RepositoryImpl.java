...
string nodetyp node uuid nodetyp node uuid deadbeef cafe cafe cafe babecafebab
string properti resourc properti resourc rep properti
properti rep prop repprop
lock file rel workspac home directori
...
init root node uuid
root node uuid rootnodeuuid load root node uuid loadrootnodeuuid meta data store metadatastor
...
reg nsreg
reg ntreg
mgr vmgr version manag impl versionmanagerimpl reg ntreg deleg dispatch delegatingdispatch
version storag node uuid version storag node uuid system root node uuid system root node uuid
init virtual nodetyp manag
virt mgr virtntmgr virtual node type state manag virtualnodetypestatemanag node type registri getnodetyperegistri
deleg dispatch delegatingdispatch nodetyp node uuid nodetyp node uuid system root node uuid system root node uuid
initi workspac
...
workspac fail initi shutdown
log error unabl start repositori forc shutdown
shutdown
workspac initi setup system session
virtual nodetyp manag
...
lock exist
repositori except repositoryexcept repositori home home absolut path getabsolutepath
appear delet file
lock absolut path getabsolutepath repositori shutdown properli
lock creat file createnewfil
except ioexcept
repositori except repositoryexcept unabl creat lock file lock absolut path getabsolutepath
...
return
throw repositoryexcept
string load root node uuid loadrootnodeuuid file system filesystem repositori except repositoryexcept
...
writer write root node uuid root node uuid
writer close
except ioexcept ioe
ignor
root node uuid root node uuid
except
...
node impl nodeimpl sy root sysroot root node rootnod intern add child node internaladdchildnod qname jcr system jcr system system root node uuid system root node uuid
add version storag
sy session syssess node type manag getnodetypemanag node type getnodetyp qname rep versionstorag rep versionstorag
sy root sysroot intern add child node internaladdchildnod qname jcr versionstorag jcr versionstorag version storag node uuid version storag node uuid
add nodetyp
sy session syssess node type manag getnodetypemanag node type getnodetyp qname rep nodetyp rep nodetyp
sy root sysroot intern add child node internaladdchildnod qname jcr nodetyp jcr nodetyp nodetyp node uuid nodetyp node uuid
...
deleg dispatch delegatingdispatch add dispatch adddispatch observ manag factori getobservationmanagerfactori wsp wspname
...
close version file system
rep config repconfig version config getversioningconfig file system getfilesystem close
file system except filesystemexcept
log error error close version filesystem
make instanc anymor
dispos
releas repositori lock releaserepositorylock
...
return code inputstream code code properti code resourc
default properti repositori method
call repositori initi
code inputstream code return close caller
method return code inputstream code
code org apach jackrabbit core repositori properti code resourc
found class path
return code inputstream code code properti code resourc
code null code resourc exist
input stream inputstream default repositori properti getdefaultrepositoryproperti
repositori impl repositoryimpl resourc stream getresourceasstream repositori properti
...
inform persistencem manag configur
initi persist manag context
argument
return creat workspac persist manag
throw repositoryexcept persist manag
instanti initi
persist manag persistencemanag creat persist manag createpersistencemanag file home dir homedir file system filesystem persist manag config persistencemanagerconfig config pmconfig
string root node uuid rootnodeuuid namespac registri namespaceregistri reg nsreg node type registri nodetyperegistri reg ntreg
repositori except repositoryexcept
persist manag persistencemanag persist manag persistencemanag config pmconfig instanc newinst
init context pmcontext home dir homedir root node uuid rootnodeuuid reg nsreg reg ntreg
except
...
subject
login except loginexcept subject accesscontrolcontext
creat session
...
item state mgr itemstatemgr share item state manag shareditemstatemanag
persist manag getpersistencemanag config persist manag config getpersistencemanagerconfig
root node uuid rootnodeuuid reg ntreg
item state mgr itemstatemgr add virtual item state provid addvirtualitemstateprovid mgr vmgr virtual item state provid getvirtualitemstateprovid
item state mgr itemstatemgr add virtual item state provid addvirtualitemstateprovid virt mgr virtntmgr virtual item state provid getvirtualitemstateprovid
except
...
search mgr searchmgr search manag searchmanag system session getsystemsess
config search config getsearchconfig
reg ntreg
item state provid getitemstateprovid
search mgr searchmgr
...
file config home dir gethomedir lock file lock file
lock mgr lockmgr
...
file system except filesystemexcept
log error error close filesystem workspac
config getnam
