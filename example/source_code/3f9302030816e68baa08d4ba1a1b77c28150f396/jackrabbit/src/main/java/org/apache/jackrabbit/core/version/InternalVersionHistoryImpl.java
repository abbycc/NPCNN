...
version
version versionableid node nodeid valueof node properti getpropertyvalu qname jcr versionableuuid jcr versionableuuid string tostr
entri
node state nodestateex children node child node getchildnod
children length
node state nodestateex child children
child getnam equal qname jcr versionlabel jcr versionlabel
label node labelnod child
intern version impl internalversionimpl creat version instanc createversioninst child
version cach versioncach put getid
root version isrootvers
root version rootvers
mgr vmgr version creat versioncr
check legaci version node 'virtual' jcr successor properti
root version rootvers successor getsuccessor length version cach versioncach size
...
intern version impl internalversionimpl intern version impl internalversionimpl version getvers node nodeid ref
...
version cach versioncach kei containskei
inheritdoc
...
pred src properti getproperti qname jcr predecessor jcr predecessor valu getvalu
intern internalvalu predecessor intern internalvalu pred length
pred length
uuid pred predid uuid string fromstr pred string getstr
check version exist
version cach versioncach kei containskei node nodeid pred predid
...
node state nodestateex node vnode node add node addnod qname version version version versionid
initi 'created' 'predecessors' 'successors'
node vnode set properti setpropertyvalu qname jcr creat jcr creat intern internalvalu creat calendar instanc getinst
node vnode set properti valu setpropertyvalu qname jcr predecessor jcr predecessor properti type propertytyp refer predecessor
node vnode set properti valu setpropertyvalu qname jcr successor jcr successor properti type propertytyp refer intern internalvalu empti arrai empti arrai
checkin sourc node
intern frozen node impl internalfrozennodeimpl checkin node vnode qname jcr frozennod jcr frozennod src
updat version graph
...
node nodeid histori historyid qname
node state nodest node state nodest
repositori except repositoryexcept
creat histori node
node state nodestateex node pnode parent add node addnod qname versionhistori versionhistori histori historyid
set version uuid
string version uuid versionableuuid node state nodest node getnodeid uuid getuuid string tostr
node pnode set properti setpropertyvalu qname jcr versionableuuid jcr versionableuuid intern internalvalu creat version uuid versionableuuid
creat label node
node pnode add node addnod qname jcr versionlabel jcr versionlabel qname versionlabel versionlabel
creat root version
node nodeid version versionid node nodeid uuid random uuid randomuuid
node state nodestateex node vnode node pnode add node addnod qname jcr rootvers jcr rootvers qname version version version versionid
initi 'created' 'predecessors'
node vnode set properti setpropertyvalu qname jcr creat jcr creat intern internalvalu creat calendar instanc getinst
node vnode set properti valu setpropertyvalu qname jcr predecessor jcr predecessor properti type propertytyp refer intern internalvalu empti arrai empti arrai
node vnode set properti valu setpropertyvalu qname jcr successor jcr successor properti type propertytyp refer intern internalvalu empti arrai empti arrai
add empti frozen node root version
node state nodestateex node node vnode add node addnod qname jcr frozennod jcr frozennod qname frozennod frozennod
initi intern properti
node set properti setpropertyvalu qname jcr frozenuuid jcr frozenuuid intern internalvalu creat version uuid versionableuuid
