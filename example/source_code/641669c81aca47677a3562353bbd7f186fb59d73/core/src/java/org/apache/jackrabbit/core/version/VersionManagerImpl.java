...
gener ad event generateaddedev event parent
case histori creat 'deep' add event ancestor
parent intern uuid internalgetuuid equal histori root historyroot uuid getuuid
node impl nodeimpl child parent
parent node impl nodeimpl parent parent getpar
gener ad event generateaddedev event parent child
