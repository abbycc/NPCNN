...
mixin session
event add event state eventst node move nodemov parent newparentid
path newpath node getnodeid path oldpath
...
node getnodeid path oldpath element getnameel
node type nodetyp getqnam mixin session
event add event state eventst child node ad childnodead
parent node getnodeid parent path parentpath
node getnodeid path newpath element getnameel
node type nodetyp getqnam mixin session
event add event state eventst node move nodemov
...
path element ad elem addedelem path element getpathel child
...
path element remov elem removedelem path element getpathel entri
...
parent getpar path path element getnameel
node type nodetyp getqnam mixin session
remov item
...
path element element getnameel node nodeid node nodeid
...
builder add addfirst
builder path getpath element getnameel
repositori except repositoryexcept
...
return element node
throw itemstateexcept error occur resolv
path element zombi element getzombienameel node nodeid node nodeid
node nodeid parent parentid
chang log base hierarchi mgr changelogbasedhierarchymgr hmgr
item state except itemstateexcept
...
path element path element getpathel child node entri childnodeentri entri
entri getnam
index entri index getindex entri index getindex
path factori impl pathfactoryimpl instanc getinst creat element createel index
