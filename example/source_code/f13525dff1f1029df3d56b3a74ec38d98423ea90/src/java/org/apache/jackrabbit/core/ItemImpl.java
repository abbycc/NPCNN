...
item state itemst transient state transientst
node isnod
iter iter state mgr statemgr descend transient item state attic getdescendanttransientitemstatesinatt
iter hasnext
transient state transientst item state itemst iter
check stale
...
string msg item mgr itemmgr safe jcr path safegetjcrpath allow modifi item
log debug msg
...
node state nodest properti entri haspropertyentri getnam
...
string msg node safe jcr path safegetjcrpath mandatori child node cnd getnam exist
log debug msg
constraint violat except constraintviolationexcept msg
...
string msg item mgr itemmgr safe jcr path safegetjcrpath allow remov item
log debug msg
access deni except accessdeniedexcept msg
...
ref state mgr statemgr node refer getnoderefer ref refsid
item state except itemstateexcept
...
version histori versionhistori hist session version manag getversionmanag creat version histori createversionhistori node
...
node intern set properti internalsetproperti jcr predecessor jcr predecessor intern internalvalu intern internalvalu creat uuid hist root version getrootvers uuid getuuid
creat transient state createdtransientst
creat transient state createdtransientst
...
item remov
remov version except versionexcept lock except lockexcept repositori except repositoryexcept
...
save
access deni except accessdeniedexcept constraint violat except constraintviolationexcept
invalid item state except invaliditemstateexcept referenti integr except referentialintegrityexcept
version except versionexcept lock except lockexcept repositori except repositoryexcept
check state instanc
saniti check sanitycheck
synchron session
...
state mgr statemgr enabl path cach enablepathcach
...
parent state parentst node state nodest state mgr statemgr transient item state gettransientitemst
...
node isnod
check root node
node impl nodeimpl depth getdepth
optim
...
iter state mgr statemgr descend transient item state attic getdescendanttransientitemstatesinatt
iter hasnext
transient state transientst item state itemst iter
