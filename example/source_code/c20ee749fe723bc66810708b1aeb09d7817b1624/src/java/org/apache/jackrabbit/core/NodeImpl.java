...
node type conflict except nodetypeconflictexcept ntce
constraint violat except constraintviolationexcept ntce messag getmessag
node type impl nodetypeimpl mixin session node type manag getnodetypemanag node type getnodetyp mixin mixinnam
shortcut
...
node impl nodeimpl
repositori root isrepositoryroot node type isnodetyp mix referenc mix referenc
...
return path
path getpath
calcul rel path referenc ancestor node
note
...
getpath foo
relpath bar
todo replac implement
path relpath getprimarypath getrelativepath getprimarypath
...
throw repositoryexcept error occur
node impl nodeimpl node getcorrespondingnod session src session srcsession
access deni except accessdeniedexcept repositori except repositoryexcept
search nearest ancestor referenc
node impl nodeimpl
repositori root isrepositoryroot node type isnodetyp mix referenc mix referenc
...
node impl nodeimpl merg test domergetest session src session srcsession effort besteffort
