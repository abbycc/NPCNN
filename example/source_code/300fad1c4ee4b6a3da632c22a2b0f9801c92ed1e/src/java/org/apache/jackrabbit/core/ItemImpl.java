...
primari type
node type impl nodetypeimpl pnt node type impl nodetypeimpl node primari node type getprimarynodetyp
effect node type primari type incl mixin
effect node type effectivenodetyp ent node effect node type geteffectivenodetyp
...
string msg node safe jcr path safegetjcrpath
...
properti definit impl propertydefinitionimpl prop definit getdefinit
check constraint
...
log debug msg
access deni except accessdeniedexcept msg
creat node refer object target
param target
return node refer object
throw itemstateexcept error occur
node refer noderefer creat node refer getorcreatenoderefer node refer nodereferencesid
...
collect check refer checkrefer iter iter dirti iterdirti iter iter remov iterremov
...
type oldtyp prop state oldpropst type gettyp
type oldtyp properti type propertytyp refer
...
node refer nodereferencesid node refer nodereferencesid uuid
node refer noderefer ref
dirti node ref dirtynoderef kei containskei
ref node refer noderefer dirti node ref dirtynoderef
ref creat node refer getorcreatenoderefer
item state except itemstateexcept
string msg item mgr itemmgr safe jcr path safegetjcrpath
fail load node refer
log debug msg
repositori except repositoryexcept msg
dirti node ref dirtynoderef put ref
...
val val length
string uuid val string tostr
node refer nodereferencesid ref refsid node refer nodereferencesid uuid
...
string msg item mgr itemmgr safe jcr path safegetjcrpath prop state propstat getid
target node refer properti node
save scope
current save oper
log warn msg
referenti integr except referentialintegrityexcept msg
...
node refer noderefer ref
dirti node ref dirtynoderef kei containskei ref refsid
ref node refer noderefer dirti node ref dirtynoderef ref refsid
ref creat node refer getorcreatenoderefer ref refsid
item state except itemstateexcept
string msg item mgr itemmgr safe jcr path safegetjcrpath target targetid
fail load node refer
log debug msg
repositori except repositoryexcept msg
dirti node ref dirtynoderef put ref refsid ref
...
check node referenc
node refer nodereferencesid node refer nodereferencesid node state nodest uuid getuuid
node refer noderefer ref
dirti node ref dirtynoderef kei containskei
ref node refer noderefer dirti node ref dirtynoderef
state mgr statemgr node refer hasnoderefer
ref state mgr statemgr node refer getnoderefer
item state except itemstateexcept
string msg item mgr itemmgr safe jcr path safegetjcrpath
fail load node refer
log debug msg
...
log warn msg
referenti integr except referentialintegrityexcept msg
return dirti noderefer object
dirti node ref dirtynoderef valu
...
node node type isnodetyp qname mix version mix version
node properti hasproperti qname jcr versionhistori jcr versionhistori
...
set depend uui dependentuuid hash set hashset
node state nodest overlai state hasoverlayedst
string parent uuid oldparentuuid
node state nodest overlai state getoverlayedst parent uuid getparentuuid
string parent uuid newparentuuid node state nodest parent uuid getparentuuid
parent uuid oldparentuuid
parent uuid newparentuuid
node remov add parent
depend
depend uui dependentuuid add parent uuid oldparentuuid
parent uuid oldparentuuid
parent uuid oldparentuuid equal parent uuid newparentuuid
node move add parent
depend
depend uui dependentuuid add parent uuid oldparentuuid
depend uui dependentuuid add parent uuid newparentuuid
...
depend uui dependentuuid add cne uuid getuuid
ad child node entri
iter cne cneit
...
walk depend check
scope save oper
iter dep depit depend uui dependentuuid iter
dep depit hasnext
node nodeid node nodeid string dep depit
...
refer updat persist
collect dirti ref dirtyref
check refer checkrefer dirti iter remov iter
start updat oper
...
refer
dirti ref dirtyref check refer checkrefer dirti iter remov iter
...
state mgr statemgr dispos transient item state disposetransientitemst transient state transientst
store refer calcul
iter dirti ref dirtyref iter hasnext
state mgr statemgr store node refer noderefer
end updat oper
