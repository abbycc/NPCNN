...
sort map sortedmap term map termmap tree map treemap
reader string reader stringread text
token stream tokenstream index text analyz gettextanalyz token stream tokenstream
token
term vector offset info termvectoroffsetinfo info
term vector offset info termvectoroffsetinfo term map termmap term text termtext
info
...
info term vector offset info termvectoroffsetinfo term map termmap term index
info
...
freq term length
term length
freq term vector offset info termvectoroffsetinfo term map termmap term length
freq
