...
item impl itemimpl item item state listen itemstatelisten constant
...
declar node type getdeclaringnodetyp equal mix version mix version
...
node node type isnodetyp mix version mix version
node properti hasproperti jcr versionhistori jcr versionhistori
version histori versionhistori hist session version manag getversionmanag creat version histori createversionhistori session node state nodest item state itemst
node intern set properti internalsetproperti jcr versionhistori jcr versionhistori intern internalvalu creat uuid hist uuid getuuid
node intern set properti internalsetproperti jcr basevers jcr basevers intern internalvalu creat uuid hist root version getrootvers uuid getuuid
node intern set properti internalsetproperti jcr ischeckedout jcr ischeckedout intern internalvalu creat
node intern set properti internalsetproperti jcr predecessor jcr predecessor
intern internalvalu intern internalvalu creat uuid hist root version getrootvers uuid getuuid
creat transient state createdtransientst
creat transient state createdtransientst
