...
org apach jackrabbit core mem memori file system memoryfilesystem
...
java util map
code inmempersistencemanag code simpl code hashmap code base
...
deprec
mem persist manag inmempersistencemanag abstract persist manag abstractpersistencemanag
logger log logger factori loggerfactori logger getlogg mem persist manag inmempersistencemanag
initi
map item itemid state store statestor
map node nodeid ref store refsstor
initi size buffer serial object
initi buffer size initi buffer size
constant serial
string state file path state file path data state bin
string ref file path ref file path data ref bin
node entri node entri
prop entri prop entri
...
hash map persist
persist
creat code inmempersistencemanag code instanc
mem persist manag inmempersistencemanag
initi
...
string build blob file path buildblobfilepath string parent uuid parentuuid prop propnam index
string builder stringbuild string builder stringbuild
char parent uuid parentuuid char arrai tochararrai
cnt
char
cnt cnt
cnt cnt
...
cnt
append file system filesystem separ char separ char
append file system path util filesystempathutil escap escapenam prop propnam string tostr
append
append index
append bin
string tostr
...
read item state
file system resourc filesystemresourc re fsre file system resourc filesystemresourc wsp wspf state file path state file path
re fsre exist
...
close
write content hash map file system
throw except error occur
...
write int writeint state store statestor size writeint statestor size number entri
entri
item itemid state store statestor kei set keyset
denot node denotesnod
write byte writebyt node entri node entri writebyt node entri entri type
write byte writebyt prop entri prop entri writebyt prop entri entri type
write utf writeutf string tostr writeutf tostr
data state store statestor
...
state store statestor hash map hashmap item itemid initi capac initialcapac load factor loadfactor
...
blob blobf memori file system memoryfilesystem
blob blobf init
blob store blobstor file system blob store filesystemblobstor blob blobf
persist
deseri content state ref store
...
clear blob store
string folder blob blobf list folder listfold
string folder folder
blob blobf delet folder deletefold folder
string file blob blobf list file listfil
string file file
blob blobf delet file deletefil file
except
ignor
...
blob blobf
blob store blobstor
state store statestor clear
state store statestor
ref store refsstor clear
ref store refsstor
initi
inheritdoc
...
byte arrai input stream bytearrayinputstream byte arrai input stream bytearrayinputstream data
...
state store statestor put state node getnodeid byte arrai tobytearrai
...
store serial format map memori effici
state store statestor put state properti getpropertyid byte arrai tobytearrai
close bytearrayoutputstream
close
except
string msg fail store properti state state properti getpropertyid
log debug msg
item state except itemstateexcept msg
inheritdoc
...
illeg state except illegalstateexcept initi
remov node state
state store statestor remov state node getnodeid
inheritdoc
...
remov properti state
state store statestor remov state properti getpropertyid
inheritdoc
...
initi
illeg state except illegalstateexcept initi
state store statestor kei containskei
inheritdoc
...
state store statestor kei containskei
inheritdoc
exist refer existsreferencesto node nodeid item state except itemstateexcept
initi
illeg state except illegalstateexcept initi
