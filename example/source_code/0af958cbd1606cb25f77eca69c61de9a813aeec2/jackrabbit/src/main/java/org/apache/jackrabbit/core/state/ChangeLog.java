...
chang log changelog
ad state
map ad state addedst link map linkedmap
modifi state
map modifi state modifiedst link map linkedmap
delet state
map delet state deletedst link map linkedmap
modifi refer
map modifi ref modifiedref link map linkedmap
state ad
...
modifi ref modifiedref put ref target gettargetid ref
...
state
state item state itemst modifi state modifiedst
state
...
node refer noderefer modifi ref modifiedref
...
iter hasnext
item state itemst state item state itemst iter
item state itemst delet state deletedst item state itemst delet state deletedst remov state getid
...
iter iter modifi state modifiedst
iter hasnext
item state itemst iter disconnect
iter delet state deletedst
iter hasnext
item state itemst iter disconnect
iter ad state addedst
...
iter ad state addedst
iter hasnext
item state itemst iter discard
reset
