...
return
getid
node nodeid workspac getworkspaceid
...
node state nodest add node entri addnewnodeentri node nodenam string uniqu uniqueid primari node type primarynodetyp node definit qnodedefinit definit repositori except repositoryexcept
...
throw repositoryexcept unexpect error occur
add properti entri addpropertyentri collect prop name propnam item exist except itemexistsexcept repositori except repositoryexcept
add transient code propertyentri code code nodeentri code
return code propertyst code entri
param propnam
return propertyst properti entri
throw itemexistsexcept
throw repositoryexcept unexpect error occur
properti state propertyst add properti entri addnewpropertyentri prop propnam properti definit qpropertydefinit definit item exist except itemexistsexcept repositori except repositoryexcept
