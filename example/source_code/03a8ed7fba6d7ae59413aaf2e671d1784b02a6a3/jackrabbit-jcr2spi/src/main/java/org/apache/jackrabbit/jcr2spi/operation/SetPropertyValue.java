...
code setpropertyvalu code
set properti setpropertyvalu abstract oper abstractoper
properti propertyid properti propertyid
properti state propertyst properti state propertyst
qvalu valu
type valuetyp
set properti setpropertyvalu properti state propertyst properti state propertyst type valuetyp qvalu valu
repositori except repositoryexcept
properti state propertyst properti state propertyst
properti propertyid properti propertyid properti state propertyst getid
type valuetyp type valuetyp
valu valu
add affect item state addaffecteditemst properti state propertyst
oper
param visitor
...
properti propertyid
properti state propertyst properti state getpropertyst
properti state propertyst
multi valu ismultivalu
properti state propertyst multi valu ismultivalu
type getvaluetyp
type valuetyp
qvalu valu getvalu
valu
factori
oper creat properti state propertyst prop state propstat qvalu valu qvalu
type valuetyp repositori except repositoryexcept
compact arrai purg null entri
list qvalu list arrai list arraylist qvalu
valu qvalu length
valu qvalu
list add valu qvalu
qvalu clean valu cleanvalu list arrai toarrai qvalu list size
set properti setpropertyvalu set properti setpropertyvalu prop state propstat type valuetyp clean valu cleanvalu
