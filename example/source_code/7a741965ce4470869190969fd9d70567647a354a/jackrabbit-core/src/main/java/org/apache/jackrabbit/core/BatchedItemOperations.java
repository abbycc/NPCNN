...
reg ntreg hier mgr hiermgr session
...
string msg
clone node src srcid uuid getuuid
parent dest parent destparentid uuid getuuid
creat share cycl
log debug msg
repositori except repositoryexcept msg
...
string msg
ad shareabl node
dest parent state destparentst node getnodeid uuid getuuid
parent support
log debug msg
...
found
throw repositoryexcept error occur
node def nodedef find applic node definit findapplicablenodedefinit
...
effect node type effectivenodetyp ent parent entpar effect node type geteffectivenodetyp parent state parentst
ent parent entpar applic child node def getapplicablechildnodedef node type nodetypenam reg ntreg
...
found
throw repositoryexcept error occur
prop def propdef find applic properti definit findapplicablepropertydefinit
type
...
code link findapplicablepropertydefinit int boolean nodest code
...
def getnam
constant nameconst mix referenc mix referenc equal declar declaringnt
mix referenc node type
constant nameconst jcr uuid jcr uuid equal
jcr uuid properti
gen valu genvalu intern internalvalu intern internalvalu creat
parent node getnodeid uuid getuuid string tostr
constant nameconst base base equal declar declaringnt
base node type
...
constant nameconst resourc resourc equal declar declaringnt
resourc node type
constant nameconst jcr lastmodifi jcr lastmodifi equal
jcr lastmodifi properti
gen valu genvalu intern internalvalu intern internalvalu creat calendar instanc getinst
constant nameconst version version equal declar declaringnt
version node type
constant nameconst jcr creat jcr creat equal
jcr creat properti
gen valu genvalu intern internalvalu intern internalvalu creat calendar instanc getinst
...
tmp size
child node entri childnodeentri entri child node entri childnodeentri tmp
...
version ent includ node type includesnodetyp constant nameconst mix version mix version
...
uuid uuid ref tracker reftrack map uuid getmappeduuid src child state srcchildstat node getnodeid uuid getuuid
uuid
node nodeid map mappedid node nodeid uuid
...
adjust
version manag versionmanag manag session version manag getversionmanag
...
manag version histori getversionhistori session state newstat
