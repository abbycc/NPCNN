...
java util list
java util map
implement link versionmanag work environ
work filter version manag client global version
manag
version manag xaversionmanag abstract version manag abstractversionmanag
...
map item xaitem
creat instanc class
version manag xaversionmanag version manag impl versionmanagerimpl mgr vmgr node type registri nodetyperegistri reg ntreg
session impl sessionimpl session
repositori except repositoryexcept
mgr vmgr mgr vmgr
reg ntreg reg ntreg
session session
state mgr statemgr item state manag xaitemstatemanag mgr vmgr share state mgr getsharedstatemgr
chang log attribut chang log attribut
node state nodest state
state node state nodest state mgr statemgr item state getitemst mgr vmgr histori root gethistoryrootid
item state except itemstateexcept
repositori except repositoryexcept unabl retriev histori root
histori root historyroot node state nodestateex state mgr statemgr reg ntreg state qname jcr versionstorag jcr versionstorag
...
version session impl sessionimpl node session getsess node getnodebyid version getid
mgr vmgr checkin node
inheritdoc
remov version removevers version histori versionhistori histori qname version versionnam
repositori except repositoryexcept
isinxa
...
remov version removevers version versionnam
mgr vmgr remov version removevers histori version versionnam
inheritdoc
...
intern version histori impl internalversionhistoryimpl intern version histori impl internalversionhistoryimpl
abstract version histori abstractversionhistori histori intern version histori getinternalversionhistori
intern version internalvers set version label setversionlabel version label move
version session impl sessionimpl histori session getsess node getnodebyid getid
mgr vmgr set version label setversionlabel histori version label move
inheritdoc
close except
...
node nodeid qname node type nodetypenam
repositori except repositoryexcept
illeg state except illegalstateexcept read
inheritdoc
...
item xaitem
item intern version item internalversionitem item xaitem
item
...
intern version internalvers checkin intern version histori impl internalversionhistoryimpl histori
node impl nodeimpl node
repositori except repositoryexcept
histori version manag getversionmanag
histori make local copi makelocalcopi histori
item xaitem put histori getid histori
checkin histori node
inheritdoc
modifi version histori make local copi
...
length
item xaitem put getid
remov version removevers histori
inheritdoc
modifi version histori make local copi
...
map item xaitem
item xaitem map attribut getattribut item attribut item attribut
item xaitem
item xaitem hash map hashmap
...
mgr vmgr share state mgr getsharedstatemgr set lock hack setnolockhack
...
mgr vmgr aquir write lock aquirewritelock
item state manag xaitemstatemanag state mgr statemgr commit
mgr vmgr share state mgr getsharedstatemgr set lock hack setnolockhack
map item xaitem map attribut getattribut item attribut item attribut
mgr vmgr item updat itemsupd item xaitem valu
mgr vmgr releas write lock releasewritelock
inheritdoc
deleg call item state manag
...
repositori except repositoryexcept
node state nodest state
state node state nodest state mgr statemgr item state getitemst histori getid
item state except itemstateexcept
