...
iter path map pathmap element lru entri lruentri iter element children getchildren
iter hasnext
path map pathmap element lru entri lruentri child iter
...
iter path map pathmap element lru entri lruentri iter parent children getchildren
iter hasnext
path map pathmap element lru entri lruentri child iter
...
posit chang
reorder
path element index newnameindex path factori impl pathfactoryimpl instanc getinst creat element createel
