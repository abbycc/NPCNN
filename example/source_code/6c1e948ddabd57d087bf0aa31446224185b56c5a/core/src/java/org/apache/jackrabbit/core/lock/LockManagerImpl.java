...
org apach jackrabbit core path map pathmap
...
logger
logger log logger logger getlogg lock manag impl lockmanagerimpl
path map lock leav
path map pathmap lock map lockmap path map pathmap
system session
session impl sessionimpl session
lock file
file lock file locksfil
monitor modifi content order make modif
lock map modif content atom
object content monitor contentmonitor object
space resolv
namespac resolv namespaceresolv resolv nsresolv
creat instanc class
param session system session
param locksfil file lock file
throw repositoryexcept error occur
lock manag impl lockmanagerimpl session impl sessionimpl session file lock file locksfil
repositori except repositoryexcept
session session
resolv nsresolv session namespac resolv getnamespaceresolv
lock file locksfil lock file locksfil
...
lock file locksfil path getpath messag getmessag
log debug root
read lock lock file popul path map
load except ioexcept
buffer reader bufferedread reader
reader buffer reader bufferedread file reader fileread lock file locksfil
...
node nodeid node nodeid lock token locktoken uuid
...
node properti getproperti constant jcr lockisdeep jcr lockisdeep boolean getboolean
node properti getproperti constant jcr lockown jcr lockown string getstr
...
writer buffer writer bufferedwrit file writer filewrit lock file locksfil
list size
lock info lockinfo info lock info lockinfo list
...
throw repositoryexcept error occur
return lock
lock lock node impl nodeimpl node lock info lockinfo info
lock except lockexcept repositori except repositoryexcept
lock lock
content monitor contentmonitor
lock map lockmap
check node lock
path path node primari path getprimarypath
...
lock map lockmap put path info
lock lock impl lockimpl info node
add properti content
node intern set properti internalsetproperti constant jcr lockown jcr lockown
intern internalvalu creat node session getsess user getuserid
node intern set properti internalsetproperti constant jcr lockisdeep jcr lockisdeep
intern internalvalu creat info deep
node save
lock
unlock node info invok session log
session scope lock session unlock
order prevent deadlock synchron dispatch
event content modif made code
section hold monitor jcr
param info lock info
unlock lock info lockinfo info
session hold lock system session
session impl sessionimpl session info lock holder getlockhold
session
session session
content monitor contentmonitor
node' path remov child path map
node impl nodeimpl node node impl nodeimpl session item manag getitemmanag item getitem
node nodeid info uuid getuuid
path path node primari path getprimarypath
lock map lockmap
path map pathmap element element lock map lockmap map path
element
...
node intern set properti internalsetproperti constant jcr lockown jcr lockown intern internalvalu
node intern set properti internalsetproperti constant jcr lockisdeep jcr lockisdeep intern internalvalu
node save
repositori except repositoryexcept
log warn unabl unlock session scope lock node
info lock token locktoken messag getmessag
log debug root
lockmanag
inheritdoc
lock lock node impl nodeimpl node deep isdeep session scope issessionscop
lock except lockexcept repositori except repositoryexcept
creat lock info pass intern implement
lock info lockinfo info lock info lockinfo lock token locktoken node intern uuid internalgetuuid
session scope issessionscop deep isdeep node session getsess user getuserid
lock node info
inheritdoc
...
session impl sessionimpl session session impl sessionimpl node session getsess
node lock holder lockhold node session item manag getitemmanag item getitem
node nodeid info uuid getuuid
...
info
lock except lockexcept node lock node safe jcr path safegetjcrpath
node session getsess equal info lock holder getlockhold
...
lock except lockexcept repositori except repositoryexcept
check lock checklock node primari path getprimarypath node session getsess
inheritdoc
...
item getitem node nodeid lock token locktoken uuid
path map pathmap element element lock map lockmap map node primari path getprimarypath
element
lock info lockinfo info lock info lockinfo element
info
...
hierarchi event hierarchyev string uuid path path type
uuid uuid
path path
type type
...
hierarchi event hierarchyev
hierarchi event hierarchyev event child uuid getchilduuid
path creat event path getpath resolv nsresolv
event type gettyp
malform path except malformedpathexcept
log info unabl event' path messag getmessag
repositori except repositoryexcept
log info unabl event' path messag getmessag
hierarchi event hierarchyev exist heexist hierarchi event hierarchyev event map eventmap uuid
exist heexist
exist heexist merg
event map eventmap put uuid
...
lock map lockmap
path map pathmap element element lock map lockmap map path oldpath
element
element remov
path map pathmap element parent lock map lockmap map path newpath ancestor getancestor
parent
parent insert path newpath element getnameel
element
lock map lockmap put path newpath element
path found except pathnotfoundexcept
