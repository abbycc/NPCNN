...
session session
resolv session path resolv getnamepathresolv
...
resolv path getqpath event path getpath normal path getnormalizedpath
event type gettyp
...
inform link org apach jackrabbit pathmap
