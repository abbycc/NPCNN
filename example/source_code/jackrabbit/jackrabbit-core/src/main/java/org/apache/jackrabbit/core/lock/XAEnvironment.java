...
info lock info xalockinfo node session scope issessionscop deep isdeep timeout hint timeouthint lock owner lockown
...
result arrai toarrai lock info lockinfo result size
...
node impl nodeimpl node
session scope sessionscop deep timeout hint timeouthint string lock owner lockown
node node getnodeid session scope sessionscop deep lock owner lockown timeout hint timeouthint
node node
