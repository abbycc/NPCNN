...
org apach jackrabbit base except baseexcept
...
properti propertyid state thisstat uuid getuuid prop propnam
properti
build resolv absolut path
...
jcr uuid properti
gen valu genvalu intern internalvalu intern internalvalu creat state thisstat uuid getuuid
...
prop state propstat
state mgr statemgr creat transient properti state createtransientpropertyst parent uuid parentuuid
...
node state nodest
state mgr statemgr creat transient node state createtransientnodest uuid node type nodetyp getqnam
parent uuid parentuuid item state itemst statu statu
...
node
renam child node renamechildnod qname oldnam index string uuid
qname newnam
repositori except repositoryexcept
modifi state 'this' parent node
node state nodest state thisstat node state nodest creat transient item state getorcreatetransientitemst
...
item mgr itemmgr item getitem prop propid set remov setremov
final remov node
state thisstat set parent uuid setparentuuid
...
node nodeid newid node nodeid cne uuid getuuid
...
prop properti impl propertyimpl item mgr itemmgr item getitem properti propertyid state thisstat uuid getuuid qname jcr mixintyp jcr mixintyp
...
link node addmixin string take code qname code
instad code string code
...
silent ignor fall
link node removemixin string take code qname code
instad code string code
...
qname prop propnam qname iter
properti impl propertyimpl prop properti impl propertyimpl item mgr itemmgr item getitem properti propertyid state thisstat uuid getuuid prop propnam
...
link node isnodetyp string take code qname code
instad code string code
...
build effect node type repres primari type incl mixin'
check includ node type
node type registri nodetyperegistri reg ntreg session node type manag getnodetypemanag node type registri getnodetyperegistri
mixin'
set type set typeset node state nodest state mixin type name getmixintypenam
qname type qname type set typeset size
type set typeset arrai toarrai type
primari type
...
node type conflict except nodetypeconflictexcept ntce
string msg intern error fail build effect node type
arrai list aslist type
log debug msg
repositori except repositoryexcept msg ntce
return intern uuid node
return uuid node
string intern uuid internalgetuuid
...
property' definit
strong import strong method public order make
access intern code locat subpackag
call applic directli
param
param
return
...
todo fixm internalsetproperti public potenti secur risk
code snippet workaround verifi
caller locat packag 'core' subpackag
thereof test jackrabbit run standalon
comment potenti
problem side effect setup environ
callcontext ctx callcontext
string calledfrompackag ctx getcal getpackag getnam
string thispackag nodeimpl class getpackag getnam
check call current packag 'core'
subpackag thereof
calledfrompackag startswith thispackag
throw securityexcept illeg method invok
type
...
node nodeid node nodeid node nodeid cne uuid getuuid
node impl nodeimpl item mgr itemmgr item getitem node nodeid
access deni except accessdeniedexcept ad
item found except itemnotfoundexcept
...
saniti check sanitycheck
node state nodest state thisstat node state nodest state
properti propertyid prop propid properti propertyid state thisstat uuid getuuid
...
intern add child node internaladdchildnod node nodenam uuid
...
node item mgr itemmgr item getitem node nodeid parent uuid parentuuid
node
inheritdoc
...
check state instanc
saniti check sanitycheck
node refer nodereferencesid target targetid node refer nodereferencesid node nodeid uuid getuuid
node refer noderefer ref creat node refer getorcreatenoderefer target targetid
...
node state nodest state mgr statemgr item state getitemst node nodeid parent uuid parentuuid
node state nodest child node entri childnodeentri parent entri parententri
parent child node entri getchildnodeentri node state nodest state uuid getuuid
...
string uuid child intern uuid internalgetuuid
...
dst node dstnode node impl nodeimpl session node uuid getnodebyuuid uuid
remov exist removeexist
...
uuid
dst node dstnode
dst node dstnode intern add child node internaladdchildnod child getqnam node type impl nodetypeimpl child primari node type getprimarynodetyp uuid
add mixin
...
unsupport repositori oper except unsupportedrepositoryoperationexcept repositori except repositoryexcept
intern restor internalrestor version impl versionimpl version intern version getinternalvers vsel remov exist removeexist
repositori except repositoryexcept
revert session
...
param removeexist
throw repositoryexcept
intern version internalvers intern restor internalrestor intern version internalvers version version selector versionselector vsel
remov exist removeexist
repositori except repositoryexcept
fail root version
...
intern set properti internalsetproperti qname jcr basevers jcr basevers intern internalvalu creat uuid version getid
...
intern set properti internalsetproperti qname jcr ischeckedout jcr ischeckedout intern internalvalu creat
intern version internalvers restor arrai toarrai intern version internalvers restor size
...
version histori impl versionhistoryimpl histori version histori impl versionhistoryimpl session node uuid getnodebyuuid version histori getversionhistoryid
string node nodeid histori version uuid getversionableuuid
check repres version exist
item mgr itemmgr item exist itemexist node nodeid node nodeid
node impl nodeimpl node impl nodeimpl session node uuid getnodebyuuid node nodeid
parent getpar issam
order end
orderbefor getnam
remov exist removeexist
...
lock manag lockmanag lock mgr lockmgr workspac impl workspaceimpl session workspac getworkspac lock manag getlockmanag
lock mgr lockmgr lock deep isdeep session scope issessionscop
inheritdoc
lock lock getlock
unsupport repositori oper except unsupportedrepositoryoperationexcept lock except lockexcept
access deni except accessdeniedexcept repositori except repositoryexcept
...
saniti check sanitycheck
todo fixm transact
node type isnodetyp qname mix lockabl mix lockabl transact istransactionalnew
...
node check
lock manag lockmanag lock mgr lockmgr workspac impl workspaceimpl session workspac getworkspac lock manag getlockmanag
lock mgr lockmgr check lock checklock
class
call context callcontext secur manag securitymanag
class caller getcal
getclasscontext 'this' class
getclasscontext class call getcal 'this' method
getclasscontext
class context getclasscontext
class caller stack getcallerstack
class context getclasscontext
