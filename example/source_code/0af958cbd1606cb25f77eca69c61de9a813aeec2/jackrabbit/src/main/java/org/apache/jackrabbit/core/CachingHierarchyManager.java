...
root node rootnodeid provid resolv nsresolv
...
node state nodest state overlai state getoverlayedst child node entri getchildnodeentri getid
log warn reorder child node found list
node ad nodead state getnam index getindex getid
node remov noderemov state getnam index getindex getid
inheritdoc
