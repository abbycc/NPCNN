...
iter authoriz find authoriz findauthoriz string properti propertynam string repositori except repositoryexcept
...
iter authoriz find authoriz findauthoriz string properti propertynam string search type searchtyp
repositori except repositoryexcept
...
intern authoriz internalgetauthoriz user userid
...
creat defin link getgroupspath group path
...
valid princip isvalidprincip princip
illeg argument except illegalargumentexcept creat authoriz princip null valid
...
correct node type
underneith configur user group tree
pre
...
administr user
nodeid creat link buildnodeid string conincid
