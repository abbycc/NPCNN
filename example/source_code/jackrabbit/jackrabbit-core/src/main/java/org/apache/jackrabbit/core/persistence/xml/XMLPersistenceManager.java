org apach jackrabbit core persist xml
...
logger log logger factori loggerfactori logger getlogg xml persist manag xmlpersistencemanag
hexdigit tostr
...
templat subdirectori path file
singl node templat process replac
code code hex digit uuid string
charact templat
string node path templat nodepathtempl xxxx xxxx xxxxxxxxxxxxxxxxxxxxxxxx
factori namefactori factori
creat code xmlpersistencemanag code instanc
xml persist manag xmlpersistencemanag
initi
factori factori impl namefactoryimpl instanc getinst
return node path templat
return node path templat
string node path templat getnodepathtempl
node path templat nodepathtempl
set node path templat
param templat node path templat
set node path templat setnodepathtempl string templat
node path templat nodepathtempl templat
build path node folder node identifi
base configur node path templat
param node identifi
return node folder path
string build node folder path buildnodefolderpath node nodeid
string builder stringbuild string builder stringbuild
char string tostr char arrai tochararrai
cnt
node path templat nodepathtempl length
node path templat nodepathtempl char charat
cnt char length
char cnt
char cnt
append
string tostr
string build prop file path buildpropfilepath properti propertyid
string file filenam
messag digest messagedigest md5 messag digest messagedigest instanc getinst md5
md5 updat getnam namespac uri getnamespaceuri byte getbyt
md5 updat getnam local getlocalnam byte getbyt
byte md5 digest
char
char hexdigit byte
char hexdigit byte
...
build node folder path buildnodefolderpath parent getparentid file filenam
string build node file path buildnodefilepath node nodeid
build node folder path buildnodefolderpath nodefilenam
string build node refer file path buildnodereferencesfilepath node nodeid
build node folder path buildnodefolderpath noderefsfilenam
...
check uuid
state node getnodeid string tostr equal walker attribut getattribut uuid attribut uuid attribut
string msg invalid serial state uuid mismatch
log debug msg
item state except itemstateexcept msg
check nodetyp
string ntname walker attribut getattribut nodetyp attribut nodetyp attribut
factori creat ntname equal state node type getnodetypenam
...
state set parent setparentid node nodeid valueof parent uuid parentuuid
modif count
...
mixin add factori creat walker attribut getattribut attribut attribut
mixin size
...
state add properti addpropertynam factori creat prop propnam
walker leav element leaveel
child node entri
...
state add child node entri addchildnodeentri factori creat child childnam node nodeid valueof child uuid childuuid
walker leav element leaveel
...
item state except itemstateexcept msg
check
state getnam equal factori creat walker attribut getattribut attribut attribut
string msg invalid serial state mismatch
log debug msg
item state except itemstateexcept msg
check parentuuid
node nodeid parent parentid node nodeid valueof walker attribut getattribut parentuuid attribut parentuuid attribut
parent parentid equal state parent getparentid
...
state set multi valu setmultivalu boolean pars boolean parseboolean multi valu multivalu
modif count
string mod count modcount walker attribut getattribut modcount attribut modcount attribut
state set mod count setmodcount short pars short parseshort mod count modcount
valu
arrai list arraylist intern internalvalu valu arrai list arraylist intern internalvalu
...
input stream inputstream blob store blobstor content
...
valu add intern internalvalu valueof content type
empti string
log warn state properti getpropertyid ignor empti type
...
item state except itemstateexcept msg
check targetid
ref target gettargetid equal node nodeid valueof walker attribut getattribut targetid attribut targetid attribut
...
string node file path nodefilepath build node file path buildnodefilepath
...
state set node type setnodetypenam factori creat ntname
...
string prop file path propfilepath build prop file path buildpropfilepath
...
string parent parentid state parent getparentid state parent getparentid string tostr
string encod node type encodednodetyp text encod illeg xml charact encodeillegalxmlcharact state node type getnodetypenam string tostr
writer write xml version encod encod
writer write node element node element
uuid attribut uuid attribut
parentuuid attribut parentuuid attribut parent parentid
modcount attribut modcount attribut state mod count getmodcount
nodetyp attribut nodetyp attribut encod node type encodednodetyp
mixin type
writer write mixintyp element mixintyp element
mixin state mixin type name getmixintypenam
writer write mixintyp element mixintyp element
attribut attribut text encod illeg xml charact encodeillegalxmlcharact mixin string tostr
writer write mixintyp element mixintyp element
properti
writer write properti element properti element
prop propnam state properti name getpropertynam
writer write properti element properti element
...
uuid attribut uuid attribut entri getid
writer write node element node element
writer write node element node element
writer write node element node element
writer close
except
string msg fail write node state
log debug msg
item state except itemstateexcept msg
inheritdoc
...
initi
illeg state except illegalstateexcept initi
string prop file path propfilepath build prop file path buildpropfilepath state properti getpropertyid
...
parentuuid attribut parentuuid attribut state parent getparentid
...
input stream inputstream val stream getstream
string blob blobid blob store blobstor creat createid state properti getpropertyid
blob store blobstor put blob blobid val length getlength
util ioutil close quietli closequietli
store blob properti
...
read blob input stream
file system resourc filesystemresourc re fsre
resourc base blob store resourcebasedblobstor blob store blobstor resourc getresourc blob blobid
valu intern internalvalu creat re fsre
blob store blobstor blob blobid
...
string msg fail store properti state state parent getparentid state getnam
log debug msg
item state except itemstateexcept msg
inheritdoc
...
file system except filesystemexcept fse
string msg fail delet node state
log debug msg
...
intern internalvalu val valu
val
val delet binari resourc deletebinaryresourc
delet properti file
string prop file path propfilepath build prop file path buildpropfilepath state properti getpropertyid
file system resourc filesystemresourc prop file propfil file system resourc filesystemresourc item state itemstatef prop file path propfilepath
...
file system except filesystemexcept fse
string msg fail delet properti state state parent getparentid state getnam
log debug msg
item state except itemstateexcept msg fse
inheritdoc
node refer noderefer load refer loadreferencesto node nodeid
item state except nosuchitemstateexcept item state except itemstateexcept
initi
illeg state except illegalstateexcept initi
except
string ref file path refsfilepath build node refer file path buildnodereferencesfilepath
...
initi
illeg state except illegalstateexcept initi
string ref file path refsfilepath build node refer file path buildnodereferencesfilepath ref target gettargetid
...
properti propertyid prop propid ref refer getrefer
writer write noderefer element noderefer element
...
item state except itemstateexcept msg fse
inheritdoc
exist refer existsreferencesto node nodeid
item state except itemstateexcept
initi
illeg state except illegalstateexcept initi
string ref file path refsfilepath build node refer file path buildnodereferencesfilepath
