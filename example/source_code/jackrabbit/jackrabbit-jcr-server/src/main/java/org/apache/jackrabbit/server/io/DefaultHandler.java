...
org apach tika metadata metadata
org slf4j logger
...
default handler defaulthandl handler iohandl properti handler propertyhandl copi move handler copymovehandl
logger log logger factori loggerfactori logger getlogg default handler defaulthandl
string collect nodetyp collectionnodetyp
string default nodetyp defaultnodetyp
string content nodetyp contentnodetyp
...
manag iomanag
jcr constant jcrconstant folder folder
jcr constant jcrconstant file file
import note webdav complianc default type
content node chang resourc
unstructur
jcr constant jcrconstant unstructur unstructur
...
content node contentnod
jcr predefin content node type
underli repositori
parent node parentnod primari node type getprimarynodetyp add child node canaddchildnod
jcr constant jcrconstant jcr content jcr content content node type getcontentnodetyp
content node contentnod parent node parentnod add node addnod
jcr constant jcrconstant jcr content jcr content content node type getcontentnodetyp
content node contentnod parent node parentnod add node addnod jcr constant jcrconstant jcr content jcr content
content node contentnod
...
stream undefin content length set
...
map prop entri propentri import properti importproperti properti import context propertyimportcontext import context importcontext collect iscollect repositori except repositoryexcept
...
map prop entri propentri repositori except repositoryexcept failur hash map hashmap prop entri propentri repositori except repositoryexcept
list prop entri propentri chang list changelist import context importcontext chang list getchangelist
...
failur
detect media type document base
param document
return detect content type applic octet stream
string detect string
metadata metadata metadata
metadata set metadata resourc kei resourc kei
manag iomanag manag iomanag detector getdetector
manag iomanag detector getdetector detect metadata string tostr
applic octet stream
except ioexcept
happen inputstream null
illeg state except illegalstateexcept
unexpect ioexcept
copymovehandl
copymovehandl cancopi copymovecontext org apach jackrabbit webdav davresourc org apach jackrabbit webdav davresourc
copi cancopi copi move context copymovecontext context dav resourc davresourc sourc dav resourc davresourc destin
copymovehandl copi copymovecontext org apach jackrabbit webdav davresourc org apach jackrabbit webdav davresourc
copi copi move context copymovecontext context dav resourc davresourc sourc dav resourc davresourc destin dav except davexcept
context shallow copi isshallowcopi sourc collect iscollect
...
context session getsess workspac getworkspac copi sourc locat getloc repositori path getrepositorypath destin locat getloc repositori path getrepositorypath
...
copymovehandl canmov copymovecontext org apach jackrabbit webdav davresourc org apach jackrabbit webdav davresourc
move canmov copi move context copymovecontext context dav resourc davresourc sourc dav resourc davresourc destin
copymovehandl move copymovecontext org apach jackrabbit webdav davresourc org apach jackrabbit webdav davresourc
move copi move context copymovecontext context dav resourc davresourc sourc dav resourc davresourc destin dav except davexcept
context workspac getworkspac move sourc locat getloc repositori path getrepositorypath destin locat getloc repositori path getrepositorypath
repositori except repositoryexcept
jcr dav except jcrdavexcept
privat
...
setter configur
set collect nodetyp setcollectionnodetyp string collect nodetyp collectionnodetyp
collect nodetyp collectionnodetyp collect nodetyp collectionnodetyp
set default nodetyp setdefaultnodetyp string default nodetyp defaultnodetyp
default nodetyp defaultnodetyp default nodetyp defaultnodetyp
set content nodetyp setcontentnodetyp string content nodetyp contentnodetyp
content nodetyp contentnodetyp content nodetyp contentnodetyp
