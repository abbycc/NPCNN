...
detect repositori shut properli
...
appear file
lock absolut path getabsolutepath lock current process
rep lock replock
repositori except repositoryexcept
repositori home home absolut path getabsolutepath
appear file
...
def sy session defsyssess jcr getjcrnam qname jcr system jcr system
system search mgr systemsearchmgr
creat cluster node
return cluster node
...
share item state manag shareditemstatemanag persist mgr persistmgr root node rootnodeid reg ntreg cach factori cachefactori
repositori
inheritdoc
...
item state mgr itemstatemgr creat item state manag createitemstatemanag persist mgr persistmgr root node rootnodeid reg ntreg cach factori cachefactori
...
inheritdoc
namespac resolv namespaceresolv namespac resovl getnamespaceresovl
namespac registri getnamespaceregistri
inheritdoc
