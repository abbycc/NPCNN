...
input stream inputstream file input fileinput
string temp tempid
result set resultset
temp modifi tempmodifi
temp modifi tempmodifi system current time milli currenttimemilli
...
con helper conhelp queri select meta sql selectmetasql temp tempid
hasnext
close
hasnext
event row exist
insert datastor valu null
con helper conhelp exec insert temp sql inserttempsql temp tempid temp modifi tempmodifi
except
...
count input stream countinginputstream count input stream countinginputstream din
...
file input fileinput buffer input stream bufferedinputstream temp file input stream tempfileinputstream temp
length temp length
...
con helper conhelp exec updat data sql updatedatasql wrapper temp tempid
length byte count getbytecount
...
modifi newmodifi
modifi newmodifi system current time milli currenttimemilli
check exist checkexist temp tempid length identifi
touch identifi modifi newmodifi
con helper conhelp exec delet sql deletesql temp tempid
updat datastor set length modifi
modifi
count con helper conhelp updat updat sql updatesql
length modifi newmodifi temp tempid temp modifi tempmodifi
updat count modifi time
temporari row chang mean
modifi date
ensur modifi date
newer garbag
collect delet row
...
duplic kei row exist repeat
except handl flow control bad
altern updat select
deadlock databas
duplic kei occur concurr
ad record
select length modifi datastor
con helper conhelp queri select meta sql selectmetasql temp tempid
row delet unexpect allow
string msg
digest temporari entri delet
temp tempid length length
log error msg
data store except datastoreexcept msg
temp modifi tempmodifi long getlong
util dbutil close
identifi usesidentifi identifi
data record dbdatarecord record data record dbdatarecord identifi length modifi newmodifi
record
except
convert insert record
temp tempid
...
check row exist
return true row exist length match
throw datastoreexcept row exist length
check exist checkexist string temp tempid length data identifi dataidentifi identifi data store except datastoreexcept sql except sqlexcept
string identifi string tostr
select length modifi datastor
result set resultset
con helper conhelp queri select meta sql selectmetasql
...
con helper conhelp updat delet older sql deleteoldersql min
except
...
result set resultset
select datastor
con helper conhelp queri select sql selectallsql
...
con helper conhelp queri select data sql selectdatasql identifi string tostr
data store except datastoreexcept record found identifi
...
stream buffer input stream bufferedinputstream temp file input stream tempfileinputstream temp
util dbutil close
...
con helper conhelp updat updat modifi sql updatelastmodifiedsql kei
except
