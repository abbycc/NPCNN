...
java text decim format decimalformat
java util calendar
...
pre
iso8601
misc numer format format
decim format decimalformat format format decim format decimalformat
decim format decimalformat xxx format xxx format decim format decimalformat
decim format decimalformat xxxx format xxxx format decim format decimalformat
...
year yyyi
buf append xxxx format xxxx format format year getyear cal
buf append
month
buf append format format format cal calendar month
buf append
dai
buf append format format format cal calendar dai month dai month
buf append
hour
buf append format format format cal calendar hour dai hour dai
buf append
minut
buf append format format format cal calendar minut
buf append
buf append format format format cal calendar
buf append
millisecond sss
buf append xxx format xxx format format cal calendar millisecond
time zone design
...
buf append offset
buf append format format format hour
buf append
buf append format format format minut
buf append
buf string tostr
return astonom year calendar
