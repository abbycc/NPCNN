...
org apach jackrabbit core config data store config datastoreconfig
...
jackrabbit repositori jackrabbitrepositori session listen sessionlisten event listen eventlisten
...
string workspac workspacenam smc workspac getworkspacenam
workspac workspacenam
workspac workspacenam config getconfig default workspac getdefaultworkspacenam
...
reg ntreg
data store datastor
ism lock ismlock ism lock ismlock config vconfig ism lock config getismlockingconfig creat ism lock createismlock
...
string sec wsp secwspnam rep config repconfig secur config getsecurityconfig secur manag config getsecuritymanagerconfig workspac getworkspacenam
...
repositori except repositoryexcept
creat data store object data store configur
return data store object
data store datastor creat data store createdatastor repositori except repositoryexcept
data store config datastoreconfig dsc rep config repconfig data store config getdatastoreconfig
data store datastor data store datastor data store datastor dsc instanc newinst
data store datastor init rep config repconfig home dir gethomedir
data store datastor
...
reg ntreg
data store datastor
ism lock ismlock ism lock ismlock config ism lock config getismlockingconfig creat ism lock createismlock
...
updateeventlisten
inheritdoc
extern updat externalupd chang log changelog extern list event repositori except repositoryexcept
