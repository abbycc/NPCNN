...
node constant nameconst jcr versionhistori jcr versionhistori properti type propertytyp refer
intern internalvalu creat uuid histori uuid getuuid
jcr basevers
condit add properti conditionaladdproperti
node constant nameconst jcr basevers jcr basevers properti type propertytyp refer
intern internalvalu creat uuid root version rootvers uuid getuuid
jcr predecessor
condit add properti conditionaladdproperti
node constant nameconst jcr predecessor jcr predecessor properti type propertytyp refer
intern internalvalu creat uuid root version rootvers uuid getuuid
jcr ischeckedout
condit add properti conditionaladdproperti
node constant nameconst jcr ischeckedout jcr ischeckedout properti type propertytyp boolean
