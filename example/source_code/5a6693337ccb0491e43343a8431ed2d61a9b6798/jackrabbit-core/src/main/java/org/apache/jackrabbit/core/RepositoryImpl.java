...
java util concurr schedul thread pool executor scheduledthreadpoolexecutor
java util concurr thread factori threadfactori
java util concurr thread pool executor threadpoolexecutor
...
map session impl sessionimpl session impl sessionimpl activ session activesess
...
schedul executor servic
schedul executor servic scheduledexecutorservic executor
protect constructor
...
jackrabbit classload background thread
pool
class loader classload pool class loader poolclassload class getclass class loader getclassload
schedul thread pool executor scheduledthreadpoolexecutor executor schedul thread pool executor scheduledthreadpoolexecutor
runtim runtim getruntim processor availableprocessor
thread factori threadfactori
atom integ atomicinteg thread number threadnumb atom integ atomicinteg
java util concurr threadfactori newthread java lang runnabl
thread thread newthread runnabl
thread thread
jackrabbit pool thread number threadnumb increment getandincr
set daemon setdaemon
prioriti getprior thread norm prioriti norm prioriti
set prioriti setprior thread norm prioriti norm prioriti
set context class loader setcontextclassload pool class loader poolclassload
thread pool executor threadpoolexecutor caller run polici callerrunspolici
executor executor
...
list session impl sessionimpl
activ session activesess
arrai list arraylist session impl sessionimpl activ session activesess size
session impl sessionimpl session activ session activesess valu
add session
...
context intern version manag getinternalversionmanag close
except
...
repositori except repositoryexcept
persist manag persistencemanag config pmconfig instanc newinst persist manag persistencemanag
...
system root node system root node executor
...
lock manag impl lockmanagerimpl system session getsystemsess executor
...
session impl sessionimpl se activ session activesess valu
