...
sy root sysroot intern add virtual child node internaladdvirtualchildnod qname jcr versionstorag jcr versionstorag version storag node version storag node
add node type
sy session syssess node type manag getnodetypemanag node type getnodetyp qname rep nodetyp rep nodetyp
sy root sysroot intern add virtual child node internaladdvirtualchildnod qname jcr nodetyp jcr nodetyp nodetyp node nodetyp node
...
format nameformat format qname jcr system jcr system def sy session defsyssess namespac resolv getnamespaceresolv
system search mgr systemsearchmgr
