...
org apach jackrabbit core version intern version manag internalxaversionmanag
org slf4j logger
...
global transact
map xid transact context transactioncontext global txglobal
collect synchron map synchronizedmap hash map hashmap xid transact context transactioncontext
system properti default transact timeout
string system properti default transact timeout system properti default transact timeout org apach jackrabbit core defaulttransactiontimeout
default transact timeout second
system properti link xasessionimpl system properti default transact timeout
default second set transactionmanag runtim
default timeout default timeout integ pars int parseint system properti getproperti system properti default transact timeout system properti default transact timeout
transact
...
repositori context repositorycontext login context logincontext wsp config wspconfig
init
creat instanc class
param repositorycontext repositori context
...
workspac impl workspaceimpl workspac context workspac getworkspac
item state manag xaitemstatemanag state mgr statemgr
item state manag xaitemstatemanag workspac item state manag getitemstatemanag
lock manag xalockmanag lock mgr lockmgr
lock manag xalockmanag workspac intern lock manag getinternallockmanag
intern version manag internalxaversionmanag version mgr versionmgr
intern version manag internalxaversionmanag intern version manag getinternalversionmanag
...
intern version manag internalxaversionmanag
...
repositori context repositorycontext item state cach factori getitemstatecachefactori
xasess
inheritdoc
...
transact context transactioncontext global txglobal xid
flag tmnoflag
...
transact context transactioncontext transact context transactioncontext xid resourc txresourc
...
logout
dispos cach
intern version manag internalxaversionmanag version mgr versionmgr close
except
log warn error close internalxaversionmanag
