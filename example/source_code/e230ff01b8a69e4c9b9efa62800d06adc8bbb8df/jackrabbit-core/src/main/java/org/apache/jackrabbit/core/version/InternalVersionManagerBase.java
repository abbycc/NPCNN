...
lock version manag
default ism lock defaultismlock lock rwlock default ism lock defaultismlock
...
write lock writelock acquir write lock acquirewritelock
...
write oper writeoper write lock writelock lock
lock lock
...
success
write lock writelock lock acquir write lock acquirewritelock
...
write oper writeoper oper start write oper startwriteoper
creat deep path
node nodeid activ activityid node nodeid
...
node nodeid act actid node properti getpropertyvalu constant nameconst jcr activ jcr activ node getnodeid
