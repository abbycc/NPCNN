...
listen finish oper
event channel eventchannel
event channel eventchannel updat commit updatecommit
...
iter local ad state addedst hasnext
add refer addrefer item state itemst
process modifi refer properti
iter local modifi state modifiedst hasnext
item state itemst state item state itemst
state node isnod
remov refer target
remov refer removerefer item state getitemst state getid
add refer target
add refer addrefer state
process remov refer properti
iter local delet state deletedst hasnext
remov refer removerefer item state itemst
add refer addrefer item state itemst state
item state except nosuchitemstateexcept item state except itemstateexcept
state node isnod
...
chang
iter modifi state modifiedst extern modifi state modifiedst
...
log warn msg
state discard
iter delet state deletedst extern delet state deletedst
