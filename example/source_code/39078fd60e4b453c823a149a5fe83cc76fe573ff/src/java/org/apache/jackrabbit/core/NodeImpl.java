...
check merg fail
properti hasproperti jcr mergefail jcr mergefail properti getproperti jcr mergefail jcr mergefail valu getvalu length
string msg unabl checkin node node unresolv merg oper safe jcr path safegetjcrpath
log debug msg
version except versionexcept msg
check lock statu
check lock checklock
...
string msg unabl checkin node session pend
log debug msg
invalid item state except invaliditemstateexcept msg
check lock statu
check lock checklock
...
src node srcnode
node node workspac
code srcworkspacenam code code updat code method
effect travers subtre
node node workspac code srcworkspacenam code
method travers subtre root node
replac state node subtre root node
node sourc workspac
remov exist removeexist
replac exist replaceexist
intern updat internalupd src node srcnode remov exist removeexist replac exist replaceexist
repositori except repositoryexcept
session refresh
session save
src session srcsession
...
check pend
session pend haspendingchang
string msg unabl merg session pend
log debug msg
invalid item state except invaliditemstateexcept msg
workspac ignor
src workspac srcworkspac equal session workspac getworkspac getnam
check lock statu
check lock checklock
session impl sessionimpl src session srcsession
creat session workspac current subject
...
node impl nodeimpl src node srcnode merg test domergetest src session srcsession effort besteffort
src node srcnode
remov properti
...
log debug msg
invalid item state except invaliditemstateexcept msg
todo implement node cancelmerg version
unsupport repositori oper except unsupportedrepositoryoperationexcept implement
inheritdoc
...
log debug msg
invalid item state except invaliditemstateexcept msg
todo implement node donemerg version
unsupport repositori oper except unsupportedrepositoryoperationexcept implement
inheritdoc
...
node impl nodeimpl merg test domergetest session impl sessionimpl src session srcsession effort besteffort
...
list valu properti hasproperti jcr mergefail jcr mergefail
arrai list aslist properti getproperti jcr mergefail jcr mergefail valu getvalu
arrai list arraylist
valu add refer referencevalu src node srcnode base version getbasevers
set properti setproperti jcr mergefail jcr mergefail valu arrai toarrai valu size
...
node add mixin addmixin name mxname
node
updat node state code srcnode code
param srcnode
param removeexist
param replaceexist
throw repositoryexcept
intern updat internalupd node impl nodeimpl src node srcnode remov exist removeexist replac exist replaceexist
lock except lockexcept repositori except repositoryexcept
check lock statu
check lock checklock
state node context mean set properti
child node word node updat set
properti child node replac node
sourc workspac repercuss node
subtre node node remov
align state parent corresponde
workspac
updat properti
...
updat node remov dst node
node iter nodeiter niter node getnod
niter hasnext
node impl nodeimpl niter node nextnod intern remov internalremov
add src
...
node type impl nodetypeimpl node type impl nodetypeimpl dst node dstnode primari node type getprimarynodetyp
node def impl nodedefimpl target def newtargetdef
target def newtargetdef node impl nodeimpl parent getpar applic child node def getapplicablechildnodedef child getqnam getqnam
repositori except repositoryexcept
string msg dst node dstnode safe jcr path safegetjcrpath definit found parent node' node type node
log debug msg
constraint violat except constraintviolationexcept msg
check lock statu current parent
node impl nodeimpl dst node dstnode parent getpar check lock checklock
add target parent remov
creat child node link createchildnodelink child getqnam uuid
node impl nodeimpl dst node dstnode parent getpar remov child node removechildnod child getqnam child index getindex child index getindex
chang definit target
node def impl nodedefimpl target def oldtargetdef node def impl nodedefimpl dst node dstnode definit getdefinit
node def nodedefid target def oldtargetdefid node def nodedefid target def oldtargetdef unwrap
node def nodedefid target def newtargetdefid node def nodedefid target def newtargetdef unwrap
target def oldtargetdefid equal target def newtargetdefid
dst node dstnode redefin onredefin target def newtargetdefid
replac exist replaceexist
...
dst node dstnode intern updat internalupd child remov exist removeexist replac exist replaceexist
