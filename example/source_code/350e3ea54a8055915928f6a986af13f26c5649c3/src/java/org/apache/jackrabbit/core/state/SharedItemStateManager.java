...
effect node type effectivenodetyp ent reg ntreg effect node type geteffectivenodetyp constant rep root rep root
prop def propdef ent applic properti def getapplicablepropertydef constant jcr primarytyp jcr primarytyp
...
root state rootstat add properti entri addpropertyentri prop def propdef getnam
...
prop set definit setdefinitionid prop def propdefid prop def propdef
...
set virtual node refer
todo rememb provid
arrai list arraylist virtual ref virtualref arrai list arraylist
...
targetid virtual provid transfer modifi set
virtual provid virtualprovid length
...
succeed
store oper unsuccess restor
origin state item local chang log
succeed
local disconnect
share item listen chang
share persist
notifi virtual provid node refer
iter virtual ref virtualref iter
iter hasnext
node refer noderefer ref node refer noderefer iter
targetid virtual provid transfer modifi set
virtual provid virtualprovid length
