...
privat constructor
effect node type impl effectivenodetypeimpl
...
effect node type impl effectivenodetypeimpl creat node type registri nodetyperegistri reg ntreg node type definit qnodetypedefinit ntd map ntd map ntdmap
...
effect node type impl effectivenodetypeimpl ent effect node type impl effectivenodetypeimpl
qname ntname ntd getqnam
prepar instanc
...
item def id itemdefid add cnda
cnda defin residu definesresidu
residu node definit
...
make auto creat
def size
item definit qitemdefinit def qdef item definit qitemdefinit def
cnda auto creat isautocr def qdef auto creat isautocr
conflict
...
def size
item definit qitemdefinit def qdef item definit qitemdefinit def
pda auto creat isautocr def qdef auto creat isautocr
conflict
string msg 'auto create' item definit
node type ntname
log debug msg
...
supertyp length
effect node type impl effectivenodetypeimpl eff super type effsupertyp effect node type impl effectivenodetypeimpl reg ntreg effect node type geteffectivenodetyp supertyp ntd map ntdmap
ent intern merg internalmerg eff super type effsupertyp
ent
factori method creat 'empty' effect node type instanc
return effectivenodetyp
...
iter hasnext
item definit qitemdefinit def qdef item definit qitemdefinit iter
...
iter1 hasnext
item definit qitemdefinit def qdef item definit qitemdefinit iter1
def qdef defin node definesnod
def add def qdef
def size
node definit qnodedefinit empti arrai empti arrai
node definit qnodedefinit def arrai toarrai node definit qnodedefinit def size
inheritdoc
...
def size
properti definit qpropertydefinit empti arrai empti arrai
properti definit qpropertydefinit def arrai toarrai properti definit qpropertydefinit def size
inheritdoc
...
inheritdoc
includ node type includesnodetyp qname node type name nodetypenam
node type allnodetyp containsal arrai list aslist node type name nodetypenam
inheritdoc
check add node constraint checkaddnodeconstraint qname node type registri nodetyperegistri reg ntreg
constraint violat except constraintviolationexcept
applic node definit getapplicablenodedefinit reg ntreg
...
inheritdoc
check add node constraint checkaddnodeconstraint qname qname node type nodetypenam node type registri nodetyperegistri reg ntreg
constraint violat except constraintviolationexcept node type except nosuchnodetypeexcept
node definit qnodedefinit applic node definit getapplicablenodedefinit node type nodetypenam reg ntreg
protect isprotect
...
inheritdoc
node definit qnodedefinit applic node definit getapplicablenodedefinit qname qname node type nodetypenam
...
inheritdoc
properti definit qpropertydefinit applic properti definit getapplicablepropertydefinit qname type
...
def size
item definit qitemdefinit empti arrai empti arrai
item definit qitemdefinit def arrai toarrai item definit qitemdefinit def size
item definit qitemdefinit unnam item def getunnameditemdef
unnam item def unnameditemdef size
item definit qitemdefinit empti arrai empti arrai
item definit qitemdefinit unnam item def unnameditemdef arrai toarrai item definit qitemdefinit unnam item def unnameditemdef size
item definit qitemdefinit name item def getnameditemdef qname
...
node definit qnodedefinit empti arrai empti arrai
node definit qnodedefinit def arrai toarrai node definit qnodedefinit def size
properti definit qpropertydefinit name prop def getnamedpropdef qname
list list list name item def nameditemdef
list list size
properti definit qpropertydefinit empti arrai empti arrai
arrai list arraylist def arrai list arraylist list size
iter iter list iter
iter hasnext
item definit qitemdefinit def qdef item definit qitemdefinit iter
def qdef defin node definesnod
...
qname def qdef getqnam
list exist def existingdef list name item def nameditemdef
exist def existingdef
exist def existingdef size
exist definit
exist def existingdef size
item definit qitemdefinit item def qitemdef item definit qitemdefinit exist def existingdef
make auto creat
...
iter iter unnam item def unnameditemdef iter
iter hasnext
item definit qitemdefinit exist item definit qitemdefinit iter
...
inherit node type inheritednodetyp add nta
object clone
effect node type impl effectivenodetypeimpl clone effect node type impl effectivenodetypeimpl
