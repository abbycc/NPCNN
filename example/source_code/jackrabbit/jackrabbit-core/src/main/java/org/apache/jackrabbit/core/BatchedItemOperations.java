...
batch item oper batcheditemoper
updat item state manag updatableitemstatemanag state mgr statemgr session context sessioncontext session context sessioncontext
...
ind dest path destpath index getindex
ind
subscript element
string msg
...
clone src state srcstate dest parent state destparentst dest path destpath getnam
...
repositori except repositoryexcept
copi
src path srcpath state mgr statemgr hier mgr hiermgr context access manag getaccessmanag
...
repositori except repositoryexcept msg
check access right lock statu node type constraint
jcr store target node state changelog earli
precautionari measur order isol concurr
underli check precondit
state mgr statemgr store dest parent state destparentst
check add node checkaddnod dest parent state destparentst dest path destpath getnam
src state srcstate node type getnodetypenam check access check access check lock check lock
check check check check check constraint check constraint check hold check hold check retent check retent
...
add parent
dest parent state destparentst add child node entri addchildnodeentri dest path destpath getnam state newstat node getnodeid
...
check add node checkaddnod dest parent destpar dest path destpath getnam
...
src index srcnameindex src path srcpath index getindex
src index srcnameindex
src index srcnameindex
renam renameonli
chang child node entri
dest parent destpar renam child node entri renamechildnodeentri src path srcpath getnam src index srcnameindex
dest path destpath getnam
check shareabl case
...
src parent srcparent remov child node entri removechildnodeentri target node getnodeid
parent target node
target set parent setparentid dest parent destpar node getnodeid
add child node entri parent
dest parent destpar add child node entri addchildnodeentri dest path destpath getnam target node getnodeid
store state
...
item definit qitemdefinit parent def parentdef
context item manag getitemmanag definit getdefinit parent state parentst unwrap
...
ent parent entpar check add node constraint checkaddnodeconstraint
node nodenam node type nodetypenam context node type registri getnodetyperegistri
node definit qnodedefinit node def newnodedef
...
log debug msg
repositori except repositoryexcept msg is
node definit qnodedefinit conflict target def conflictingtargetdef
context item manag getitemmanag definit getdefinit conflict state conflictingst unwrap
...
retent registri retentionregistri retent reg retentionreg
context session impl getsessionimpl retent registri getretentionregistri
...
item definit qitemdefinit target def targetdef
context item manag getitemmanag definit getdefinit target state targetst unwrap
...
manag edit mode
node definit qnodedefinit def find applic node definit findapplicablenodedefinit node nodenam node type nodetypenam parent
...
add child node entri parent
parent add child node entri addchildnodeentri node nodenam node node getnodeid
...
properti definit qpropertydefinit ent applic properti def getapplicablepropertydef constant nameconst jcr mixintyp jcr mixintyp
...
properti definit qpropertydefinit ent auto creat prop def getautocreatepropdef
creat properti state createpropertyst node getnam requir type getrequiredtyp
recurs add 'auto create' child node defin node type
node definit qnodedefinit ent auto creat node def getautocreatenodedef
...
node type instanc handler nodetypeinstancehandl session user getuserid set default valu setdefaultvalu
prop parent def
...
context workspac getworkspac intern lock manag getinternallockmanag check lock checklock
node path nodepath session
...
repositori except repositoryexcept
node state nodest node node state getnodest node path nodepath
context item manag getitemmanag definit getdefinit node protect isprotect
...
flag
copi
node shareabl node share set
copi uuid
section specif
shareabl ref tracker reftrack map getmappedid src state srcstate node getnodeid
node nodeid newid ref tracker reftrack map getmappedid src state srcstate node getnodeid
node state nodest share state sharedst node state nodest state mgr statemgr item state getitemst newid
share state sharedst add share addshar dest parent destparentid
share state sharedst
clone
referenc
referenc node creat node
uuid sourc node
src state srcstate node getnodeid
state mgr statemgr item state hasitemst
shareabl
node state nodest share state sharedst node state nodest state mgr statemgr item state getitemst
share state sharedst add share addshar dest parent destparentid
share state sharedst
node uuid exist
...
src access mgr srcaccessmgr read canread prop path proppath prop propid
...
mix lockabl
todo fixm deleg 'node type instanc handler'
properti definit qpropertydefinit def ent applic properti def getapplicablepropertydef
src child state srcchildstat getnam src child state srcchildstat type gettyp
src child state srcchildstat multi valu ismultivalu
constant nameconst mix lockabl mix lockabl equal def declar node type getdeclaringnodetyp
skip properti defin mix lockabl
properti state propertyst child state newchildst
copi properti state copypropertyst src child state srcchildstat prop propnam def
histori
full version fullversion
...
repositori except repositoryexcept msg is
copi properti state
param srcstate properti state copi
param parentid parent node
param propnam properti
param def definit properti
return copi properti state
throw repositoryexcept error occur copi
