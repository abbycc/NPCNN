org apach jackrabbit core state util
...
java util set
java util arrai
code serial code util class static method
serial deseri code itemst code
code noderefer code object simpl binari serial
format
serial
null uuid placehold byte null uuid placehold byte
encod serial string valu
string encod utf
serial code nodest code object
binari code stream code
param state code state code serial
param stream stream code state code
serial
throw except error occur serial
deseri nodest inputstream
serial node state nodest state output stream outputstream stream
except
...
write null uuid placehold byte null uuid placehold byte
write state parent getparentid uuid getuuid raw byte getrawbyt
definitionid
write utf writeutf state definit getdefinitionid string tostr
mixin type
collect state mixin type name getmixintypenam
...
modcount
write short writeshort state mod count getmodcount
properti name
state properti name getpropertynam
write int writeint size writeint size count
iter iter iter iter hasnext
qname prop propnam qname iter
write utf writeutf prop propnam string tostr writeutf propnam tostr
...
write entri getid uuid getuuid raw byte getrawbyt write entri getid getuuid getrawbyt uuid
deseri code nodest code object binari
code stream code
param state code state code deseri
param stream stream code state code deseri
throw except error occur deseri
serial nodest outputstream
deseri node state nodest state input stream inputstream stream
except
...
parentuuid null
uuid byte uuidbyt uuid uuid byte length uuid byte length
read fulli readfulli uuid byte uuidbyt
arrai equal uuid byte uuidbyt null uuid placehold byte null uuid placehold byte
state set parent setparentid node nodeid uuid uuid byte uuidbyt
definitionid
read utf readutf
...
modcount
mod count modcount read short readshort
state set mod count setmodcount mod count modcount
properti name
count read int readint count readint count
count
state add properti addpropertynam qname valueof read utf readutf state addpropertynam qname valueof readutf
child node list uuid pair
count read int readint count readint count
count
...
uuid
read fulli readfulli uuid byte uuidbyt
state add child node entri addchildnodeentri node nodeid uuid uuid byte uuidbyt
serial code propertyst code object
binari code stream code binari valu store
code blobstor code
param state code state code serial
param stream stream code state code
serial
...
throw except error occur serial
deseri propertyst inputstream blobstor
serial properti state propertyst state
...
writeutf string size limit 65k
string serial length byte
writeutf val tostr
byte val string tostr byte getbyt encod
write int writeint byte length writeint byte length lenght byte
write byte write byte byte
deseri code propertyst code object binari
code stream code binari valu retriev
code blobstor code
param state code state code deseri
param stream stream code state code
deseri
param blobstor handler blob data
throw except error occur deseri
serial propertyst outputstream blobstor
deseri properti state propertyst state
...
state set multi valu setmultivalu multi valu multivalu
definitionid
string read utf readutf
...
read utf readutf readutf blobid
special handl requir binari
store blob data
blob store
blob store blobstor resourc base blob store resourcebasedblobstor
...
read blob input stream
file system resourc filesystemresourc re fsre
resourc base blob store resourcebasedblobstor blob store blobstor resourc getresourc
val intern internalvalu creat re fsre
input stream inputstream blob store blobstor
...
string serial length byte
readutf
len read int readint int len readint lenght byte
byte len
read fulli readfulli byte readfulli byte byte
string byte encod
