...
rel depth start node link userconst user path
link userconst group path
...
configur option chang link user path default path
creat user
string param user path param user path userspath
configur option chang link group path default path
creat group
...
default link user path
string user path userspath
configur defin node group node creat
default link group path
string group path groupspath
flag indic link getauthoriz string find user
group creat jackrabbit
...
flat store batch modu
option turn made user manag
persist explicit call link javax jcr session save
edit session object default behavior
immedi persist
setpersistencemodu boolean session
batch modu batchmodu
...
link param user path miss set link user path
link param group path miss set link group path
...
param batch code true code made manag
authoriz persist explict call link
javax jcr session save
throw repositoryexcept pass code editingsess code
usermanag write
comment work progress
public void setpersistencemodu boolean batch session editingsess throw repositoryexcept
editingsess session
throw repositoryexcept chang persist modu session mismatch
batchmodu batch
...
user group
note return groupid
illeg jcr char group getid unescap node
addit escap requir
...
user userid user userid length
illeg argument except illegalargumentexcept creat user userid null empti string
password
illeg argument except illegalargumentexcept creat user null password
valid princip isvalidprincip princip
illeg argument except illegalargumentexcept creat user princip null valid
authoriz getauthoriz user userid
authoriz exist except authorizableexistsexcept user user userid exist
authoriz hasauthoriz princip
...
set properti setproperti user node usernod princip princip getvalu princip getnam
batch modu batchmodu
session save
...
creat code group code code princip code
creat link group path group path
exist element path creat node
type link rep authoriz folder rep authorizablefold
group gener princip
conflict exist authoriz happen case
...
valid princip isvalidprincip princip
illeg argument except illegalargumentexcept creat group princip null valid
authoriz hasauthoriz princip
authoriz exist except authorizableexistsexcept authoriz princip getnam exist
...
set properti setproperti group node groupnod princip princip getvalu princip getnam
batch modu batchmodu
session save
...
return
throw repositoryexcept
authoriz hasauthoriz princip princip repositori except repositoryexcept
authoriz getauthoriz princip
...
illeg argument except illegalargumentexcept user user path
...
group impl groupimpl creat group node groupnod
valid princip isvalidprincip princip princip
princip princip getnam princip getnam length
param
return
throw repositoryexcept
node nodeid build node buildnodeid string repositori except repositoryexcept
uuid uuid uuid uuid byte nameuuidfrombyt byte getbyt utf
node nodeid uuid
...
logout session loggedout session
session session
session logout
class
...
node impl nodeimpl folder
string default path defaultpath default folder path getdefaultfolderpath group isgroup intermedi path intermediatepath
session node exist nodeexist default path defaultpath
folder node impl nodeimpl session node getnod default path defaultpath
folder node type isnodetyp rep authoriz folder rep authoriz folder
repositori except repositoryexcept invalid intermedi path type rep authorizablefold
string segmt default path defaultpath split
folder node impl nodeimpl session root node getrootnod
...
auth node creat potenti collid
intermedi node
