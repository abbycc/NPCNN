...
node type definit qnodetypedefinit def mgr provid mgrprovid node type definit provid getnodetypedefinitionprovid node type definit getnodetypedefinit node type nodetypenam
ent parent entpar check add node constraint checkaddnodeconstraint node nodenam def mgr provid mgrprovid item definit provid getitemdefinitionprovid
collis
option check collis check collis check collis check collis
...
mgr provid mgrprovid version state manag getversionstatemanag check check checkischeckedout node state nodest
...
node state nodest node state nodest item state itemst node isnod node state nodest item state itemst item state itemst parent getpar
mgr provid mgrprovid lock state manag getlockstatemanag check lock checklock node state nodest
...
note check collis exist child node
remov jsr name node properti
allow deleg valid underli
spi implement
...
note check collis exist child properti
remov jsr name node properti
allow deleg valid underli
spi implement
check conflict exist sibl node
