...
jcr basevers
node properti haspropertynam jcr basevers jcr basevers
...
jcr predecessor
node properti haspropertynam jcr predecessor jcr predecessor
...
prop set valu setvalu intern internalvalu intern internalvalu creat uuid hist root version getrootvers uuid getuuid
jcr ischeckedout
node properti haspropertynam jcr ischeckedout jcr ischeckedout
...
properti propertyid prop propid properti propertyid parent uuid getuuid node nodenam
...
properti state propertyst prop newprop
item op itemop creat properti state createpropertyst parent newnam
conflict type gettyp conflict valu getvalu length
prop newprop set valu setvalu conflict valu getvalu
parent remov properti removepropertynam node nodenam
...
properti state propertyst prop
prop def propdef def
node properti haspropertynam prop propnam
properti exist
