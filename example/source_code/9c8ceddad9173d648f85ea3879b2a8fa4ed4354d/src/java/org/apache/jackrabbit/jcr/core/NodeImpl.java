org apach jackrabbit jcr core
org apach jackrabbit jcr core nodetyp
org apach jackrabbit jcr core state
org apach jackrabbit jcr core version frozen node frozennod
org apach jackrabbit jcr core version gener version selector genericversionselector
org apach jackrabbit jcr core version version impl versionimpl
org apach jackrabbit jcr core version version selector versionselector
org apach jackrabbit jcr util children collector childrencollector
org apach jackrabbit jcr util iter helper iteratorhelp
org apach jackrabbit jcr util uuid uuid
org apach log4j logger
javax jcr
javax jcr access access deni except accessdeniedexcept
javax jcr lock lock
...
todo central version histori creation code nodeimpl addmixin itemimpl initversionhistori
...
check collis
item impl itemimpl item item mgr itemmgr item getitem node path nodepath
item node isnod
properti
...
node
node remov string
remov string rel path relpath
path found except pathnotfoundexcept repositori except repositoryexcept
check state instanc
check item state checkitemst
path target path targetpath
path path element pathel target targetnam
path parent path parentpath
target path targetpath path creat primari path getprimarypath rel path relpath session namespac resolv getnamespaceresolv
target targetnam target path targetpath element getnameel
parent path parentpath target path targetpath ancestor getancestor
malform path except malformedpathexcept
string msg fail resolv path rel path relpath rel safe jcr path safegetjcrpath
log error msg
repositori except repositoryexcept msg
check item exist protect
item impl itemimpl target item targetitem
target item targetitem item mgr itemmgr item getitem target path targetpath
target item targetitem node isnod
node impl nodeimpl node node impl nodeimpl target item targetitem
node def nodedef def node definit getdefinit
check protect flag
def protect isprotect
string msg target item targetitem safe jcr path safegetjcrpath remov protect node
log error msg
constraint violat except constraintviolationexcept msg
properti impl propertyimpl prop properti impl propertyimpl target item targetitem
properti def propertydef def prop definit getdefinit
check protect flag
def protect isprotect
string msg target item targetitem safe jcr path safegetjcrpath remov protect properti
log error msg
constraint violat except constraintviolationexcept msg
access deni except accessdeniedexcept ad
path found except pathnotfoundexcept rel path relpath
node impl nodeimpl parent node parentnod
item impl itemimpl parent item mgr itemmgr item getitem parent path parentpath
parent node isnod
string msg remov item properti parent safe jcr path safegetjcrpath
log error msg
repositori except repositoryexcept msg
parent node parentnod node impl nodeimpl parent
access deni except accessdeniedexcept ad
...
target item targetitem node isnod
parent node parentnod remov child node removechildnod target targetnam getnam target targetnam index getindex
parent node parentnod remov child properti removechildproperti target targetnam getnam
node addnod string
...
travers children 'collector'
accept children collector childrencollector node
node size
node hasproperti
...
travers children 'collector'
accept children collector childrencollector prop
prop size
...
todo central version histori creation code nodeimpl addmixin itemimpl initversionhistori
ntname equal node type registri nodetyperegistri mix version mix version
version histori versionhistori hist rep version manag getversionmanag creat version histori createversionhistori
intern set properti internalsetproperti version impl versionimpl propnam version histori propnam version histori intern internalvalu creat uuid hist uuid getuuid
intern set properti internalsetproperti version impl versionimpl propnam base version propnam base version intern internalvalu creat uuid hist root version getrootvers uuid getuuid
intern set properti internalsetproperti version impl versionimpl propnam check propnam check intern internalvalu creat
intern set properti internalsetproperti version impl versionimpl propnam predecessor propnam predecessor intern internalvalu intern internalvalu creat uuid hist root version getrootvers uuid getuuid
...
list add item mgr itemmgr item getitem prop propid
iter helper iteratorhelp list
node getdefinit
...
version rep version manag getversionmanag checkin
properti prop intern set properti internalsetproperti version impl versionimpl propnam check propnam check intern internalvalu creat
prop save
prop intern set properti internalsetproperti version impl versionimpl propnam base version propnam base version intern internalvalu creat uuid uuid getuuid
prop save
prop intern set properti internalsetproperti version impl versionimpl propnam predecessor propnam predecessor intern internalvalu
prop save
node checkout
checkout
unsupport repositori oper except unsupportedrepositoryoperationexcept repositori except repositoryexcept
...
properti prop intern set properti internalsetproperti version impl versionimpl propnam check propnam check intern internalvalu creat
prop save
prop intern set properti internalsetproperti version impl versionimpl propnam predecessor propnam predecessor
intern internalvalu
...
log debug msg
version except versionexcept msg
valu properti getproperti version impl versionimpl propnam predecessor propnam predecessor valu getvalu
...
properti prop intern set properti internalsetproperti version impl versionimpl propnam predecessor propnam predecessor pred
prop save
...
properti hasproperti version impl versionimpl propnam predecessor propnam predecessor
valu properti getproperti version impl versionimpl propnam predecessor propnam predecessor valu getvalu
...
properti hasproperti item impl itemimpl propnam merg fail propnam merg fail
valu properti getproperti item impl itemimpl propnam merg fail propnam merg fail valu getvalu
valu newvalu valu length
system arraycopi valu valu newvalu valu length
valu newvalu valu length refer referencevalu
set properti setproperti item impl itemimpl propnam merg fail propnam merg fail valu newvalu
valu newvalu
valu newvalu refer referencevalu
set properti setproperti item impl itemimpl propnam merg fail propnam merg fail valu newvalu
...
unsupport repositori oper except unsupportedrepositoryoperationexcept repositori except repositoryexcept
check version checkversion
properti getproperti version impl versionimpl propnam check propnam check boolean getboolean
...
properti hasproperti version impl versionimpl propnam check propnam check
properti getproperti version impl versionimpl propnam check propnam check boolean getboolean
node restor string
...
intern restor internalrestor version impl versionimpl version histori getversionhistori version getvers version versionnam gv
save
node restor version
...
intern restor internalrestor version impl versionimpl version gener version selector genericversionselector version creat getcreat
save
...
node impl nodeimpl node add node addnod rel path relpath version impl versionimpl version
node check ischeckedout
string msg unabl restor version node check node safe jcr path safegetjcrpath
log debug msg
version except versionexcept msg
node intern restor internalrestor version impl versionimpl version gener version selector genericversionselector version creat getcreat
...
log debug msg
version except versionexcept msg
version impl versionimpl version impl versionimpl version histori getversionhistori version label getversionbylabel version label versionlabel
...
throw repositoryexcept error occur
node impl nodeimpl add node addnod string rel path relpath frozen node frozennod frozen
item exist except itemexistsexcept path found except pathnotfoundexcept
constraint violat except constraintviolationexcept node type except nosuchnodetypeexcept
repositori except repositoryexcept
frozen node type
node type manag impl nodetypemanagerimpl mgr ntmgr session node type manag getnodetypemanag
string ntname frozen properti getproperti version impl versionimpl propnam frozen primari type propnam frozen primari type string getstr
node type impl nodetypeimpl node type impl nodetypeimpl mgr ntmgr node type getnodetyp ntname
frozen uuid
string uuid frozen properti hasproperti version impl versionimpl propnam frozen uuid propnam frozen uuid
frozen properti getproperti version impl versionimpl propnam frozen uuid propnam frozen uuid string getstr
frozen mixin
node impl nodeimpl node intern add node internaladdnod rel path relpath uuid
todo respect mix type creation
frozen properti hasproperti version impl versionimpl propnam frozen mixin type propnam frozen mixin type
name mxname frozen properti getproperti version impl versionimpl propnam frozen mixin type propnam frozen mixin type valu getvalu
name mxname length
node add mixin addmixin name mxname string getstr
node
...
throw unsupportedrepositoryoperationexcept
throw repositoryexcept
intern restor internalrestor version impl versionimpl version version selector versionselector vsel
unsupport repositori oper except unsupportedrepositoryoperationexcept repositori except repositoryexcept
child node properti chang remov
ad depend copi
onparentvers attribut detail
restor frozen state restorefrozenst version vsel
jcr basevers properti chang point
intern set properti internalsetproperti version impl versionimpl propnam base version propnam base version intern internalvalu creat uuid version uuid getuuid
jcr ischeckedout properti set fals
intern set properti internalsetproperti version impl versionimpl propnam check propnam check intern internalvalu creat
n' jcr predecessor properti set null
intern set properti internalsetproperti version impl versionimpl propnam predecessor propnam predecessor intern internalvalu
helper retriev opv properti depend
implementaion frozen lookup prop def
param
param type
param multivalu
return
throw repositoryexcept
guess opv guessopv qname type multi valu multivalu repositori except repositoryexcept
properti def impl propertydefimpl def applic properti def getapplicablepropertydef type multi valu multivalu
def parent version getonparentvers
creat frozen state node
param freez
throw repositoryexcept
restor frozen state restorefrozenst frozen node frozennod freez version selector versionselector vsel
repositori except repositoryexcept
properti iter propertyiter piter freez properti getproperti
piter hasnext
properti impl propertyimpl prop properti impl propertyimpl piter properti nextproperti
check special properti
prop getqnam equal version impl versionimpl propnam frozen uuid propnam frozen uuid
check uuid 'this'
node type isnodetyp node type registri nodetyperegistri mix referenc mix referenc
item exist except itemexistsexcept unabl restor version safe jcr path safegetjcrpath referenc
prop string getstr equal uuid getuuid
item exist except itemexistsexcept unabl restor version safe jcr path safegetjcrpath uuid chang
prop getqnam equal version impl versionimpl propnam frozen primari type propnam frozen primari type
check primarytyp 'this'
prop string getstr equal primari node type getprimarynodetyp getnam
...
prop getqnam equal version impl versionimpl propnam frozen mixin type propnam frozen mixin type
add mixin
valu prop valu getvalu
node type nodetyp mixin mixin node type getmixinnodetyp
valu length
string valu string getstr
found
mixin length
equal mixin getnam
clear
...
prop getqnam equal version impl versionimpl propnam successor propnam successor
ignor
prop getqnam equal version impl versionimpl propnam creat propnam creat
ignor
prop getqnam equal version impl versionimpl propnam version label propnam version label
ignor
prop getqnam equal version impl versionimpl propnam version histori propnam version histori
ignor
prop getqnam equal version impl versionimpl propnam primarytyp propnam primarytyp
ignor
prop getqnam equal version impl versionimpl propnam mixintyp propnam mixintyp
ignor
prop getqnam equal version impl versionimpl propnam uuid propnam uuid
ignor
normal properti
...
valu length
type valu type gettyp
type prop getvalu type gettyp
opv guess opv guessopv prop getqnam type prop definit getdefinit multipl ismultipl
opv
parent version action onparentversionact abort
repositori except repositoryexcept checkin abort due opv prop safe jcr path safegetjcrpath
parent version action onparentversionact comput
parent version action onparentversionact ignor
parent version action onparentversionact initi
parent version action onparentversionact version
parent version action onparentversionact copi
intern copi properti internalcopypropertyfrom prop
iter node
node iter nodeiter niter freez node getnod
niter hasnext
node impl nodeimpl child node impl nodeimpl niter node nextnod
child node type isnodetyp node type registri nodetyperegistri frozen frozen
frozen node frozennod frozen node frozennod child
frozen node exist replac
todo make work sibl
node hasnod child getnam
remov child getnam
node impl nodeimpl add node addnod child getnam
restor frozen state restorefrozenst vsel
child node type isnodetyp node type registri nodetyperegistri frozen version child frozen version child
check child exist
node hasnod child getnam
desir version version selector
version histori versionhistori version histori versionhistori child properti getproperti version impl versionimpl propnam version histori propnam version histori node getnod
version impl versionimpl version impl versionimpl vsel select
node impl nodeimpl node add node addnod child getnam
...
unsupport repositori oper except unsupportedrepositoryoperationexcept repositori except repositoryexcept
check version checkversion
rep version manag getversionmanag version histori getversionhistori
node getbasevers
version base version getbasevers
unsupport repositori oper except unsupportedrepositoryoperationexcept repositori except repositoryexcept
check version checkversion
rep version manag getversionmanag base version getbasevers
copi properti node
param prop
throw repositoryexcept
...
todo implement lock support
code childrencollectorfilt code util class
'collect' child item
node name match pattern implement
code itemvisitor code interfac
author stefan guggisberg
children collector filter childrencollectorfilt travers item visitor traversingitemvisitor default
wildcard char wildcard char
string
collect children
collect node collectnod
collect properti collectproperti
string pattern namepattern
construct code childrencollectorfilt code
param namepattern pattern appli name
children
param children match children ad
param collectnod true child node collect fals
param collectproperti true child properti collect fals
param maxlevel umber hierarchi level travers
direct children children children
children collector filter childrencollectorfilt string pattern namepattern collect children collect node collectnod collect properti collectproperti max level maxlevel
max level maxlevel
pattern namepattern pattern namepattern
children children
collect node collectnod collect node collectnod
collect properti collectproperti collect properti collectproperti
traversingitemvisitor enter node int
enter node node level
repositori except repositoryexcept
level collect node collectnod
match node getnam pattern namepattern
children add node
traversingitemvisitor enter properti int
enter properti properti level
repositori except repositoryexcept
level collect properti collectproperti
match properti getnam pattern namepattern
children add properti
appli pattern
pattern full partial
wildcard charact disjunct charact
repres logic
code jcr foo bar code
match
code foo bar code code jcr code
param test pattern
return true match pattern
match string string pattern
split pattern
string token stringtoken string token stringtoken pattern
token hasmoretoken
intern match internalmatch token nexttoken
intern helper recurs match pattern
param string test
param pattern pattern
param soff offset code code
param poff offset code pattern code
return true code code match pattern fals
intern match internalmatch string string pattern soff poff
len plen pattern length
len slen length
poff len plen
soff len slen
char charat soff
check subscript notat
entir pattern match subscript
ignor subscript
soff len slen pattern char charat poff wildcard char wildcard char
check pattern char
handl recurs call
postfix
pattern char charat poff wildcard char wildcard char
poff len plen
intern match internalmatch pattern soff poff
soff len slen
soff
poff len plen soff len slen
pattern char charat poff char charat soff
poff
soff
