...
org apach jackrabbit spi common nodetyp node type def diff nodetypedefdiff
org apach jackrabbit spi common nodetyp node definit builder qnodedefinitionbuild
...
node type registri nodetyperegistri node type event listen nodetypeeventlisten
...
org apach jackrabbit core nodetyp builtin nodetyp cnd
string custom nodetyp resourc custom nodetyp resourc
nodetyp custom nodetyp xml
...
map node type definit qnodetypedefinit regist def registeredntdef
definit root node
node definit qnodedefinit root node def rootnodedef
...
map node type registri listen nodetyperegistrylisten node type registri listen nodetyperegistrylisten listen
...
regist node type getregisterednodetyp
regist def registeredntdef kei set keyset arrai toarrai regist def registeredntdef size
...
effect node type effectivenodetyp regist node type registernodetyp node type definit qnodetypedefinit ntd
...
ent intern regist internalregist ntd
...
set node type definit qnodetypedefinit def ntdef hash set hashset node type definit qnodetypedefinit
def ntdef add ntd
event channel eventchannel regist def ntdef
ent
code link registernodetyp qnodetypedefinit code
collect code nodetypedef code regist
method regist set node type
depend
param ntdef collect code qnodetypedefinit code object
throw invalidnodetypedefexcept node type definit invalid
throw repositoryexcept repositori error occur
regist node type registernodetyp collect node type definit qnodetypedefinit def ntdef
invalid node type def except invalidnodetypedefexcept repositori except repositoryexcept
regist node type registernodetyp def ntdef
intern implement link registernodetyp collect
param ntdef collect code qnodetypedefinit code object
param extern invoc consid extern
throw invalidnodetypedefexcept node type definit invalid
throw repositoryexcept repositori error occur
regist node type registernodetyp collect node type definit qnodetypedefinit def ntdef
extern
...
denot regist node type
throw repositoryexcept error occur
unregist node type unregisternodetyp
collect name ntname extern
node type except nosuchnodetypeexcept repositori except repositoryexcept
preliminari check
ntname name ntname
...
notifi unregist notifyunregist name ntname
persist custom node type def persistcustomnodetypedef custom def customntdef
inform cluster extern invoc
extern event channel eventchannel
event channel eventchannel unregist name ntname
...
denot regist node type
throw repositoryexcept error occur
unregisternodetyp collect boolean
unregist node type unregisternodetyp ntname
node type except nosuchnodetypeexcept repositori except repositoryexcept
...
throw nosuchnodetypeexcept code ntd code refer
unknown node type
throw invalidnodetypedefexcept node type definit
invalid
throw repositoryexcept error occur
effect node type effectivenodetyp reregist node type reregisternodetyp node type definit qnodetypedefinit ntd
node type except nosuchnodetypeexcept invalid node type def except invalidnodetypedefexcept
repositori except repositoryexcept
reregist node type reregisternodetyp ntd
intern implement link reregisternodetyp qnodetypedefinit
param ntd node type definit
param extern invoc consid extern
return effect node type
throw nosuchnodetypeexcept code ntd code refer
...
node type except nosuchnodetypeexcept invalid node type def except invalidnodetypedefexcept
repositori except repositoryexcept
effect node type effectivenodetyp ent entnew
ntd getnam
...
ntd check base subtyp checkntbasesubtyp ntd regist def registeredntdef
...
node type definit qnodetypedefinit ntd ntdold regist def registeredntdef
...
ent entnew intern regist internalregist ntd
...
inform cluster extern invoc
extern event channel eventchannel
event channel eventchannel reregist ntd
ent entnew
param ntname
return effect node type
throw nosuchnodetypeexcept node type exist
effect node type effectivenodetyp effect node type geteffectivenodetyp ntname
...
return effect node type node primari
mixin type
param primari primari type node
param mixin mixin type node set link name
return effect node type
throw nodetypeconflictexcept type conflict
throw nosuchnodetypeexcept type found
effect node type effectivenodetyp effect node type geteffectivenodetyp primari set mixin
node type conflict except nodetypeconflictexcept node type except nosuchnodetypeexcept
mixin empti isempti
effect node type geteffectivenodetyp primari
name mixin size
mixin arrai toarrai name
name name length primari
effect node type geteffectivenodetyp name ent cach entcach regist def registeredntdef
...
return set node type code code
throw nosuchnodetypeexcept node type exist
set depend node type getdependentnodetyp node type nodetypenam
node type except nosuchnodetypeexcept
...
node type definit qnodetypedefinit ntd regist def registeredntdef valu
...
exist
node type definit qnodetypedefinit node type def getnodetypedef node type nodetypenam
node type except nosuchnodetypeexcept
node type definit qnodetypedefinit def regist def registeredntdef node type nodetypenam
def
node type except nosuchnodetypeexcept node type nodetypenam string tostr
def
param nodetypenam node type
...
code fals code
regist isregist node type nodetypenam
regist def registeredntdef kei containskei node type nodetypenam
param nodetypenam node type
return code true code node type built
code fals code
built isbuiltin node type nodetypenam
...
builder append nodetyperegistri string tostr
builder append regist nodetyp
node type definit qnodetypedefinit ntd regist def registeredntdef valu
builder append ntd getnam
builder append
builder append
tsupertyp
arrai string tostr ntd supertyp getsupertyp
builder append tmixin ntd mixin ismixin
builder append torderablechildnod ntd order child node hasorderablechildnod
builder append tprimaryitemnam ntd primari item getprimaryitemnam null ntd primari item getprimaryitemnam string tostr
properti definit qpropertydefinit ntd properti def getpropertydef
properti definit qpropertydefinit apd
builder append tpropertydefinit
builder append declar apd declar node type getdeclaringnodetyp
builder append tname apd defin residu definesresidu apd getnam string tostr
string type apd requir type getrequiredtyp null properti type propertytyp namefromvalu apd requir type getrequiredtyp
builder append trequiredtyp type
constraint qvalueconstraint vca apd constraint getvalueconstraint
string builder stringbuild constraint string builder stringbuild
vca
constraint append null
constraint qvalueconstraint vca avca vca
constraint length
constraint append
constraint append vca avca string getstr
builder append tvalueconstraint constraint
qvalu def val defval apd default valu getdefaultvalu
string builder stringbuild default valu defaultvalu string builder stringbuild
def val defval
default valu defaultvalu append null
qvalu def val defval def val defval
...
builder append tdefaultvalu default valu defaultvalu
builder append tautocr apd auto creat isautocr
builder append tmandatori apd mandatori ismandatori
builder append tonvers parent version action onparentversionact namefromvalu apd parent version getonparentvers
builder append tprotect apd protect isprotect
builder append tmultipl apd multipl ismultipl
node definit qnodedefinit ntd child node def getchildnodedef
node definit qnodedefinit
builder append tnodedefinit
builder append declar declar node type getdeclaringnodetyp
builder append tname defin residu definesresidu getnam string tostr
req primari type reqprimarytyp requir primari type getrequiredprimarytyp
req primari type reqprimarytyp req primari type reqprimarytyp length
req primari type reqprimarytyp req primari type reqprimarytyp
builder append trequiredprimarytyp req primari type reqprimarytyp
def primari type defprimarytyp default primari type getdefaultprimarytyp
def primari type defprimarytyp
builder append tdefaultprimarytyp def primari type defprimarytyp
builder append tautocr auto creat isautocr
builder append tmandatori mandatori ismandatori
builder append tonvers parent version action onparentversionact namefromvalu parent version getonparentvers
builder append tprotect protect isprotect
builder append tallowssamenames sibl allowssamenames
builder append ent cach entcach
builder string tostr
nodetypeeventlisten
inheritdoc
extern regist externalregist collect node type definit qnodetypedefinit def ntdef
repositori except repositoryexcept invalid node type def except invalidnodetypedefexcept
regist node type registernodetyp def ntdef
inheritdoc
extern reregist externalreregist node type definit qnodetypedefinit def ntdef
node type except nosuchnodetypeexcept invalid node type def except invalidnodetypedefexcept
repositori except repositoryexcept
reregist node type reregisternodetyp def ntdef
inheritdoc
extern unregist externalunregist collect name ntname
repositori except repositoryexcept node type except nosuchnodetypeexcept
unregist node type unregisternodetyp name ntname
overrid
constructor
param nsreg space registri
param repositori file system
throw repositoryexcept error occur
suppress warn suppresswarn uncheck
node type registri nodetyperegistri namespac registri namespaceregistri reg nsreg file system filesystem
repositori except repositoryexcept
reg nsreg reg nsreg
custom node type resourc customnodetypesresourc
file system resourc filesystemresourc custom nodetyp resourc custom nodetyp resourc
...
ent cach entcach bit set ent cach impl bitsetentcacheimpl
...
definit load
throw repositoryexcept error occur load
...
reader input stream reader inputstreamread utf
store load cnd loadcnd builtin nodetyp resourc path builtin nodetyp resourc path
except ioexcept ioe
string error
...
code store code
param store link nodetypedefstor definit
persist
throw repositoryexcept error occur persist
custom node type definit
persist custom node type def persistcustomnodetypedef node type def store nodetypedefstor store
repositori except repositoryexcept
output stream outputstream custom node type resourc customnodetypesresourc output stream getoutputstream
...
check fail reason
check conflict content checkforconflictingcont node type definit qnodetypedefinit ntd
repositori except repositoryexcept
collect name node type depend
node type
...
referenc check fail
reason
check refer content checkforreferencesincont node type nodetypenam
repositori except repositoryexcept
repositori except repositoryexcept implement
implement
return definit root node
node definit qnodedefinit root node def getrootnodedef
...
effect node type cach effectivenodetypecach kei kei ent cach entcach kei getkei ntname
effect node type effectivenodetyp ent ent cach entcach kei
ent
ent
make definit node type
node type definit qnodetypedefinit ntd ntd cach ntdcach ntname
ntd
node type except nosuchnodetypeexcept ntname string tostr
...
throw nosuchnodetypeexcept node type refer supertyp
resolv
effect node type effectivenodetyp effect node type geteffectivenodetyp name ntname
effect node type cach effectivenodetypecach ent cach entcach
map node type definit qnodetypedefinit ntd cach ntdcach
node type conflict except nodetypeconflictexcept node type except nosuchnodetypeexcept
...
make definit node type
ntname name ntname
ntd cach ntdcach kei containskei ntname
node type except nosuchnodetypeexcept ntname string tostr
build aggreg
...
remaind kei name getnam
remaind aremaind remaind
node type definit qnodetypedefinit ntd ntd cach ntdcach remaind aremaind
effect node type effectivenodetyp ent
...
result
check circular inherit checkforcircularinherit supertyp
stack inherit chain inheritancechain
map node type definit qnodetypedefinit def cach ntdefcach
invalid node type def except invalidnodetypedefexcept repositori except repositoryexcept
supertyp
...
node type definit qnodetypedefinit ntd def cach ntdefcach
sta ntd supertyp getsupertyp
sta length
check recurs
...
child node childnod child node ent childnod node type getallnodetyp
child node childnod
...
buf string tostr
node definit qnodedefinit node def nodedef child node ent childnod auto creat node def getautocreatenodedef
node definit qnodedefinit node def nodedef node def nodedef
dnt node def nodedef default primari type getdefaultprimarytyp
defin definingnt node def nodedef declar node type getdeclaringnodetyp
dnt
check recurs
...
log debug msg
invalid node type def except invalidnodetypedefexcept msg nsnte
effect node type effectivenodetyp intern regist internalregist node type definit qnodetypedefinit ntd
invalid node type def except invalidnodetypedefexcept repositori except repositoryexcept
ntd getnam
regist def registeredntdef kei containskei
string msg exist
...
throw invalidnodetypedefexcept node type valid
throw repositoryexcept error occur
registernodetyp
intern regist internalregist collect node type definit qnodetypedefinit def ntdef
invalid node type def except invalidnodetypedefexcept repositori except repositoryexcept
intern regist internalregist def ntdef
...
intern regist internalregist collect node type definit qnodetypedefinit def ntdef lenient
invalid node type def except invalidnodetypedefexcept repositori except repositoryexcept
list collect modifi
list node type definit qnodetypedefinit def arrai list arraylist node type definit qnodetypedefinit def ntdef
map node type name node type definit
map node type definit qnodetypedefinit tmp def cach tmpntdefcach hash map hashmap node type definit qnodetypedefinit regist def registeredntdef
temporarili regist node type definit
preliminari check
node type definit qnodetypedefinit ntd def
ntd getnam
tmp def cach tmpntdefcach kei containskei
string msg exist
tmp def cach tmpntdefcach kei containskei
msg local
log debug msg
...
check node type def proper base subtyp
def size
node type definit qnodetypedefinit ntd def
node type definit qnodetypedefinit mod check base subtyp checkntbasesubtyp ntd tmp def cach tmpntdefcach
mod ntd
check fix subtyp
updat cach list def
tmp def cach tmpntdefcach put mod getnam mod
def set mod
...
node type definit qnodetypedefinit ntd def
effect node type effectivenodetyp ent valid node type def validatenodetypedef ntd tmp ent cach tmpentcach
tmp def cach tmpntdefcach reg nsreg lenient
store effect node type instanc
...
intern unregist internalunregist node type except nosuchnodetypeexcept
node type definit qnodetypedefinit ntd regist def registeredntdef
ntd
node type except nosuchnodetypeexcept string tostr
...
name ntname
intern unregist internalunregist
util method verifi namespac code code
...
check namespac checknamespac namespac registri namespaceregistri reg nsreg
repositori except repositoryexcept
make namespac uri denot regist namespac
reg nsreg prefix getprefix namespac uri getnamespaceuri
check node type def correct supertyp respect
base mixin nodetyp base primari
inherit supertyp
param ntd node type def check
param ntdcach cach lookup
return node type definit check
instanc fix
node type definit qnodetypedefinit check base subtyp checkntbasesubtyp node type definit qnodetypedefinit ntd map node type definit qnodetypedefinit ntd cach ntdcach
constant nameconst base base equal ntd getnam
ntd
set supertyp tree set treeset arrai list aslist ntd supertyp getsupertyp
supertyp empti isempti
ntd
modifi
ntd mixin ismixin
mixin remov base supertyp
modifi supertyp remov constant nameconst base base
check supertyp base mixin
mixin allmixin
supertyp
equal constant nameconst base base
node type definit qnodetypedefinit def ntd cach ntdcach
def def mixin ismixin
mixin allmixin
mixin allmixin
ntd primari node type mixin supertyp
base
modifi supertyp add constant nameconst base base
ntd primari node type supertyp
ensur base ad note
trivial case supertyp left handl
qnodetypedefinit directli
modifi supertyp remov constant nameconst base base
modifi
ntd node type definit impl qnodetypedefinitionimpl ntd getnam
supertyp arrai toarrai supertyp size
ntd support mixin type getsupportedmixintyp ntd mixin ismixin
ntd abstract isabstract ntd queryabl isquery
ntd order child node hasorderablechildnod ntd primari item getprimaryitemnam
ntd properti def getpropertydef ntd child node def getchildnodedef
ntd
valid code nodetypedef code context
collect return code effectivenodetyp code
param ntd node type definit
param entcach effect node type cach
param ntdcach cach 'known' node type definit resolv depend
param nsreg namespac registri validatingatch name
param lenient flag govern valid lenient strict
return effect node type represent code qnodetypedefinit code
throw invalidnodetypedefexcept node type valid
throw repositoryexcept error occur
effect node type effectivenodetyp valid node type def validatenodetypedef node type definit qnodetypedefinit ntd
effect node type cach effectivenodetypecach ent cach entcach
map node type definit qnodetypedefinit ntd cach ntdcach
namespac registri namespaceregistri reg nsreg
lenient
...
check node type definit overrid
supertypes' primaryitem illeg jcr
ntd primari item getprimaryitemnam
est primari item getprimaryitemnam
string msg primaryitemnam supertyp overridden
log debug msg
invalid node type def except invalidnodetypedefexcept msg
node type conflict except nodetypeconflictexcept ntce
...
qvalu def val defval default valu getdefaultvalu
...
requir type getrequiredtyp properti type propertytyp weakrefer
constraint qvalueconstraint constraint constraint
ntname factori impl namefactoryimpl instanc getinst creat constraint string getstr
equal ntname ntd cach ntdcach kei containskei ntname
string msg getnam
invalid
requir type getrequiredtyp properti type propertytyp refer refer weakrefer
constraint
...
dpt cnd default primari type getdefaultprimarytyp
...
req type reqtyp cnd requir primari type getrequiredprimarytyp
req type reqtyp req type reqtyp length
rpt req type reqtyp
skip base requir type
constant nameconst base base equal rpt
...
invalid node type def except invalidnodetypedefexcept msg nsnte
ent
node definit qnodedefinit creat root node def createrootnodedef
node definit builder qnodedefinitionbuild def node definit builder qnodedefinitionbuild
fixm fake declar node type
rep root correct exist node type
def set declar node type setdeclaringnodetyp constant nameconst rep root rep root
def set requir primari type setrequiredprimarytyp constant nameconst rep root rep root
def set default primari type setdefaultprimarytyp constant nameconst rep root rep root
...
node type registri listen nodetyperegistrylisten ala
ala
ala node type regist nodetyperegist ntname
notifi listen node type code ntname code regist
param ntname node type
notifi regist notifyreregist ntname
copi listen arrai avoid concurrentmodificationexcept
node type registri listen nodetyperegistrylisten listen valu arrai toarrai
node type registri listen nodetyperegistrylisten listen size
node type registri listen nodetyperegistrylisten ala
ala
ala node type regist nodetypereregist ntname
notifi listen oon node type unregist
param name node type name
notifi unregist notifyunregist collect name
copi listen arrai avoid concurrentmodificationexcept
node type registri listen nodetyperegistrylisten listen valu arrai toarrai
node type registri listen nodetyperegistrylisten listen size
node type registri listen nodetyperegistrylisten ala
ala
ala node type unregist nodetypesunregist name
