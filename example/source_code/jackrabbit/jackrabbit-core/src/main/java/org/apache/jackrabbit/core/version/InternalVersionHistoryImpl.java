...
default logger
logger log logger factori loggerfactori logger getlogg intern version histori impl internalversionhistoryimpl
...
mgr vmgr node
init
fix legaci fixlegaci
initi histori load intern cach
throw repositoryexcept error occur
...
version entri
child node entri childnodeentri child node state getstat child node entri getchildnodeentri
child getnam equal constant nameconst jcr versionlabel jcr versionlabel
cach namecach put child getnam child getid
fix legaci
fix legaci fixlegaci repositori except repositoryexcept
root version rootvers successor getsuccessor empti isempti
...
repositori except repositoryexcept
inconsist version state inconsistentversioningst fail creat version vhr histori historyid histori historyid
...
repositori except repositoryexcept
inconsist version state inconsistentversioningst version jcr frozennod child node getnodeid histori historyid
inheritdoc
overrid
node nodeid getid
histori historyid
...
present
param version
return version code null code cach
...
throw repositoryexcept error occur
intern version impl internalversionimpl checkin
node state nodestateex src calendar creat
repositori except repositoryexcept
...
node nodeid version versionid mgr vmgr node factori getnodeidfactori node newnodeid
...
creat histori node
node nodeid histori historyid mgr vmgr node factori getnodeidfactori node newnodeid
