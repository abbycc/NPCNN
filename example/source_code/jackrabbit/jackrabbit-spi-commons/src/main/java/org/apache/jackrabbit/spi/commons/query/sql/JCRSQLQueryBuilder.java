...
org apach jackrabbit spi common queri ari queri node naryquerynod
...
org apach jackrabbit spi common queri queri node factori querynodefactori
...
link org apach jackrabbit spi common queri queryconst type date
...
parser set resolv setnameresolv resolv
...
string string tostr queri root node queryrootnod root resolv nameresolv resolv
invalid queri except invalidqueryexcept
...
attach operand path step
locat step queri node locationstepquerynod step path node pathnod path step getpathstep
step step length add predic addpred constraint node constraintnod operand getoperand
constraint node constraintnod num operand getnumoperand
...
root add select properti addselectproperti factori impl namefactoryimpl instanc getinst creat rep uri rep uri excerpt
data
root
data
...
node children accept childrenaccept default parser visitor defaultparservisitor
object visit ast identifi astidentifi node object data
node getnam equal constant nameconst base base
...
data
identifi tmp
identifi identifi equal constant nameconst jcr path jcr path
tmp
...
node children length
liter ast liter astliter node children
liter ast liter astliter node children
predic node predicatenod creat relat queri node createrelationquerynod parent identifi type liter
type queri constant queryconst oper spellcheck oper spellcheck
predic node predicatenod creat relat queri node createrelationquerynod parent
constant nameconst jcr primarytyp jcr primarytyp type
...
queri andqueri num operand getnumoperand
...
queri notqueri num operand getnumoperand
...
data
intern
creat link org apach jackrabbit spi common queri relationquerynod
...
node factori creat relat queri node createrelationquerynod parent oper type operationtyp
node set rel path setrelativepath rel path relpath
node set string setstringvalu liter getvalu
liter type gettyp queri constant queryconst type timestamp type timestamp
calendar iso8601 pars liter getvalu
node factori creat relat queri node createrelationquerynod parent oper type operationtyp
node set rel path setrelativepath rel path relpath
...
type parent node code oper code
link org apach jackrabbit spi common queri querynod type
link org apach jackrabbit spi common queri querynod type
link org apach jackrabbit spi common queri querynod type
...
oper collect valid jcr system node type name validjcrsystemnodetypenam
