...
oper event channel eventchannel creat node node getnodeid deep isdeep session user getuserid
acquir
check node lock
...
inheritdoc
extern lock externallock node nodeid node nodeid deep isdeep string user userid repositori except repositoryexcept
acquir
path path path getpath node nodeid
creat lock token
lock info lockinfo info lock info lockinfo lock token locktoken node nodeid deep isdeep user userid
info set live setliv
lock map lockmap put path info
save
releas
