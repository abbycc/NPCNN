...
string build node refer file path buildnodereferencesfilepath node refer nodereferencesid
build node folder path buildnodefolderpath target gettargetid noderefsfilenam
...
check uuid
state node getnodeid uuid getuuid string tostr equal walker attribut getattribut uuid attribut uuid attribut
...
state add child node entri addchildnodeentri qname valueof child childnam node nodeid valueof child uuid childuuid
walker leav element leaveel
...
item state except itemstateexcept msg
check targetid
ref getid equal node refer nodereferencesid valueof walker attribut getattribut targetid attribut targetid attribut
...
uuid attribut uuid attribut uuid getuuid
parentuuid attribut parentuuid attribut state parent getparentid state parent getparentid uuid getuuid string tostr
...
uuid attribut uuid attribut entri getid uuid getuuid string tostr
writer write node element node element
writer write node element node element
writer write node element node element
writer close
...
parentuuid attribut parentuuid attribut state parent getparentid uuid getuuid
...
initi
illeg state except illegalstateexcept initi
node refer nodereferencesid ref getid
string ref file path refsfilepath build node refer file path buildnodereferencesfilepath
...
targetid attribut targetid attribut ref getid
