...
ad state
set item state itemst ad state addedst link hash set linkedhashset item state itemst
modifi state
set item state itemst modifi state modifiedst link hash set linkedhashset item state itemst
remov state
set item state itemst remov state removedst link hash set linkedhashset item state itemst
stale state
set item state itemst stale state stalest link hash set linkedhashset item state itemst
set oper
set oper oper link hash set linkedhashset oper
transient item state manag transientitemstatemanag
return oper record
iter oper oper getoper
oper iter
...
code itemst code descend stale flag true
return
...
set oper op link hash set linkedhashset oper
set item state itemst affect state affectedst link hash set linkedhashset item state itemst
...
item state itemst state stale state stalest
...
changelog
oper oper
collect item state itemst state opstat affect item state getaffecteditemst
item state itemst state state opstat
...
param definit definit node state
...
set item state itemst affect state affectedst chang log subchangelog affect state getaffectedst
