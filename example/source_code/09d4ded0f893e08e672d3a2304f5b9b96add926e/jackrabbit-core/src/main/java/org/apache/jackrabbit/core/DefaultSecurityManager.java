...
system user manag systemusermanag creat user manag createusermanag secur session securitysess
creat system user createsystemus system user manag systemusermanag admin adminid anonym anonymousid
...
provid factori acproviderfactori init secur session securitysess
...
workspac access manag workspaceaccessmanag workspac access manag impl workspaceaccessmanagerimpl
workspac access manag workspaceaccessmanag init secur session securitysess
...
bean config beanconfig umc repositori config getconfig secur config getsecurityconfig secur manag config getsecuritymanagerconfig user manag config getusermanagerconfig
properti config
umc
todo deal user manag implement
string clname umc class getclassnam
clname user manag impl usermanagerimpl getnam equal clname clname length
log warn unsupport custom usermanag implement clname
config umc paramet getparamet
user manag impl usermanagerimpl session admin adminid config
...
access mgr accessmgr access manag accessmanag config amconfig instanc newinst
...
equal userid definit userid
obtain login credenti
user manag case set princip present
subject search user
string uid
simpl access userid simplecredenti
...
uid user getuserid
simplecredenti retriev authoriz
group princip present determin
userid
princip subject princip getprincip
group
authoriz authorz system user manag systemusermanag authoriz getauthoriz
...
check initi checkiniti
auth context provid authcontextprovid auth context getauthcontext cred subject secur session securitysess
princip provid registri principalproviderregistri admin adminid anonym anonymousid
...
repositori session creat onsessioncr system session systemsess
workspac config workspaceconfig conf repositori config getconfig workspac config getworkspaceconfig workspac workspacenam
workspac secur config workspacesecurityconfig sec conf secconf conf conf secur config getsecurityconfig
provid acprovid
provid provid factori acproviderfactori creat provid createprovid system session systemsess sec conf secconf
...
group admin group user manag usermanag authoriz getauthoriz
admin
admin user manag usermanag creat group creategroup princip impl principalimpl secur constant securityconst administr administr
log debug creat administr group secur constant securityconst administr administr
admin adminid
authoriz admin user manag usermanag authoriz getauthoriz admin adminid
admin
admin user manag usermanag creat user createus admin adminid admin adminid
...
inheritdoc
param securitysess
init session secur session securitysess repositori except repositoryexcept
inheritdoc
