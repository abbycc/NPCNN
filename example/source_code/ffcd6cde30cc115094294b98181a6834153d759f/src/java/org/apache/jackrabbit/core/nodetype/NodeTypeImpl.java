...
node type impl nodetypeimpl effect node type effectivenodetyp ent node type def nodetypedef ntd node type manag impl nodetypemanagerimpl mgr ntmgr namespac resolv namespaceresolv resolv nsresolv
ent ent
mgr ntmgr mgr ntmgr
...
remov item canremoveitem properti propertynam
qname qname jcr fromjcrnam properti propertynam resolv nsresolv
type valu valu length properti type propertytyp undefin valu type gettyp
properti def impl propertydefimpl def applic properti def getapplicablepropertydef type
def protect isprotect
def multipl ismultipl
