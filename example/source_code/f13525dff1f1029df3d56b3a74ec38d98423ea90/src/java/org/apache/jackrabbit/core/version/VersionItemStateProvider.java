...
root node
string root node rootnodeid
creat version item state provid
param vmgr
param rootid
param parentid
throw repositoryexcept
version item state provid versionitemstateprovid version manag versionmanag mgr vmgr node type registri nodetyperegistri reg ntreg string root rootid string parent parentid repositori except repositoryexcept
mgr vmgr mgr vmgr
reg ntreg reg ntreg
root node rootnodeid root rootid
parent parentid parent parentid
ndef version ndef version node def nodedefid reg ntreg effect node type geteffectivenodetyp versionhistori versionhistori applic child node def getapplicablechildnodedef jcr rootvers jcr rootvers version version
ndef version histori ndef version histori node def nodedefid reg ntreg effect node type geteffectivenodetyp unstructur unstructur applic child node def getapplicablechildnodedef jcr rootvers jcr rootvers versionhistori versionhistori
ndef version histori root ndef version histori root node def nodedefid reg ntreg effect node type geteffectivenodetyp rep system rep system applic child node def getapplicablechildnodedef jcr versionstorag jcr versionstorag rep versionstorag rep versionstorag
ndef version label ndef version label node def nodedefid reg ntreg effect node type geteffectivenodetyp versionhistori versionhistori applic child node def getapplicablechildnodedef jcr versionlabel jcr versionlabel versionlabel versionlabel
creat root node state createrootnodest
creat root node state
throw repositoryexcept
creat root node state createrootnodest repositori except repositoryexcept
root histori root node state historyrootnodest mgr vmgr parent parentid root node rootnodeid
...
add hard refer version histori fluhe
state add state refer addstaterefer vln
...
repositori except repositoryexcept
prop def propdef def applic properti def getapplicablepropertydef parent type multi valu multivalu
...
prop set definit setdefinitionid prop def propdefid def
prop
...
repositori except repositoryexcept
node def nodedefid def
def node def nodedefid applic child node def getapplicablechildnodedef parent node type nodetypenam
repositori except repositoryexcept
...
reg ntreg node def getnodedef node def nodedefid cnd
def node def nodedefid cnd
creat node state
...
state set definit setdefinitionid def
...
return
throw repositoryexcept
prop def propdef applic properti def getapplicablepropertydef node state nodest parent qname properti propertynam
...
return
throw repositoryexcept
child node def childnodedef applic child node def getapplicablechildnodedef node state nodest parent qname node nodenam qname node type nodetypenam
repositori except repositoryexcept
effect node type geteffectivenodetyp parent applic child node def getapplicablechildnodedef node nodenam node type nodetypenam
...
destroi node isnod node state nodest destroi uuid getuuid equal root node rootnodeid
creat root node state createrootnodest
repositori except repositoryexcept
ignor
node remov destroi getid
inheritdoc
state discard statediscard item state itemst discard
discard remov listen removelisten
discard node isnod node state nodest discard uuid getuuid equal root node rootnodeid
creat root node state createrootnodest
repositori except repositoryexcept
ignor
node remov discard getid
