...
item life cycl listen itemlifecyclelisten
item life cycl listen itemlifecyclelisten listen valu arrai toarrai
item life cycl listen itemlifecyclelisten listen size
length
item creat itemcr
...
item state itemst statu stale modifi statu stale modifi
msg transient state transientst getid
item save modifi extern
log debug msg
invalid item state except invaliditemstateexcept msg
item state itemst statu stale destroi statu stale destroi
...
item valid itemvalid valid item valid itemvalid mgr ntmgr node type registri getnodetyperegistri
session hierarchi manag gethierarchymanag session
...
effect node type effectivenodetyp ent valid effect node type geteffectivenodetyp node state nodest
...
item itemid item state itemst getid
check remov permiss
access mgr accessmgr grant isgrant access manag accessmanag remov
string msg item mgr itemmgr safe jcr path safegetjcrpath
allow remov item
log debug msg
access deni except accessdeniedexcept msg
...
item impl itemimpl item item mgr itemmgr item getitem item state itemst
persist state transient item
item make persist makepersist
restor transient item restoretransientitem iter iter
walk list transient state reappli transient
iter hasnext
item state itemst item state itemst item state itemst iter
item itemid item state itemst getid
item impl itemimpl item
...
instanc ourself
item state itemst node isnod
item item mgr itemmgr creat node instanc createnodeinst node state nodest item state itemst
item item mgr itemmgr creat properti instanc createpropertyinst properti state propertyst item state itemst
...
reappli transient undo effect item makepersist
item node isnod
...
effect node type effectivenodetyp ntold valid effect node type geteffectivenodetyp
shareabl wasshar ntold includ node type includesnodetyp constant nameconst mix shareabl mix shareabl
effect node type effectivenodetyp ntnew valid effect node type geteffectivenodetyp
...
item state itemst node isnod
node state nodest node state nodest node state nodest item state itemst
effect node type effectivenodetyp valid effect node type geteffectivenodetyp node state nodest
...
version histori versionhistori mgr vmgr version histori getversionhistori session node state nodest
mgr vmgr creat version histori createversionhistori session node state nodest
node intern set properti internalsetproperti constant nameconst jcr versionhistori jcr versionhistori intern internalvalu creat uuid uuid getuuid
node intern set properti internalsetproperti constant nameconst jcr basevers jcr basevers intern internalvalu creat uuid root version getrootvers uuid getuuid
node intern set properti internalsetproperti constant nameconst jcr ischeckedout jcr ischeckedout intern internalvalu creat
node intern set properti internalsetproperti constant nameconst jcr predecessor jcr predecessor
intern internalvalu intern internalvalu creat uuid root version getrootvers uuid getuuid
creat transient state createdtransientst
creat transient state createdtransientst
...
log debug msg
repositori except repositoryexcept msg
node definit nodedefinit def node definit getdefinit
check protect flag
check nocheck def protect isprotect
string msg safe jcr path safegetjcrpath remov protect node
log debug msg
constraint violat except constraintviolationexcept msg
properti impl propertyimpl prop properti impl propertyimpl
properti definit propertydefinit def prop definit getdefinit
check protect flag
check nocheck def protect isprotect
...
check nocheck parent node parentnod intern check internalischeckedout
...
check nocheck parent node parentnod definit getdefinit protect isprotect
...
call item refresh fals itemimpl setremov
transient istransi
state statu getstatu
...
persist state restor
persist state resurrect item instanc
state mgr statemgr disconnect transient item state disconnecttransientitemst state
...
node state nodest child node entri childnodeentri cne cneit
...
string msg safe jcr path safegetjcrpath unabl updat item
log debug msg
repositori except repositoryexcept msg
succeed
...
transient istransi
transient state transientst state
transient state transientst statu getstatu
item state itemst statu stale modifi statu stale modifi
item state itemst statu stale destroi statu stale destroi
item state itemst statu exist modifi statu exist modifi
...
item state itemst statu statu
string msg safe jcr path safegetjcrpath refresh item
log debug msg
repositori except repositoryexcept msg
log debug unexpect state statu transient state transientst statu getstatu
ignor
