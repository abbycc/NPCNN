...
session item manag getitemmanag item getitem lock token locktoken getid
path path path getpath lock token locktoken getid
...
throw repositoryexcept error occur
abstract lock info abstractlockinfo intern lock internallock node impl nodeimpl node deep isdeep
session scope issessionscop timeout hint timeouthint
string owner info ownerinfo
...
session scope issessionscop deep isdeep lock owner lockown timeout hint timeouthint
...
todo tobefix
todo token open scope lock ad session
info issessionscop
...
info
lock except lockexcept node lock node
session info lock holder getlockhold
lock except lockexcept node lock session node
session remov lock token removelocktoken info lock token getlocktoken session
element set
info set live setliv
info session scope sessionscop
save
...
oper
oper end success
packag privat low level helper method return
code abstractlockinfo code
session
...
element visit elementvisit path map pathmap element element
lock info lockinfo info lock info lockinfo element
info live isliv info lock holder getlockhold equal session
info add info
abstract lock info abstractlockinfo info arrai toarrai abstract lock info abstractlockinfo info size
...
lock except lockexcept repositori except repositoryexcept
abstract lock info abstractlockinfo info intern lock internallock node deep isdeep session scope issessionscop timout hint timouthint owner info ownerinfo
write lock properti writelockproperti node info lock owner lockown info deep
...
path map pathmap element element lock map lockmap map path
abstract lock info abstractlockinfo info abstract lock info abstractlockinfo element
info element path haspath path info deep
...
acquir
abstract lock info abstractlockinfo info lock info getlockinfo session
lock lock lock info length
info length
abstract lock info abstractlockinfo info info
node holder node session item manag getitemmanag item getitem info getid
...
releas
inheritdoc
lock holder islockhold session session node impl nodeimpl node
repositori except repositoryexcept
acquir
path map pathmap element element lock map lockmap map path getpath node getid
element
abstract lock info abstractlockinfo info abstract lock info abstractlockinfo element
info info lock holder getlockhold session
item found except itemnotfoundexcept
releas
inheritdoc
...
session add listen addlisten lock info lockinfo info
...
item valid itemvalid helper item valid itemvalid edit session editingsess node type manag getnodetypemanag node type registri getnodetyperegistri wsp hierarchi manag gethierarchymanag edit session editingsess
state mgr statemgr
...
prop def propdef def helper find applic properti definit findapplicablepropertydefinit constant nameconst jcr lockown jcr lockown properti type propertytyp string node state nodest
prop state propstat state mgr statemgr creat createnew constant nameconst jcr lockown jcr lockown node nodeid
prop state propstat set definit setdefinitionid def getid
...
prop def propdef def helper find applic properti definit findapplicablepropertydefinit constant nameconst jcr lockisdeep jcr lockisdeep properti type propertytyp boolean node state nodest
...
session path getqpath event path getpath normal path getnormalizedpath
event type gettyp
...
lock token locktoken session scope sessionscop deep lock owner lockown long max max
creat instanc class
param locktoken lock token
param sessionscop lock token session scope
param deep lock deep
...
properli clean
session impl sessionimpl system session systemsess lock manag impl lockmanagerimpl session
...
node unlock
repositori except repositoryexcept
log warn unabl remov session scope lock node lock token locktoken messag getmessag
log debug root
session lock holder lockhold
...
acquir
path path path getpath node nodeid
creat lock token
lock info lockinfo info lock info lockinfo lock token locktoken node nodeid deep isdeep lock owner lockown
info set live setliv
lock map lockmap put path info
save
releas
