...
hier mgr hiermgr cach hierarchi manag cachinghierarchymanag root node rootnodeid resolv nsresolv
...
custom variant link createnew nodeid qname nodeid
...
custom variant link createnew qname nodeid
connect newli creat persist state transient state
...
iter descend transient item state getdescendanttransientitemst node nodeid parent parentid
...
depth arrai index
list list
iter iter transient store transientstor valu iter
iter hasnext
item state itemst state item state itemst iter
determin rel depth mean descend
depth
depth hier mgr hiermgr rel depth getrelativedepth parent parentid state getid
...
iter descend transient item state attic getdescendanttransientitemstatesinatt node nodeid parent parentid
...
zombi hierarchi manag zombiehierarchymanag hier mgr hiermgr root node getrootnodeid
attic getatt
hier mgr hiermgr namespac resolv getnamespaceresolv
arrai list group descend rel depth
depth arrai index
list list
iter iter attic store atticstor valu iter
iter hasnext
item state itemst state item state itemst iter
determin rel depth mean descend
depth zombi hier mgr zombiehiermgr rel depth getrelativedepth parent parentid state getid
depth
descend
ensur capac
depth length
...
return
throw itemstateexcept
node state nodest creat transient node state createtransientnodest node nodeid qname node type nodetypenam node nodeid parent parentid initi statu initialstatu
...
return
throw itemstateexcept
properti state propertyst creat transient properti state createtransientpropertyst node nodeid parent parentid qname prop propnam initi statu initialstatu
item state except itemstateexcept
...
collect tmp arrai list arraylist transient store transientstor valu
iter iter tmp iter
iter hasnext
item state itemst state item state itemst iter
dispos transient item state disposetransientitemst state
tmp arrai list arraylist attic store atticstor valu
iter tmp iter
iter hasnext
item state itemst state item state itemst iter
